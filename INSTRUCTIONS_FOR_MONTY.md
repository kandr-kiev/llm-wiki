...
> **Зміни (2026-07-06):** `wiki/sources/`, `wiki/events/`, `wiki/digests/` видалено. Шаблони переміщено у `wiki/templates/`. Wiki-сторінки тепер посилаються на raw-джерела напряму: `sources: [raw/articles/filename.md]`.
