...
ingested: 2026-07-10
sha256: 2af75c2a71213565e49662c8bca79b0abac693d36f48e80d4add08f1105bc694
...
<head><script>document.documentElement.classList.add('js');</script>  <title>[2607.07850] A Graph Neural Network Model for Real-Time Gesture Recognition Based on sEMG Signals</title>
  ...
  <link rel="canonical" href="https://arxiv.org/abs/2607.07850"/>
  <meta name="description" content="Abstract page for arXiv paper 2607.07850: A Graph Neural Network Model for Real-Time Gesture Recognition Based on sEMG Signals"><meta property="og:type" content="website" />
<meta property="og:site_name" content="arXiv.org" />
<meta property="og:title" content="A Graph Neural Network Model for Real-Time Gesture Recognition Based on sEMG Signals" />
<meta property="og:url" content="https://arxiv.org/abs/2607.07850v1" />
<meta property="og:image" content="/static/browse/0.3.4/images/arxiv-logo-fb.png" />
<meta property="og:image:secure_url" content="/static/browse/0.3.4/images/arxiv-logo-fb.png" />
<meta property="og:image:width" content="1200" />
<meta property="og:image:height" content="700" />
<meta property="og:image:alt" content="arXiv logo"/>
<meta property="og:description" content="For seemless control of advanced hand prostheses and augmented reality, accurate and immediate hand gestures recognition is essential. Surface electromyography (sEMG) signals obtained from the forearm are commonly employed for this purpose. In this paper, we present a novel approach for sEMG representation that utilizes graph networks which contain information about muscle activation patterns in the forearm. Based on these graph networks, we have developed a machine learning algorithm capable of real-time hand gesture recognition using a graph neural network. The algorithm&#39;s performance was evaluated using sEMG signals acquired from myoband, which has 8 electrodes placed around the forearm, involving 8 healthy subjects. The proposed method demonstrated an average classification accuracy of 99\%, surpassing the performance of state-of-the-art techniques. The average time for both graph construction and prediction stood at 48ms utilizing a M1 pro CPU, rendering the approach well-suited for real-time applications."/>
<meta name="twitter:site" content="@arxiv"/>
<meta name="twitter:card" content="summary"/>
<meta name="twitter:title" content="A Graph Neural Network Model for Real-Time Gesture Recognition..."/>
<meta name="twitter:description" content="For seemless control of advanced hand prostheses and augmented reality, accurate and immediate hand gestures recognition is essential. Surface electromyography (sEMG) signals obtained from the..."/>
...
<meta name="twitter:image:alt" content="arXiv logo"/>
  ...
  <script src="/static/browse/0.3.4/js/cite.js" type="text/javascript"></script><meta name="citation_title" content="A Graph Neural Network Model for Real-Time Gesture Recognition Based on sEMG Signals" /><meta name="citation_author" content="Vipulanandan, Pragatheeswaran" /><meta name="citation_author" content="Premaratne, Kamal" /><meta name="citation_author" content="Murthi, Manohar" /><meta name="citation_doi" content="10.1109/EMBC53108.2024.10781990" /><meta name="citation_date" content="2026/07/08" /><meta name="citation_online_date" content="2026/07/08" /><meta name="citation_pdf_url" content="https://arxiv.org/pdf/2607.07850" /><meta name="citation_arxiv_id" content="2607.07850" /><meta name="citation_abstract" content="For seemless control of advanced hand prostheses and augmented reality, accurate and immediate hand gestures recognition is essential. Surface electromyography (sEMG) signals obtained from the forearm are commonly employed for this purpose. In this paper, we present a novel approach for sEMG representation that utilizes graph networks which contain information about muscle activation patterns in the forearm. Based on these graph networks, we have developed a machine learning algorithm capable of real-time hand gesture recognition using a graph neural network. The algorithm&#39;s performance was evaluated using sEMG signals acquired from myoband, which has 8 electrodes placed around the forearm, involving 8 healthy subjects. The proposed method demonstrated an average classification accuracy of 99\%, surpassing the performance of state-of-the-art techniques. The average time for both graph construction and prediction stood at 48ms utilizing a M1 pro CPU, rendering the approach well-suited for real-time applications." />
</head>
...
rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
    ...
    <rdf:Description
        rdf:about="/abs/2607.07850"
        dc:identifier="/abs/2607.07850"
        dc:title="A Graph Neural Network Model for Real-Time Gesture Recognition Based on sEMG Signals"
        trackback:ping="/trackback/2607.07850" />
    </rdf:RDF>
--><div id="abs-outer">
  ...
  <div class="leftcolumn">
    ...
    <div class="header-breadcrumbs-mobile">
      <strong>arXiv:2607.07850</strong> (cs)
    </div>
...
<div id="content-inner">
  ...
  [Submitted on 8 Jul 2026]</div>
    <h1 class="title mathjax"><span class="descriptor">Title:</span>A Graph Neural Network Model for Real-Time Gesture Recognition Based on sEMG Signals</h1>
    <div class="authors"><span class="descriptor">Authors:</span><a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Vipulanandan,+P" rel="nofollow">Pragatheeswaran Vipulanandan</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Premaratne,+K" rel="nofollow">Kamal Premaratne</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Murthi,+M" rel="nofollow">Manohar Murthi</a></div>            <div id="download-button-info" hidden>View a PDF of the paper titled A Graph Neural Network Model for Real-Time Gesture Recognition Based on sEMG Signals, by Pragatheeswaran Vipulanandan and 2 other authors</div>
    <a class="mobile-submission-download" href="/pdf/2607.07850">View PDF</a>
    <a class="mobile-submission-download" href="https://arxiv.org/html/2607.07850v1">HTML (experimental)</a>



    <blockquote class="abstract mathjax">
            <span class="descriptor">Abstract:</span>For seemless control of advanced hand prostheses and augmented reality, accurate and immediate hand gestures recognition is essential. Surface electromyography (sEMG) signals obtained from the forearm are commonly employed for this purpose. In this paper, we present a novel approach for sEMG representation that utilizes graph networks which contain information about muscle activation patterns in the forearm. Based on these graph networks, we have developed a machine learning algorithm capable of real-time hand gesture recognition using a graph neural network. The algorithm&#39;s performance was evaluated using sEMG signals acquired from myoband, which has 8 electrodes placed around the forearm, involving 8 healthy subjects. The proposed method demonstrated an average classification accuracy of 99\%, surpassing the performance of state-of-the-art techniques. The average time for both graph construction and prediction stood at 48ms utilizing a M1 pro CPU, rendering the approach well-suited for real-time applications.
    </blockquote>
    ...
    <div class="metatable">
      <table summary="Additional metadata"><tr>
          ...
          <td class="tablecell arxivid"><span class="arxivid"><a href="https://arxiv.org/abs/2607.07850">arXiv:2607.07850</a> [cs.AI]</span></td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxividv">(or <span class="arxivid">
              <a href="https://arxiv.org/abs/2607.07850v1">arXiv:2607.07850v1</a> [cs.AI]</span> for this version)
          </td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxivdoi">              <a href="https://doi.org/10.48550/arXiv.2607.07850"  id="arxiv-doi-link">https://doi.org/10.48550/arXiv.2607.07850</a><div class="button-and-tooltip">
          ...
          <td class="tablecell doi"><a href="https://doi.org/10.1109/EMBC53108.2024.10781990" data-doi="10.1109/EMBC53108.2024.10781990" class="link-https link-external" rel="external noopener nofollow">https://doi.org/10.1109/EMBC53108.2024.10781990</a>
    ...
    <div class="submission-history">
      <h2>Submission history</h2> From: Pragatheeswaran Vipulanandan [<a href="/show-email/5daaf39b/2607.07850" rel="nofollow">view email</a>]      <br/>    <strong>[v1]</strong>
        Wed, 8 Jul 2026 18:29:52 UTC (600 KB)<br/>
</div>
  </div>
  <!--end leftcolumn-->
...
View a PDF of the paper titled A Graph Neural Network Model for Real-Time Gesture Recognition Based on sEMG Signals, by Pragatheeswaran Vipulanandan and 2 other authors</div><li><a href="/pdf/2607.07850" aria-describedby="download-button-info" accesskey="f" class="abs-button download-pdf">View PDF</a></li><li><a href="https://arxiv.org/html/2607.07850v1" class="abs-button" id="latexml-download-link">HTML (experimental)</a></li><li><a href="/src/2607.07850" class="abs-button download-eprint">TeX Source
 </a></li></ul>
  ...
  <div class="prevnext">
<span class="arrow">
      <a class="abs-button prev-url" href="/prevnext?id=2607.07850&amp;function=prev&amp;context=cs.AI"
         accesskey="p" title="previous in cs.AI (accesskey p)" rel="nofollow">&lt;&nbsp;prev</a>
    </span>
    <span class="is-hidden-mobile">&nbsp; | &nbsp;</span>    <span class="arrow">
      <a class="abs-button next-url" href="/prevnext?id=2607.07850&amp;function=next&amp;context=cs.AI" accesskey="n"
    ...
    <div class="switch context-change">
        <a href="/abs/2607.07850?context=cs" rel="nofollow">cs</a><br class="is-hidden-mobile">
    </div>
  </div>
      ...
      <div class="extra-ref-cite">
        ...
        <ul>
          <li><a  class="abs-button abs-button-small cite-ads" href="https://ui.adsabs.harvard.edu/abs/arXiv:2607.07850">NASA ADS</a></li><li><a  class="abs-button abs-button-small cite-google-scholar" href="https://scholar.google.com/scholar_lookup?arxiv_id=2607.07850" target="_blank" rel="noopener">Google Scholar</a></li>
          <li><a  class="abs-button abs-button-small cite-semantic-scholar" href="https://api.semanticscholar.org/arXiv:2607.07850" target="_blank" rel="noopener">Semantic Scholar</a></li>
        </ul>
...
<div id='bib-cite-modal' class='bib-modal' hidden='true'>
  ...
  <div><h3>Bookmark</h3></div><a class="abs-button abs-button-grey abs-button-small" href="http://www.bibsonomy.org/BibtexHandler?requTask=upload&amp;url=https://arxiv.org/abs/2607.07850&amp;description=A Graph Neural Network Model for Real-Time Gesture Recognition Based on sEMG Signals"
     title="Bookmark on BibSonomy">
    <img src="/static/browse/0.3.4/images/icons/social/bibsonomy.png"
         alt="BibSonomy"/>
  </a>
  <a class="abs-button abs-button-grey abs-button-small" href="https://reddit.com/submit?url=https://arxiv.org/abs/2607.07850&amp;title=A Graph Neural Network Model for Real-Time Gesture Recognition Based on sEMG Signals"
...
<!-- END LABS AREA -->
  <div class="endorsers">
    <a href="/auth/show-endorsers/2607.07850" class="endorser-who" rel="nofollow">Which authors of this paper are endorsers?</a> |
