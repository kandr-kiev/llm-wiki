...
- **Quantitative Evaluation:** Accuracy, faithfulness, relevance, safety metrics
- **Observability:** Distribution shift, edge cases, model updates affect prompts in production
- **Data Curation:** Production logs → failure mode analysis → dataset enrichment

## Domain-Specific Applications

- **Medical:** High stakes, requires factual accuracy, citation, uncertainty delineation
- **Education:** Balances pedagogy with ethics, supports learning not replaces cognition
- **Tabular Data:** Finance, healthcare, scientific domains require structural integrity

## Key Tools & Frameworks

- **DSPy:** Programmatic prompt optimization
- **GEPA:** Automatic prompt engineering
- **ProTeGi:** Prompt generation and improvement
- **Playground++:** Prompt versioning and deployment

## Related Wiki Pages

- [[llm-fine-tuning-lora-qlora-dpo]] — When to fine-tune vs prompt
- [[advanced-rag-techniques]] — RAG as retrieval-based alternative
- [[llm-wiki]] — Knowledge base for prompt patterns
