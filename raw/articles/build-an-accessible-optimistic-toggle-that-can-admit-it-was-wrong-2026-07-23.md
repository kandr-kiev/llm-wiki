...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Build an Accessible Optimistic Toggle That Can Admit It Was Wrong - DEV Community</title>
    
    <link rel="preload" href="/reactions?article_id=4214975" as="fetch" crossorigin="same-origin">
    <link rel="canonical" href="https://dev.to/babycat/build-an-accessible-optimistic-toggle-that-can-admit-it-was-wrong-49gm" />
    <meta name="description" content="Keep keyboard focus, announced state, and server truth aligned when an optimistic setting update fails or returns out of order. Tagged with frontend, a11y, javascript, ux.">
    <meta name="keywords" content="frontend, a11y, javascript, ux, software, coding, development, engineering, inclusive, community">

    <meta property="og:type" content="article" />
    <meta property="og:url" content="https://dev.to/babycat/build-an-accessible-optimistic-toggle-that-can-admit-it-was-wrong-49gm" />
    <meta property="og:title" content="Build an Accessible Optimistic Toggle That Can Admit It Was Wrong" />
    <meta property="og:description" content="Keep keyboard focus, announced state, and server truth aligned when an optimistic setting update fails or returns out of order." />
    <meta property="og:site_name" content="DEV Community" />
    <meta name="twitter:site" content="@thepracticaldev">
    <meta name="twitter:creator" content="@">
    <meta name="author-trust" content="0">
    <meta name="twitter:title" content="Build an Accessible Optimistic Toggle That Can Admit It Was Wrong">
    <meta name="twitter:description" content="Keep keyboard focus, announced state, and server truth aligned when an optimistic setting update fails or returns out of order.">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:widgets:new-embed-design" content="on">
    <meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1">
      <meta property="og:image" content="https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Ffafs9p8s7t6aagohdamx.png" />
      <meta name="twitter:image:src" content="https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Ffafs9p8s7t6aagohdamx.png">
  ...
  <div class="crayons-header__container">
    <span class="inline-block m:hidden ">
      <button class="c-btn c-btn--icon-alone js-hamburger-trigger mx-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="aan2cb7vcp7ltzkr8xcv9vtkibu0i1qp" class="crayons-icon"><title id="aan2cb7vcp7ltzkr8xcv9vtkibu0i1qp">Navigation menu</title>
        ...
        <div class="crayons-fields crayons-fields--horizontal">
          <div class="crayons-field flex-1 relative">
            ...
            <button type="submit" aria-label="Search" class="c-btn c-btn--icon-alone absolute inset-px right-auto mt-0 py-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a3tt2jiauf44a0hmpzzr3e0iokz9ij86" aria-hidden="true" class="crayons-icon"><title id="a3tt2jiauf44a0hmpzzr3e0iokz9ij86">Search</title>
    <path d="M18.031 16.617l4.283 4.282-1.415 1.415-4.282-4.283A8.96 8.96 0 0111 20c-4.968 0-9-4.032-9-9s4.032-9 9-9 9 4.032 9 9a8.96 8.96 0 01-1.969 5.617zm-2.006-.742A6.977 6.977 0 0018 11c0-3.868-3.133-7-7-7-3.868 0-7 3.132-7 7 0 3.867 3.132 7 7 7a6.977 6.977 0 004.875-1.975l.15-.15z"></path>
            ...
            <a class="crayons-header--search-brand-indicator" href="https://www.algolia.com/developers/?utm_source=devto&utm_medium=referral" target="_blank" rel="noopener noreferrer">
                Powered by Algolia
                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" width="24" height="24" viewBox="0 0 500 500.34" role="img" aria-labelledby="alx2mno2n18x6jot2xcmj76icrbrfnh5" aria-hidden="true" class="crayons-icon"><title id="alx2mno2n18x6jot2xcmj76icrbrfnh5">Search</title>
  ...
  <div class="hamburger__content">
    <header class="hamburger__content__header">
      ...
      <button class="c-btn c-btn--icon-alone js-hamburger-trigger shrink-0" aria-label="Close">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="ajj10qxlgxms9bxisj3ml1ecbmevcrdt" aria-hidden="true" class="crayons-icon c-btn__icon"><title id="ajj10qxlgxms9bxisj3ml1ecbmevcrdt">Close</title><path d="M12 10.586l4.95-4.95 1.414 1.414-4.95 4.95 4.95 4.95-1.414 1.414-4.95-4.95-4.95 4.95-1.414-1.414 4.95-4.95-4.95-4.95L7.05 5.636l4.95 4.95z"></path></svg>
...
<div id="page-content" class="wrapper stories stories-show articletag-frontend articletag-a11y articletag-javascript articletag-ux articleuser-4022684" data-current-page="stories-show">
  <div id="page-content-inner" data-internal-nav="false" data-viewable-id="4214975" data-viewable-type="Article">
...
<script src="https://assets.dev.to/assets/commentDropdowns-7a28d130e5b78d38b30a9495a964003a66bd64fa455fc70b766d69cf06b9ba24.js" defer="defer"></script>
  ...
  <script type="application/ld+json">
    {"@context":"http://schema.org","@type":"Article","mainEntityOfPage":{"@type":"WebPage","@id":"https://dev.to/babycat/build-an-accessible-optimistic-toggle-that-can-admit-it-was-wrong-49gm"},"url":"https://dev.to/babycat/build-an-accessible-optimistic-toggle-that-can-admit-it-was-wrong-49gm","image":["https://media2.dev.to/dynamic/image/width=1080,height=1080,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Ffafs9p8s7t6aagohdamx.png","https://media2.dev.to/dynamic/image/width=1280,height=720,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Ffafs9p8s7t6aagohdamx.png","https://media2.dev.to/dynamic/image/width=1600,height=900,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Ffafs9p8s7t6aagohdamx.png"],"publisher":{"@context":"http://schema.org","@type":"Organization","name":"DEV Community","logo":{"@context":"http://schema.org","@type":"ImageObject","url":"https://media2.dev.to/dynamic/image/width=192,height=,fit=scale-down,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F8j7kvp660rqzt99zui8e.png","width":"192","height":"192"}},"headline":"Build an Accessible Optimistic Toggle That Can Admit It Was Wrong","author":{"@context":"http://schema.org","@type":"Person","url":"https://dev.to/babycat","name":"babycat"},"datePublished":"2026-07-23T11:54:28Z","dateModified":"2026-07-23T11:54:28Z"}
  </script>
    ...
    <span data-testid="tooltip" class="crayons-tooltip__content">
      ...
      <div class="align-center m:relative">
        <button id="article-show-more-button" aria-controls="article-show-more-dropdown" aria-expanded="false" aria-haspopup="true" class="dropbtn crayons-btn crayons-btn--ghost-dimmed crayons-btn--icon-rounded" aria-label="Share post options">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" role="img" aria-labelledby="a7v68khwpd68yj4825t7j2spkudrkfct" aria-hidden="true" class="crayons-icon dropdown-icon"><title id="a7v68khwpd68yj4825t7j2spkudrkfct">More...</title><path fill-rule="evenodd" clip-rule="evenodd" d="M7 12a2 2 0 11-4 0 2 2 0 014 0zm7 0a2 2 0 11-4 0 2 2 0 014 0zm5 2a2 2 0 100-4 2 2 0 000 4z"></path></svg>
        ...
        <div id="article-show-more-dropdown" class="crayons-dropdown side-bar left-2 right-2 m:right-auto m:left-100 s:left-auto mb-1 m:mb-0 top-unset bottom-100 m:top-0 m:bottom-unset">
          <div>
            <button
              ...
              data-postUrl="https://dev.to/babycat/build-an-accessible-optimistic-toggle-that-can-admit-it-was-wrong-49gm">
              <span class="fw-bold">Copy link</span>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" id="article-copy-icon" role="img" aria-labelledby="af4q9uuq1dcsz241jx07xshmchfdevpt" aria-hidden="true" class="crayons-icon mx-2 shrink-0"><title id="af4q9uuq1dcsz241jx07xshmchfdevpt">Copy link</title>
    <path d="M7 6V3a1 1 0 011-1h12a1 1 0 011 1v14a1 1 0 01-1 1h-3v3c0 .552-.45 1-1.007 1H4.007A1 1 0 013 21l.003-14c0-.552.45-1 1.007-1H7zm2 0h8v10h2V4H9v2zm-2 5v2h6v-2H7zm0 4v2h6v-2H7z"></path>
          ...
          <div class="Desktop-only">
            <a
              ...
              rel="noopener"
              href='https://twitter.com/intent/tweet?text=%22Build%20an%20Accessible%20Optimistic%20Toggle%20That%20Can%20Admit%20It%20Was%20Wrong%22%20by%20babycat%20%23DEVCommunity%20https%3A%2F%2Fdev.to%2Fbabycat%2Fbuild-an-accessible-optimistic-toggle-that-can-admit-it-was-wrong-49gm'>
              Share to X
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fdev.to%2Fbabycat%2Fbuild-an-accessible-optimistic-toggle-that-can-admit-it-was-wrong-49gm&title=Build%20an%20Accessible%20Optimistic%20Toggle%20That%20Can%20Admit%20It%20Was%20Wrong&summary=Keep%20keyboard%20focus%2C%20announced%20state%2C%20and%20server%20truth%20aligned%20when%20an%20optimistic%20setting%20update%20fails%20or%20returns%20out%20of%20order.&source=DEV%20Community">
              Share to LinkedIn
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://www.facebook.com/sharer.php?u=https%3A%2F%2Fdev.to%2Fbabycat%2Fbuild-an-accessible-optimistic-toggle-that-can-admit-it-was-wrong-49gm">
              Share to Facebook
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://s2f.kytta.dev/?text=https%3A%2F%2Fdev.to%2Fbabycat%2Fbuild-an-accessible-optimistic-toggle-that-can-admit-it-was-wrong-49gm">
              Share to Mastodon
            </a>
          </div>

          <web-share-wrapper shareurl="https://dev.to/babycat/build-an-accessible-optimistic-toggle-that-can-admit-it-was-wrong-49gm" sharetitle="Build an Accessible Optimistic Toggle That Can Admit It Was Wrong" sharetext="Keep keyboard focus, announced state, and server truth aligned when an optimistic setting update fails or returns out of order." template="web-share-button">
          </web-share-wrapper>
    ...
    <main id="main-content" class="crayons-layout__content grid gap-4">
      <div class="article-wrapper">
        ...
        <article class="crayons-card crayons-article mb-4"
          ...
          data-article-id="4214975"
          data-article-slug="build-an-accessible-optimistic-toggle-that-can-admit-it-was-wrong-49gm"
          data-author-id="4022684"
          data-author-name="babycat"
          data-author-username="babycat"
          data-co-author-ids=""
          data-path="/babycat/build-an-accessible-optimistic-toggle-that-can-admit-it-was-wrong-49gm"
            ...
            <div class="crayons-article__header__meta">
              <div class="flex s:items-start flex-col s:flex-row">
                ...
                <div class="flex flex-1 mb-5 items-start">
                  <div class="relative">
                      <a href="/babycat"><img class="radius-full align-middle" src="https://media2.dev.to/dynamic/image/width=50,height=50,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Fuser%2Fprofile_image%2F4022684%2Fe78be405-e521-4234-81bb-9fcbc006d5d1.jpg" width="40" height="40" alt="babycat" /></a>
                  </div>
                  <div class="pl-3 flex-1">
                    <a href="/babycat" class="crayons-link fw-bold">babycat</a>
                    
                    <p class="fs-xs color-base-60">
                        Posted on <time datetime="2026-07-23T11:54:28Z" class="date-no-year">Jul 23</time>
      ...
      " href="/t/ux"><span class="crayons-tag__prefix">#</span>ux</a>
          ...
          <div class="crayons-article__main ">
            <div class="crayons-article__body text-styles spec__body" data-article-id="4214975"
              id="article-body">
                <p>A user presses Space on “Email alerts.” The switch immediately turns on. The request fails, the UI silently flips back, and a screen-reader user receives no explanation. Optimistic UI made the happy path faster by making the failure path ambiguous.</p>
...
<h2>
  <a name="use-a-native-control" href="#use-a-native-control">
  </a>
...
<h2>
  <a name="ignore-stale-responses" href="#ignore-stale-responses">
  </a>
...
<span class="nx">input</span><span class="p">.</span><span class="nf">addEventListener</span><span class="p">(</span><span class="dl">"</span><span class="s2">change</span><span class="dl">"</span><span class="p">,</span> <span class="k">async </span><span class="p">()</span> <span class="o">=&gt;</span> <span class="p">{</span>
  ...
  <span class="k">try</span> <span class="p">{</span>
    ...
    <span class="k">if </span><span class="p">(</span><span class="nx">state</span><span class="p">.</span><span class="nx">requestId</span> <span class="o">!==</span> <span class="nx">requestId</span><span class="p">)</span> <span class="k">return</span><span 