---
source_url: https://dev.to/magopredator/corpus-scrub-010-detecta-y-redacta-pii-y-secretos-en-corpus-de-entrenamiento-antes-del-432h
ingested: 2026-07-17
sha256: 9765409c21ecc4b6ccaf782292c15a0f403ee0a93f4f15633d1f5960914de52a
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>corpus-scrub 0.1.0: detecta y redacta PII y secretos en corpus de entrenamiento antes del entrenamiento LLM - DEV Community</title>
    
    <link rel="preload" href="/reactions?article_id=4161691" as="fetch" crossorigin="same-origin">
    <link rel="canonical" href="https://dev.to/magopredator/corpus-scrub-010-detecta-y-redacta-pii-y-secretos-en-corpus-de-entrenamiento-antes-del-432h" />
    <meta name="description" content="corpus-scrub 0.1.0: detecta y redacta PII y secretos en corpus de entrenamiento antes del... Tagged with ai, security, python, opensource.">
    <meta name="keywords" content="ai, security, python, opensource, software, coding, development, engineering, inclusive, community">

    <meta property="og:type" content="article" />
    <meta property="og:url" content="https://dev.to/magopredator/corpus-scrub-010-detecta-y-redacta-pii-y-secretos-en-corpus-de-entrenamiento-antes-del-432h" />
    <meta property="og:title" content="corpus-scrub 0.1.0: detecta y redacta PII y secretos en corpus de entrenamiento antes del entrenamiento LLM" />
    <meta property="og:description" content="corpus-scrub 0.1.0: detecta y redacta PII y secretos en corpus de entrenamiento antes del..." />
    <meta property="og:site_name" content="DEV Community" />
    <meta name="twitter:site" content="@thepracticaldev">
    <meta name="twitter:creator" content="@">
    <meta name="author-trust" content="0">
    <meta name="twitter:title" content="corpus-scrub 0.1.0: detecta y redacta PII y secretos en corpus de entrenamiento antes del entrenamiento LLM">
    <meta name="twitter:description" content="corpus-scrub 0.1.0: detecta y redacta PII y secretos en corpus de entrenamiento antes del...">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:widgets:new-embed-design" content="on">
    <meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1">
      <meta property="og:image" content="https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fctw4qtqf8pwekcwbje3s.png" />
      <meta name="twitter:image:src" content="https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fctw4qtqf8pwekcwbje3s.png">

      <meta name="last-updated" content="2026-07-17 01:31:43 UTC">
      <meta name="user-signed-in" content="false">
      <meta name="head-cached-at" content="1784251903">
  ...
  <div class="crayons-header__container">
    <span class="inline-block m:hidden ">
      <button class="c-btn c-btn--icon-alone js-hamburger-trigger mx-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="ajs7160k61sv50o31e8d7u0bpjafkn5u" class="crayons-icon"><title id="ajs7160k61sv50o31e8d7u0bpjafkn5u">Navigation menu</title>
        ...
        <div class="crayons-fields crayons-fields--horizontal">
          <div class="crayons-field flex-1 relative">
            ...
            <button type="submit" aria-label="Search" class="c-btn c-btn--icon-alone absolute inset-px right-auto mt-0 py-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="ar5im8h3qry4ezgyt1y2gnnnydx8nqh8" aria-hidden="true" class="crayons-icon"><title id="ar5im8h3qry4ezgyt1y2gnnnydx8nqh8">Search</title>
    <path d="M18.031 16.617l4.283 4.282-1.415 1.415-4.282-4.283A8.96 8.96 0 0111 20c-4.968 0-9-4.032-9-9s4.032-9 9-9 9 4.032 9 9a8.96 8.96 0 01-1.969 5.617zm-2.006-.742A6.977 6.977 0 0018 11c0-3.868-3.133-7-7-7-3.868 0-7 3.132-7 7 0 3.867 3.132 7 7 7a6.977 6.977 0 004.875-1.975l.15-.15z"></path>
            ...
            <a class="crayons-header--search-brand-indicator" href="https://www.algolia.com/developers/?utm_source=devto&utm_medium=referral" target="_blank" rel="noopener noreferrer">
                Powered by Algolia
                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" width="24" height="24" viewBox="0 0 500 500.34" role="img" aria-labelledby="ahygeugiwmyzrojm0tu5uq6hqrt02rkn" aria-hidden="true" class="crayons-icon"><title id="ahygeugiwmyzrojm0tu5uq6hqrt02rkn">Search</title>
  ...
  <div class="hamburger__content">
    <header class="hamburger__content__header">
      ...
      <button class="c-btn c-btn--icon-alone js-hamburger-trigger shrink-0" aria-label="Close">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="anripbvndr9idd1qd65d1gk0aztobuzi" aria-hidden="true" class="crayons-icon c-btn__icon"><title id="anripbvndr9idd1qd65d1gk0aztobuzi">Close</title><path d="M12 10.586l4.95-4.95 1.414 1.414-4.95 4.95 4.95 4.95-1.414 1.414-4.95-4.95-4.95 4.95-1.414-1.414 4.95-4.95-4.95-4.95L7.05 5.636l4.95 4.95z"></path></svg>
...
<div id="page-content" class="wrapper stories stories-show articletag-ai articletag-security articletag-python articletag-opensource articleuser-3981057" data-current-page="stories-show">
  <div id="page-content-inner" data-internal-nav="false" data-viewable-id="4161691" data-viewable-type="Article">
...
<script src="https://assets.dev.to/assets/commentDropdowns-7a28d130e5b78d38b30a9495a964003a66bd64fa455fc70b766d69cf06b9ba24.js" defer="defer"></script>
  ...
  <script type="application/ld+json">
    {"@context":"http://schema.org","@type":"Article","mainEntityOfPage":{"@type":"WebPage","@id":"https://dev.to/magopredator/corpus-scrub-010-detecta-y-redacta-pii-y-secretos-en-corpus-de-entrenamiento-antes-del-432h"},"url":"https://dev.to/magopredator/corpus-scrub-010-detecta-y-redacta-pii-y-secretos-en-corpus-de-entrenamiento-antes-del-432h","image":["https://media2.dev.to/dynamic/image/width=1080,height=1080,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fctw4qtqf8pwekcwbje3s.png","https://media2.dev.to/dynamic/image/width=1280,height=720,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fctw4qtqf8pwekcwbje3s.png","https://media2.dev.to/dynamic/image/width=1600,height=900,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fctw4qtqf8pwekcwbje3s.png"],"publisher":{"@context":"http://schema.org","@type":"Organization","name":"DEV Community","logo":{"@context":"http://schema.org","@type":"ImageObject","url":"https://media2.dev.to/dynamic/image/width=192,height=,fit=scale-down,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F8j7kvp660rqzt99zui8e.png","width":"192","height":"192"}},"headline":"corpus-scrub 0.1.0: detecta y redacta PII y secretos en corpus de entrenamiento antes del entrenamiento LLM","author":{"@context":"http://schema.org","@type":"Person","url":"https://dev.to/magopredator","name":"Fenix"},"datePublished":"2026-07-17T01:21:29Z","dateModified":"2026-07-17T01:26:00Z"}
  </script>
    ...
    <span data-testid="tooltip" class="crayons-tooltip__content">
      ...
      <div class="align-center m:relative">
        <button id="article-show-more-button" aria-controls="article-show-more-dropdown" aria-expanded="false" aria-haspopup="true" class="dropbtn crayons-btn crayons-btn--ghost-dimmed crayons-btn--icon-rounded" aria-label="Share post options">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" role="img" aria-labelledby="a313u0jjluilgqs9w3ls6yh0cdqmpieo" aria-hidden="true" class="crayons-icon dropdown-icon"><title id="a313u0jjluilgqs9w3ls6yh0cdqmpieo">More...</title><path fill-rule="evenodd" clip-rule="evenodd" d="M7 12a2 2 0 11-4 0 2 2 0 014 0zm7 0a2 2 0 11-4 0 2 2 0 014 0zm5 2a2 2 0 100-4 2 2 0 000 4z"></path></svg>
        ...
        <div id="article-show-more-dropdown" class="crayons-dropdown side-bar left-2 right-2 m:right-auto m:left-100 s:left-auto mb-1 m:mb-0 top-unset bottom-100 m:top-0 m:bottom-unset">
          <div>
            <button
              ...
              data-postUrl="https://dev.to/magopredator/corpus-scrub-010-detecta-y-redacta-pii-y-secretos-en-corpus-de-entrenamiento-antes-del-432h">
              <span class="fw-bold">Copy link</span>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" id="article-copy-icon" role="img" aria-labelledby="aa78s4w6s8fhj9ld6sb3en7j2fo9zgk8" aria-hidden="true" class="crayons-icon mx-2 shrink-0"><title id="aa78s4w6s8fhj9ld6sb3en7j2fo9zgk8">Copy link</title>
    <path d="M7 6V3a1 1 0 011-1h12a1 1 0 011 1v14a1 1 0 01-1 1h-3v3c0 .552-.45 1-1.007 1H4.007A1 1 0 013 21l.003-14c0-.552.45-1 1.007-1H7zm2 0h8v10h2V4H9v2zm-2 5v2h6v-2H7zm0 4v2h6v-2H7z"></path>
          ...
          <div class="Desktop-only">
            <a
              ...
              rel="noopener"
              href='https://twitter.com/intent/tweet?text=%22corpus-scrub%200.1.0%3A%20detecta%20y%20redacta%20PII%20y%20secretos%20en%20corpus%20de%20entrenamiento%20antes%20del%20entrenamiento%20LLM%22%20by%20Fenix%20%23DEVCommunity%20https%3A%2F%2Fdev.to%2Fmagopredator%2Fcorpus-scrub-010-detecta-y-redacta-pii-y-secretos-en-corpus-de-entrenamiento-antes-del-432h'>
              Share to X
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fdev.to%2Fmagopredator%2Fcorpus-scrub-010-detecta-y-redacta-pii-y-secretos-en-corpus-de-entrenamiento-antes-del-432h&title=corpus-scrub%200.1.0%3A%20detecta%20y%20redacta%20PII%20y%20secretos%20en%20corpus%20de%20entrenamiento%20antes%20del%20entrenamiento%20LLM&summary=corpus-scrub%200.1.0%3A%20detecta%20y%20redacta%20PII%20y%20secretos%20en%20corpus%20de%20entrenamiento%20antes%20del...&source=DEV%20Community">
              Share to LinkedIn
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://www.facebook.com/sharer.php?u=https%3A%2F%2Fdev.to%2Fmagopredator%2Fcorpus-scrub-010-detecta-y-redacta-pii-y-secretos-en-corpus-de-entrenamiento-antes-del-432h">
              Share to Facebook
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://s2f.kytta.dev/?text=https%3A%2F%2Fdev.to%2Fmagopredator%2Fcorpus-scrub-010-detecta-y-redacta-pii-y-secretos-en-corpus-de-entrenamiento-antes-del-432h">
              Share to Mastodon
            </a>
          </div>

          <web-share-wrapper shareurl="https://dev.to/magopredator/corpus-scrub-010-detecta-y-redacta-pii-y-secretos-en-corpus-de-entrenamiento-antes-del-432h" sharetitle="corpus-scrub 0.1.0: detecta y redacta PII y secretos en corpus de entrenamiento antes del entrenamiento LLM" sharetext="corpus-scrub 0.1.0: detecta y redacta PII y secretos en corpus de entrenamiento antes del..." template="web-share-button">
          </web-share-wrapper>
    ...
    <main id="main-content" class="crayons-layout__content grid gap-4">
      <div class="article-wrapper">
        ...
        <article class="crayons-card crayons-article mb-4"
          ...
          data-article-id="4161691"
          data-article-slug="corpus-scrub-010-detecta-y-redacta-pii-y-secretos-en-corpus-de-entrenamiento-antes-del-432h"
          data-author-id="3981057"
          data-author-name="Fenix"
          data-author-username="magopredator"
          data-co-author-ids=""
          data-path="/magopredator/corpus-scrub-010-detecta-y-redacta-pii-y-secretos-en-corpus-de-entrenamiento-antes-del-432h"
          ...
          <header class="crayons-article__header" id="main-title">
              <a class="crayons-article__cover" href="https://media2.dev.to/dynamic/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fctw4qtqf8pwekcwbje3s.png">
                <img
                  src="https://media2.dev.to/dynamic/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fctw4qtqf8pwekcwbje3s.png"
                  style="aspect-ratio: auto 1000 / 420;"
                  width="1000" height="420"
                  class="crayons-article__cover__image" alt="Cover image for corpus-scrub 0.1.0: detecta y redacta PII y secretos en corpus de entrenamiento antes del entrenamiento LLM">
              </a>
            ...
            <div class="crayons-article__header__meta">
              <div class="flex s:items-start flex-col s:flex-row">
                ...
                <div class="flex flex-1 mb-5 items-start">
                  <div class="relative">
                      <a href="/magopredator"><img class="radius-full align-middle" src="https://media2.dev.to/dynamic/image/width=50,height=50,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Fuser%2Fprofile_image%2F3981057%2Fe5877943-3569-4c4d-b7f1-7490f73e13b5.jpeg" width="40" height="40" alt="Fenix" /></a>
                  </div>
                  <div class="pl-3 flex-1">
                    <a href="/magopredator" class="crayons-link fw-bold">Fenix</a>
                    
                    <p class="fs-xs color-base-60">
                        Posted on <time datetime="2026-07-17T01:21:29Z" class="date-no-year">Jul 17</time>
    ...
    ><span class="crayons-reaction__icon crayons-reaction__icon--inactive p-1"><img src="https://assets.dev.to/assets/fire-f60e7a582391810302117f987b22a8ef04a2fe0df7e3258a5f49332df1cec71e.svg" width="24" height="24" /></span>
      ...
      " href="/t/python"><span class="crayons-tag__prefix">#</span>python</a>
          ...
          <div class="crayons-article__main ">
            <div class="crayons-article__body text-styles spec__body" data-article-id="4161691"
              id="article-body">
                <h1>
  <a name="corpusscrub-010-detecta-y-redacta-pii-y-secretos-en-corpus-de-entrenamiento-antes-del-entrenamiento" href="#corpusscrub-010-detecta-y-redacta-pii-y-secretos-en-corpus-de-entrenamiento-antes-del-entrenamiento">
  </a>
...
<h2>
  <a name="el-problema" href="#el-problema">
  </a>
  El problema
</h2>
...
<ul>
<li>Modelos de síntesis de imágenes que retroalimentan riesgos de privacidad amplificados en mezclas real-sintético (<a href="https://arxiv.org/abs/2607.13541" target="_blank" rel="noopener noreferrer">arXiv 2607.13541</a>)</li>
<li>Memorización no intencionada de información sensible en fine-tuning (<a href="https://arxiv.org/abs/2601.17480" target="_blank" rel="noopener noreferrer">arXiv 2601.17480</a>)</li>
<li>Direcciones de activación universales para fuga de PII (UniLeak) (<a href="https://arxiv.org/abs/2602.16980" target="_blank" rel="noopener noreferrer">arXiv 2602.16980</a>)</li>
</ul>
...
<h2>
  <a name="qu%C3%A9-hace" href="#qu%C3%A9-hace">
  </a>
  Qué hace
</h2>
...
<h2>
  <a name="c%C3%B3mo-funciona" href="#c%C3%B3mo-funciona">
  </a>
  Cómo funciona
</h2>
...
<pre class="highlight shell"><code><span class="c"># Instalar<