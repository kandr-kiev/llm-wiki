---
source_url: https://arxiv.org/abs/2607.20467
ingested: 2026-07-24
sha256: 0f84b993d13c42de7a0d0040af6040d9cebe8a8ce72f0087a185fa23b8b21879
blog_source: ArXiv AI
---
<!DOCTYPE html>
<html lang="en">

<head><script>document.documentElement.classList.add('js');</script>  <title>[2607.20467] DC-Leap: Training-Free Acceleration of dLLMs via Draft-Guided Contiguous Leaping Decoding</title>
...
<meta name="twitter:image:alt" content="arXiv logo"/>
  ...
  <script src="/static/browse/0.3.4/js/cite.js" type="text/javascript"></script><meta name="citation_title" content="DC-Leap: Training-Free Acceleration of dLLMs via Draft-Guided Contiguous Leaping Decoding" /><meta name="citation_author" content="Jiao, Yanhua" /><meta name="citation_author" content="Wu, Tianyi" /><meta name="citation_author" content="Sun, Xiaoxi" /><meta name="citation_author" content="Li, Yulin" /><meta name="citation_author" content="Zhen, HuiLing" /><meta name="citation_author" content="Qin, Libo" /><meta name="citation_author" content="Hu, Baotian" /><meta name="citation_author" content="Tian, Zhuotao" /><meta name="citation_author" content="Zhang, Min" /><meta name="citation_date" content="2026/05/19" /><meta name="citation_online_date" content="2026/05/19" /><meta name="citation_pdf_url" content="https://arxiv.org/pdf/2607.20467" /><meta name="citation_arxiv_id" content="2607.20467" /><meta name="citation_abstract" content="While parallel decoding is central to the efficiency of Diffusion Large Language Models (dLLMs), current strategies are often hindered by overly conservative confidence thresholds. These thresholds, necessitated by the Joint Probability Dependence Error (JPDE), result in redundant denoising iterations and suboptimal inference speeds. To overcome this, we propose DC-Leap, a training-free framework that enables reliable acceleration of dLLMs in the moderate-confidence regime. DC-Leap introduces a Dynamic Contiguous Verification strategy that integrates strictly-ordered causal constraints into the parallel decoding process. By progressively validating token dependencies, this mechanism effectively neutralizes the JPDE, enabling reliable acceleration with comparable performance. Furthermore, DC-Leap incorporates the draft-guided decoding mechanism, where the draft helps extend the context by leaping forward across multiple tokens, providing look-ahead context and retaining the structural benefits of bidirectional attention during inference. Extensive experiments on standard benchmarks demonstrate that DC-Leap achieves substantial speedups, up to 53.19x on MBPP for long-sequence generation, and up to 105.02x when combined with KV-Cache with comparable generation quality. Code is available at https://github.com/ffh-wyls/DC-Leap ." />
</head>
...
rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
    ...
    <rdf:Description
        rdf:about="/abs/2607.20467"
        dc:identifier="/abs/2607.20467"
        dc:title="DC-Leap: Training-Free Acceleration of dLLMs via Draft-Guided Contiguous Leaping Decoding"
        trackback:ping="/trackback/2607.20467" />
    </rdf:RDF>
--><div id="abs-outer">
  ...
  <div class="leftcolumn">
    ...
    <div class="header-breadcrumbs-mobile">
      <strong>arXiv:2607.20467</strong> (cs)
    </div>
...
<div id="content-inner">
  ...
  [Submitted on 19 May 2026]</div>
    <h1 class="title mathjax"><span class="descriptor">Title:</span>DC-Leap: Training-Free Acceleration of dLLMs via Draft-Guided Contiguous Leaping Decoding</h1>
    <div class="authors"><span class="descriptor">Authors:</span><a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Jiao,+Y" rel="nofollow">Yanhua Jiao</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Wu,+T" rel="nofollow">Tianyi Wu</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Sun,+X" rel="nofollow">Xiaoxi Sun</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Li,+Y" rel="nofollow">Yulin Li</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Zhen,+H" rel="nofollow">HuiLing Zhen</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Qin,+L" rel="nofollow">Libo Qin</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Hu,+B" rel="nofollow">Baotian Hu</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Tian,+Z" rel="nofollow">Zhuotao Tian</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Zhang,+M" rel="nofollow">Min Zhang</a></div>            <div id="download-button-info" hidden>View a PDF of the paper titled DC-Leap: Training-Free Acceleration of dLLMs via Draft-Guided Contiguous Leaping Decoding, by Yanhua Jiao and 8 other authors</div>
    <a class="mobile-submission-download" href="/pdf/2607.20467">View PDF</a>
    <a class="mobile-submission-download" href="https://arxiv.org/html/2607.20467v1">HTML (experimental)</a>



    <blockquote class="abstract mathjax">
            <span class="descriptor">Abstract:</span>While parallel decoding is central to the efficiency of Diffusion Large Language Models (dLLMs), current strategies are often hindered by overly conservative confidence thresholds. These thresholds, necessitated by the Joint Probability Dependence Error (JPDE), result in redundant denoising iterations and suboptimal inference speeds. To overcome this, we propose DC-Leap, a training-free framework that enables reliable acceleration of dLLMs in the moderate-confidence regime. DC-Leap introduces a Dynamic Contiguous Verification strategy that integrates strictly-ordered causal constraints into the parallel decoding process. By progressively validating token dependencies, this mechanism effectively neutralizes the JPDE, enabling reliable acceleration with comparable performance. Furthermore, DC-Leap incorporates the draft-guided decoding mechanism, where the draft helps extend the context by leaping forward across multiple tokens, providing look-ahead context and retaining the structural benefits of bidirectional attention during inference. Extensive experiments on standard benchmarks demonstrate that DC-Leap achieves substantial speedups, up to 53.19x on MBPP for long-sequence generation, and up to 105.02x when combined with KV-Cache with comparable generation quality. Code is available at <a href="https://github.com/ffh-wyls/DC-Leap" rel="external noopener nofollow" class="link-external link-https">this https URL</a> .
    </blockquote>
    ...
    <div class="metatable">
      <table summary="Additional metadata"><tr>
          ...
          <td class="tablecell arxivid"><span class="arxivid"><a href="https://arxiv.org/abs/2607.20467">arXiv:2607.20467</a> [cs.AI]</span></td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxividv">(or <span class="arxivid">
              <a href="https://arxiv.org/abs/2607.20467v1">arXiv:2607.20467v1</a> [cs.AI]</span> for this version)
          </td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxivdoi">              <a href="https://doi.org/10.48550/arXiv.2607.20467"  id="arxiv-doi-link">https://doi.org/10.48550/arXiv.2607.20467</a><div class="button-and-tooltip">
    ...
    <div class="submission-history">
      <h2>Submission history</h2> From: Yulin Li [<a href="/show-email/d1b4a1df/2607.20467" rel="nofollow">view email</a>]      <br/>    <strong>[v1]</strong>
        Tue, 19 May 2026 06:27:58 UTC (1,756 KB)<br/>
</div>
  </div>
  <!--end leftcolumn-->
...
View a PDF of the paper titled DC-Leap: Training-Free Acceleration of dLLMs via Draft-Guided Contiguous Leaping Decoding, by Yanhua Jiao and 8 other authors</div><li><a href="/pdf/2607.20467" aria-describedby="download-button-info" accesskey="f" class="abs-button download-pdf">View PDF</a></li><li><a href="https://arxiv.org/html/2607.20467v1" class="abs-button" id="latexml-download-link">HTML (experimental)</a></li><li><a href="/src/2607.20467" class="abs-button download-eprint">TeX Source
 </a></li></ul>
  ...
  <div class="prevnext">
<span class="arrow">
      <a class="abs-button prev-url" href="/prevnext?id=2607.20467&amp;function=prev&amp;context=cs.AI"
         accesskey="p" title="previous in cs.AI (accesskey p)" rel="nofollow">&lt;&nbsp;prev</a>
    </span>
    <span class="is-hidden-mobile">&nbsp; | &nbsp;</span>    <span class="arrow">
      <a class="abs-button next-url" href="/prevnext?id=2607.20467&amp;function=next&amp;context=cs.AI" accesskey="n"
    ...
    <div class="switch context-change">
        <a href="/abs/2607.20467?context=cs" rel="nofollow">cs</a><br class="is-hidden-mobile">
        <a class="subclass" href="/abs/2607.20467?context=cs.LG" rel="nofollow">cs.LG</a><br class="is-hidden-mobile">
    </div>
  </div>
      ...
      <div class="extra-ref-cite">
        ...
        <ul>
          <li><a  class="abs-button abs-button-small cite-ads" href="https://ui.adsabs.harvard.edu/abs/arXiv:2607.20467">NASA ADS</a></li><li><a  class="abs-button abs-button-small cite-google-scholar" href="https://scholar.google.com/scholar_lookup?arxiv_id=2607.20467" target="_blank" rel="noopener">Google Scholar</a></li>
          <li><a  class="abs-button abs-button-small cite-semantic-scholar" href="https://api.semanticscholar.org/arXiv:2607.20467" target="_blank" rel="noopener">Semantic Scholar</a></li>
        </ul>
...
<div id='bib-cite-modal' class='bib-modal' hidden='true'>
  ...
  <div><h3>Bookmark</h3></div><a class="abs-button abs-button-grey abs-button-small" href="http://www.bibsonomy.org/BibtexHandler?requTask=upload&amp;url=https://arxiv.org/abs/2607.20467&amp;description=DC-Leap: Training-Free Acceleration of dLLMs via Draft-Guided Contiguous Leaping Decoding"
     title="Bookmark on BibSonomy">
    <img src="/static/browse/0.3.4/images/icons/social/bibsonomy.png"
         alt="BibSonomy"/>
  </a>
  <a class="abs-button abs-button-grey abs-button-small" href="https://reddit.com/submit?url=https://arxiv.org/abs/2607.20467&amp;title=DC-Leap: Training-Free Acceleration of dLLMs via Draft-Guided Contiguous Leaping Decoding"
...
<!-- END LABS AREA -->
  <div class="endorsers">
    <a href="/auth/show-endorsers/2607.20467" class="endorser-who" rel="nofollow">Which authors of this paper are endorsers?</a> |
