---
source_url: https://arxiv.org/abs/2607.20469
ingested: 2026-07-24
sha256: 26666f3c7ea78dfc42e3bcb4890555641fe37ff41560e5268632293cb9dd9292
blog_source: ArXiv AI
---
<!DOCTYPE html>
<html lang="en">

<head><script>document.documentElement.classList.add('js');</script>  <title>[2607.20469] DecodeShare: Tracing the Shared Subspace of LLM Decode-Time Decisions</title>
...
<meta name="twitter:image:alt" content="arXiv logo"/>
  ...
  <script src="/static/browse/0.3.4/js/cite.js" type="text/javascript"></script><meta name="citation_title" content="DecodeShare: Tracing the Shared Subspace of LLM Decode-Time Decisions" /><meta name="citation_author" content="Shao, Zishan" /><meta name="citation_author" content="Zhang, Lixun" /><meta name="citation_author" content="Cui, Kangning" /><meta name="citation_author" content="Wang, Yixiao" /><meta name="citation_author" content="Jiang, Ting" /><meta name="citation_author" content="Ye, Hancheng" /><meta name="citation_author" content="Wang, Qinsi" /><meta name="citation_author" content="Du, Zhixu" /><meta name="citation_author" content="Fu, Yuzhe" /><meta name="citation_author" content="Yang, Fan" /><meta name="citation_author" content="Zhuo, Danyang" /><meta name="citation_author" content="Chen, Yiran" /><meta name="citation_author" content="Li, Hai Helen" /><meta name="citation_date" content="2026/05/21" /><meta name="citation_online_date" content="2026/05/21" /><meta name="citation_pdf_url" content="https://arxiv.org/pdf/2607.20469" /><meta name="citation_arxiv_id" content="2607.20469" /><meta name="citation_abstract" content="Large language models (LLMs) handle many tasks with one set of parameters, but under KV-cached inference it is unclear what task-general structure, if any, is used at decode time rather than during prefill. We propose DecodeShare, a protocol that identifies a low-dimensional subspace consistently shared across tasks in decode-time hidden states, and then tests its causal role by removing that subspace only during decoding. In our experiments, disturbing the discovered shared subspace degrades decision performance far more than disturbing either a prefill-derived or random subspace under the same intervention budget. We further show this decode-shared subspace has practical consequences for activation steering: common steering directions can overlap the task-general decode channel. Projecting out this shared subspace directly separates the functional roles of the two components, while evaluating steering vectors at decode-time yields more reliable signal for downstream deployment than prefill-based proxies. Despite its compactness, the shared subspace can serve as a high-leverage causal channel at decode time. Code is available at: https://github.com/Zishan-Shao/decodeshare.git." />
</head>
...
rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
    ...
    <rdf:Description
        rdf:about="/abs/2607.20469"
        dc:identifier="/abs/2607.20469"
        dc:title="DecodeShare: Tracing the Shared Subspace of LLM Decode-Time Decisions"
        trackback:ping="/trackback/2607.20469" />
    </rdf:RDF>
--><div id="abs-outer">
  ...
  <div class="leftcolumn">
    ...
    <div class="header-breadcrumbs-mobile">
      <strong>arXiv:2607.20469</strong> (cs)
    </div>
<link rel="stylesheet" type="text/css" href="/static/base/1.0.1/css/abs.css">
<div id="content-inner">
  <div id="abs">
    <div class="dateline">
  [Submitted on 21 May 2026]</div>
    <h1 class="title mathjax"><span class="descriptor">Title:</span>DecodeShare: Tracing the Shared Subspace of LLM Decode-Time Decisions</h1>
    <div class="authors"><span class="descriptor">Authors:</span><a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Shao,+Z" rel="nofollow">Zishan Shao</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Zhang,+L" rel="nofollow">Lixun Zhang</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Cui,+K" rel="nofollow">Kangning Cui</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Wang,+Y" rel="nofollow">Yixiao Wang</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Jiang,+T" rel="nofollow">Ting Jiang</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Ye,+H" rel="nofollow">Hancheng Ye</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Wang,+Q" rel="nofollow">Qinsi Wang</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Du,+Z" rel="nofollow">Zhixu Du</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Fu,+Y" rel="nofollow">Yuzhe Fu</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Yang,+F" rel="nofollow">Fan Yang</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Zhuo,+D" rel="nofollow">Danyang Zhuo</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Chen,+Y" rel="nofollow">Yiran Chen</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Li,+H+H" rel="nofollow">Hai Helen Li</a></div>            <div id="download-button-info" hidden>View a PDF of the paper titled DecodeShare: Tracing the Shared Subspace of LLM Decode-Time Decisions, by Zishan Shao and 12 other authors</div>
    <a class="mobile-submission-download" href="/pdf/2607.20469">View PDF</a>
    <a class="mobile-submission-download" href="https://arxiv.org/html/2607.20469v1">HTML (experimental)</a>



    <blockquote class="abstract mathjax">
            <span class="descriptor">Abstract:</span>Large language models (LLMs) handle many tasks with one set of parameters, but under KV-cached inference it is unclear what task-general structure, if any, is used at decode time rather than during prefill. We propose DecodeShare, a protocol that identifies a low-dimensional subspace consistently shared across tasks in decode-time hidden states, and then tests its causal role by removing that subspace only during decoding. In our experiments, disturbing the discovered shared subspace degrades decision performance far more than disturbing either a prefill-derived or random subspace under the same intervention budget. We further show this decode-shared subspace has practical consequences for activation steering: common steering directions can overlap the task-general decode channel. Projecting out this shared subspace directly separates the functional roles of the two components, while evaluating steering vectors at decode-time yields more reliable signal for downstream deployment than prefill-based proxies. Despite its compactness, the shared subspace can serve as a high-leverage causal channel at decode time. Code is available at: <a href="https://github.com/Zishan-Shao/decodeshare.git" rel="external noopener nofollow" class="link-external link-https">this https URL</a>.
    </blockquote>
    ...
    <div class="metatable">
      <table summary="Additional metadata"><tr>
          ...
          <td class="tablecell arxivid"><span class="arxivid"><a href="https://arxiv.org/abs/2607.20469">arXiv:2607.20469</a> [cs.AI]</span></td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxividv">(or <span class="arxivid">
              <a href="https://arxiv.org/abs/2607.20469v1">arXiv:2607.20469v1</a> [cs.AI]</span> for this version)
          </td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxivdoi">              <a href="https://doi.org/10.48550/arXiv.2607.20469" id="arxiv-doi-link">https://doi.org/10.48550/arXiv.2607.20469</a><div class="button-and-tooltip">
    ...
    <div class="submission-history">
      <h2>Submission history</h2> From: Zishan Shao [<a href="/show-email/60b5e901/2607.20469" rel="nofollow">view email</a>]      <br/>    <strong>[v1]</strong>
        Thu, 21 May 2026 18:59:00 UTC (1,321 KB)<br/>
</div>
  </div>
  <!--end leftcolumn-->
...
View a PDF of the paper titled DecodeShare: Tracing the Shared Subspace of LLM Decode-Time Decisions, by Zishan Shao and 12 other authors</div><li><a href="/pdf/2607.20469" aria-describedby="download-button-info" accesskey="f" class="abs-button download-pdf">View PDF</a></li><li><a href="https://arxiv.org/html/2607.20469v1" class="abs-button" id="latexml-download-link">HTML (experimental)</a></li><li><a href="/src/2607.20469" class="abs-button download-eprint">TeX Source
 </a></li></ul>
  ...
  <div class="prevnext">
<span class="arrow">
      <a class="abs-button prev-url" href="/prevnext?id=2607.20469&amp;function=prev&amp;context=cs.AI"
         accesskey="p" title="previous in cs.AI (accesskey p)" rel="nofollow">&lt;&nbsp;prev</a>
    </span>
    <span class="is-hidden-mobile">&nbsp; | &nbsp;</span>    <span class="arrow">
      <a class="abs-button next-url" href="/prevnext?id=2607.20469&amp;function=next&amp;context=cs.AI" accesskey="n"
    ...
    <div class="switch context-change">
        <a href="/abs/2607.20469?context=cs" rel="nofollow">cs</a><br class="is-hidden-mobile">
    </div>
  </div>
      ...
      <div class="extra-ref-cite">
        ...
        <ul>
          <li><a  class="abs-button abs-button-small cite-ads" href="https://ui.adsabs.harvard.edu/abs/arXiv:2607.20469">NASA ADS</a></li><li><a  class="abs-button abs-button-small cite-google-scholar" href="https://scholar.google.com/scholar_lookup?arxiv_id=2607.20469" target="_blank" rel="noopener">Google Scholar</a></li>
          <li><a  class="abs-button abs-button-small cite-semantic-scholar" href="https://api.semanticscholar.org/arXiv:2607.20469" target="_blank" rel="noopener">Semantic Scholar</a></li>
        </ul>
...
<div id='bib-cite-modal' class='bib-modal' hidden='true'>
  ...
  <div><h3>Bookmark</h3></div><a class="abs-button abs-button-grey abs-button-small" href="http://www.bibsonomy.org/BibtexHandler?requTask=upload&amp;url=https://arxiv.org/abs/2607.20469&amp;description=DecodeShare: Tracing the Shared Subspace of LLM Decode-Time Decisions"
     title="Bookmark on BibSonomy">
    <img src="/static/browse/0.3.4/images/icons/social/bibsonomy.png"
         alt="BibSonomy"/>
  </a>
  <a class="abs-button abs-button-grey abs-button-small" href="https://reddit.com/submit?url=https://arxiv.org/abs/2607.20469&amp;title=DecodeShare: Tracing the Shared Subspace of LLM Decode-Time Decisions"
...
<!-- END LABS AREA -->
  <div class="endorsers">
    <a href="/auth/show-endorsers/2607.20469" class="endorser-who" rel="nofollow">Which authors of this paper are endorsers?</a> |
