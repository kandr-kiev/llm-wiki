...
ingested: 2026-07-22
sha256: dac8a91bc4fd900b001becd4b7580e442260736f4e2c0ffd185b9a0ea6f5afe3
...
<html>
    <head>
        <title>
            Experimental Linux support for the Fairphone 6 wide camera Â· nondescriptpointer
        </title>
        <meta charset="utf-8" />
    ...
    <body>
        <header>
            <div class="title">
                <p class="site"><span>nondescript</span>pointer</p>
                <p class="subtitle">Software freedom for XR and mobile</p>
            </div>
            <nav>
                <a href="/">About</a>
                <a href="/articles">Articles</a>
                <a href="/rss.xml">RSS</a>
                <a href="https://github.com/nondescriptpointer">Github</a>
            </nav>
        </header>
        <main><article>
  <header class="article-header">
    <h1>Experimental Linux support for the Fairphone 6 wide camera</h1>
    <p class="dates"><time class="date" datetime="2026-07-21">Published 21 Jul 2026</time></p>
  </header>
<figure class="video" style="max-width: 250px;">
...
<pre><code>image sensor  â  CSI-2 D-PHY  â  CSIPHY  â  CSID  â  ISP (VFE/TFE)  â  memory
...
<p>That was the point at which the camera physically worked: <strong>OV13B10 â CSIPHY â CSID â TFE665 â DDR</strong>, delivering genuine Bayer frames.</p>
...
<p>The fix was small. The OV13B10's analogue gain is linear, with <code>0x80 = 1Ã</code>, or <code>gain = code / 128</code>, which is the same behaviour as several other OmniVision sensors. I added a class to libcamera's sensor-helper database:</p>
...
<h3>Binned modes</h3>
<p>The OV13B10 driver advertised several resolutions, including 2Ã2-binned half-resolution modes. On this CAMSS path, <strong>the binned modes produced garbled, sheared output</strong>. Their readout geometry did not match the declared frame size, while full-resolution and a couple of other modes were clean.</p>
...
<li><strong>The preview field of view is cropped</strong> at common resolutions because the 2Ã2-binned sensor modes are broken on this path and the software ISP crops instead of scaling. Fixing the binned-mode register sequences, or adding a scaler, would restore the full ultra-wide field of view.</li>
...
<li>Prepare the parts that are ready for upstreaming.</li>
        ...
        <footer>
            All site content has been marked as dedicated to the public domain
            under
            <a href="https://creativecommons.org/publicdomain/zero/1.0/"
                >CC0 1.0</a
            >. This site does not collect any user data.
        </footer>
    </body>
</html>