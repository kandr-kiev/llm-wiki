...
ingested: 2026-07-11
sha256: daebfb563e529636ffe88ee8f5e59b9822457f68b4ce14f6a65df859847268e2
...
<p>Above: The 4 apps. Left to right: <em><em>Oura</em></em> - I love this "grand overview" summary page, it's dense with just the info you want, and it's super easy to swipe left/right for other days. <em><em>Whoop</em></em> - less dense, you have to move around a lot to "treasure hunt" the information you want. <em><em>8Sleep</em></em> - pretty decent. <em><em>AutoSleep</em></em> - looks cool but the numbers are all wrong so <code>¯\(ツ)/¯</code>.</p>
