...
<html>
  <head>
    <title>Finding the Words to Say: Hidden State Visualizations for Language Models – Jay Alammar – Visualizing machine learning one concept at a time.</title>
...
" />
    ...
    <meta property="og:title" content="Finding the Words to Say: Hidden State Visualizations for Language Models" />
    <meta property="twitter:title" content="Finding the Words to Say: Hidden State Visualizations for Language Models" />
  ...
  <body>
    ...
    <div id="main" role="main" class="container">
      <article class="post">
  <h1>Finding the Words to Say: Hidden State Visualizations for Language Models</h1>
...
@article{dosovitskiy2020image,
  ...
  author={Dosovitskiy, Alexey and Beyer, Lucas and Kolesnikov, Alexander and Weissenborn, Dirk and Zhai, Xiaohua and Un