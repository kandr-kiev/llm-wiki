...
ingested: 2026-07-23
sha256: f7cf0c5dbf01925fbf0fe99db030b008339b7eae5d0c0624efccf996737631c2
blog_source: ArXiv AI
---
<!DOCTYPE html>
<html lang="en">

<head><script>document.documentElement.classList.add('js');</script>  <title>[2607.19349] FineServe: A Fine-Grained Dataset and Characterization of Global LLM Serving Workloads</title>
...
<meta name="twitter:image:alt" content="arXiv logo"/>
  ...
  <script src="/static/browse/0.3.4/js/cite.js" type="text/javascript"></script><meta name="citation_title" content="FineServe: A Fine-Grained Dataset and Characterization of Global LLM Serving Workloads" /><meta name="citation_author" content="Zhang, Tiancheng" /><meta name="citation_author" content="Huang, Shaoyuan" /><meta name="citation_author" content="Wang, Mingyuan" /><meta name="citation_author" content="Zhao, Yunfeng" /><meta name="citation_author" content="Wang, Xiaofei" /><meta name="citation_author" content="Wang, Wenyu" /><meta name="citation_date" content="2026/04/17" /><meta name="citation_online_date" content="2026/04/17" /><meta name="citation_pdf_url" content="https://arxiv.org/pdf/2607.19349" /><meta name="citation_arxiv_id" content="2607.19349" /><meta name="citation_abstract" content="Large language models (LLMs) are increasingly deployed as always-on online services, making efficient LLM serving a critical systems challenge. Achieving low latency and high throughput under volatile demand requires deep understanding of real-world serving workloads, yet existing studies often rely on proxy traces or coarse-grained characterizations that fail to capture the heterogeneity of modern multi-model LLM platforms. We present FineServe, an in-the-wild, multi-model LLM serving workload dataset collected from a global commercial marketplace, enabling fine-grained characterization of real-world serving dynamics across heterogeneous models and tasks. Leveraging FineServe, we conduct a comprehensive analysis of arrival dynamics and token behavior, revealing fundamentally different fluctuation regimes across model architectures, scales and task intents. Building on these insights, we develop the FineServe workload generator, which composes fine-grained model-aware workloads into configurable mixtures tailored for benchmarking multi-model serving platforms. By exposing these fine-grained workload dynamics, FineServe provides a realistic foundation for evaluating routing, scheduling, and capacity-planning strategies in LLM serving systems. FineServe is available at https://github.com/hihiztc1/FineServe." />
</head>
...
rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
    ...
    <rdf:Description
        rdf:about="/abs/2607.19349"
        dc:identifier="/abs/2607.19349"
        dc:title="FineServe: A Fine-Grained Dataset and Characterization of Global LLM Serving Workloads"
        trackback:ping="/trackback/2607.19349" />
    </rdf:RDF>
--><div id="abs-outer">
  ...
  <div class="leftcolumn">
    ...
    <div class="header-breadcrumbs-mobile">
      <strong>arXiv:2607.19349</strong> (cs)
    </div>
<link rel="stylesheet" type="text/css" href="/static/base/1.0.1/css/abs.css">
<div id="content-inner">
  <div id="abs">
    <div class="dateline">
  [Submitted on 17 Apr 2026]</div>
    <h1 class="title mathjax"><span class="descriptor">Title:</span>FineServe: A Fine-Grained Dataset and Characterization of Global LLM Serving Workloads</h1>
    <div class="authors"><span class="descriptor">Authors:</span><a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Zhang,+T" rel="nofollow">Tiancheng Zhang</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Huang,+S" rel="nofollow">Shaoyuan Huang</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Wang,+M" rel="nofollow">Mingyuan Wang</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Zhao,+Y" rel="nofollow">Yunfeng Zhao</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Wang,+X" rel="nofollow">Xiaofei Wang</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Wang,+W" rel="nofollow">Wenyu Wang</a></div>            <div id="download-button-info" hidden>View a PDF of the paper titled FineServe: A Fine-Grained Dataset and Characterization of Global LLM Serving Workloads, by Tiancheng Zhang and 5 other authors</div>
    <a class="mobile-submission-download" href="/pdf/2607.19349">View PDF</a>
    <a class="mobile-submission-download" href="https://arxiv.org/html/2607.19349v1">HTML (experimental)</a>



    <blockquote class="abstract mathjax">
            <span class="descriptor">Abstract:</span>Large language models (LLMs) are increasingly deployed as always-on online services, making efficient LLM serving a critical systems challenge. Achieving low latency and high throughput under volatile demand requires deep understanding of real-world serving workloads, yet existing studies often rely on proxy traces or coarse-grained characterizations that fail to capture the heterogeneity of modern multi-model LLM platforms. We present FineServe, an in-the-wild, multi-model LLM serving workload dataset collected from a global commercial marketplace, enabling fine-grained characterization of real-world serving dynamics across heterogeneous models and tasks. Leveraging FineServe, we conduct a comprehensive analysis of arrival dynamics and token behavior, revealing fundamentally different fluctuation regimes across model architectures, scales and task intents. Building on these insights, we develop the FineServe workload generator, which composes fine-grained model-aware workloads into configurable mixtures tailored for benchmarking multi-model serving platforms. By exposing these fine-grained workload dynamics, FineServe provides a realistic foundation for evaluating routing, scheduling, and capacity-planning strategies in LLM serving systems. FineServe is available at <a href="https://github.com/hihiztc1/FineServe" rel="external noopener nofollow" class="link-external link-https">this https URL</a>.
    </blockquote>
    ...
    <div class="metatable">
      <table summary="Additional metadata">        <tr>
          ...
          <td class="tablecell comments mathjax">14 pages, 14 figures</td>
        </tr>
<tr>
          ...
          <td class="tablecell arxivid"><span class="arxivid"><a href="https://arxiv.org/abs/2607.19349">arXiv:2607.19349</a> [cs.AI]</span></td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxividv">(or <span class="arxivid">
              <a href="https://arxiv.org/abs/2607.19349v1">arXiv:2607.19349v1</a> [cs.AI]</span> for this version)
          </td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxivdoi">              <a href="https://doi.org/10.48550/arXiv.2607.19349"  id="arxiv-doi-link">https://doi.org/10.48550/arXiv.2607.19349</a><div class="button-and-tooltip">
    ...
    <div class="submission-history">
      <h2>Submission history</h2> From: Tiancheng Zhang [<a href="/show-email/ea7ba389/2607.19349" rel="nofollow">view email</a>]      <br/>    <strong>[v1]</strong>
        Fri, 17 Apr 2026 13:02:56 UTC (1,926 KB)<br/>
</div>
  </div>
  <!--end leftcolumn-->
...
View a PDF of the paper titled FineServe: A Fine-Grained Dataset and Characterization of Global LLM Serving Workloads, by Tiancheng Zhang and 5 other authors</div><li><a href="/pdf/2607.19349" aria-describedby="download-button-info" accesskey="f" class="abs-button download-pdf">View PDF</a></li><li><a href="https://arxiv.org/html/2607.19349v1" class="abs-button" id="latexml-download-link">HTML (experimental)</a></li><li><a href="/src/2607.19349" class="abs-button download-eprint">TeX Source
 </a></li></ul>
  ...
  <div class="prevnext">
<span class="arrow">
      <a class="abs-button prev-url" href="/prevnext?id=2607.19349&amp;function=prev&amp;context=cs.AI"
         accesskey="p" title="previous in cs.AI (accesskey p)" rel="nofollow">&lt;&nbsp;prev</a>
    </span>
    <span class="is-hidden-mobile">&nbsp; | &nbsp;</span>    <span class="arrow">
      <a class="abs-button next-url" href="/prevnext?id=2607.19349&amp;function=next&amp;context=cs.AI" accesskey="n"
    ...
    <div class="switch context-change">
        <a href="/abs/2607.19349?context=cs" rel="nofollow">cs</a><br class="is-hidden-mobile">
    </div>
  </div>
      ...
      <div class="extra-ref-cite">
        ...
        <ul>
          <li><a  class="abs-button abs-button-small cite-ads" href="https://ui.adsabs.harvard.edu/abs/arXiv:2607.19349">NASA ADS</a></li><li><a  class="abs-button abs-button-small cite-google-scholar" href="https://scholar.google.com/scholar_lookup?arxiv_id=2607.19349" target="_blank" rel="noopener">Google Scholar</a></li>
          <li><a  class="abs-button abs-button-small cite-semantic-scholar" href="https://api.semanticscholar.org/arXiv:2607.19349" target="_blank" rel="noopener">Semantic Scholar</a></li>
        </ul>
...
<div id='bib-cite-modal' class='bib-modal' hidden='true'>
  ...
  <div><h3>Bookmark</h3></div><a class="abs-button abs-button-grey abs-button-small" href="http://www.bibsonomy.org/BibtexHandler?requTask=upload&amp;url=https://arxiv.org/abs/2607.19349&amp;description=FineServe: A Fine-Grained Dataset and Characterization of Global LLM Serving Workloads"
     title="Bookmark on BibSonomy">
    <img src="/static/browse/0.3.4/images/icons/social/bibsonomy.png"
         alt="BibSonomy"/>
  </a>
  <a class="abs-button abs-button-grey abs-button-small" href="https://reddit.com/submit?url=https://arxiv.org/abs/2607.19349&amp;title=FineServe: A Fine-Grained Dataset and Characterization of Global LLM Serving Workloads"
...
<!-- END LABS AREA -->
  <div class="endorsers">
    <a href="/auth/show-endorsers/2607.19349" class="endorser-who" rel="nofollow">Which authors of this paper are endorsers?</a> |
