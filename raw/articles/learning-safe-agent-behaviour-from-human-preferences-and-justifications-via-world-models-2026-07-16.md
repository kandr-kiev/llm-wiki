---
source_url: https://arxiv.org/abs/2607.13172
ingested: 2026-07-16
sha256: f595f8294d42a177a864815a0a97932a635563cfca7b40820a3a2834196e5338
blog_source: ArXiv AI
---
<!DOCTYPE html>
<html lang="en">

<head><script>document.documentElement.classList.add('js');</script>  <title>[2607.13172] Learning Safe Agent Behaviour from Human Preferences and Justifications via World Models</title>
...
<meta name="twitter:image:alt" content="arXiv logo"/>
  ...
  <script src="/static/browse/0.3.4/js/cite.js" type="text/javascript"></script><meta name="citation_title" content="Learning Safe Agent Behaviour from Human Preferences and Justifications via World Models" /><meta name="citation_author" content="Kazantzidis, Ilias" /><meta name="citation_author" content="Norman, Timothy J." /><meta name="citation_author" content="Du, Yali" /><meta name="citation_author" content="Freeman, Christopher T." /><meta name="citation_date" content="2026/07/14" /><meta name="citation_online_date" content="2026/07/14" /><meta name="citation_pdf_url" content="https://arxiv.org/pdf/2607.13172" /><meta name="citation_arxiv_id" content="2607.13172" /><meta name="citation_abstract" content="We address the problem of safely training an agent policy and deploying a good and safe policy, in settings where the environment dynamics are unknown and no suitable reward function is available. In the context of safety-critical environments, we consider traditional reinforcement learning impractical and resort to the resource of human input. We introduce DROPJ, a human-centred method for both safe training and deployment. We first learn a world model (a learned simulator) from a dataset of prior real-world trajectories. A human then plays the game in this learned simulator to extract several informative simulated trajectories. From these, we sample pairs of simulated trajectory segments and elicit from a human their preference over these segments, as well as a reason (justification) for their choice. We then train a reward model from these justified preferences and use it, together with the world model, to directly deploy the agent using model predictive control. Running real-user experiments, we find that generating informative simulated trajectories from a user significantly reduces the computational cost during training compared to other strategies, and can also improve the performance during deployment. In the context of training within a learned simulator, we show that the use of preferences rather than other types of feedback substantially improves the performance during deployment. We further demonstrate that safety justifications accompanying preferences can significantly enhance safety or prioritise user-prescribed aspects of safety associated with them during deployment." />
</head>
...
rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
    ...
    <rdf:Description
        rdf:about="/abs/2607.13172"
        dc:identifier="/abs/2607.13172"
        dc:title="Learning Safe Agent Behaviour from Human Preferences and Justifications via World Models"
        trackback:ping="/trackback/2607.13172" />
    </rdf:RDF>
--><div id="abs-outer">
  ...
  <div class="leftcolumn">
    ...
    <div class="header-breadcrumbs-mobile">
      <strong>arXiv:2607.13172</strong> (cs)
    </div>
...
<div id="content-inner">
  ...
  [Submitted on 14 Jul 2026]</div>
    <h1 class="title mathjax"><span class="descriptor">Title:</span>Learning Safe Agent Behaviour from Human Preferences and Justifications via World Models</h1>
    <div class="authors"><span class="descriptor">Authors:</span><a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Kazantzidis,+I" rel="nofollow">Ilias Kazantzidis</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Norman,+T+J" rel="nofollow">Timothy J. Norman</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Du,+Y" rel="nofollow">Yali Du</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Freeman,+C+T" rel="nofollow">Christopher T. Freeman</a></div>            <div id="download-button-info" hidden>View a PDF of the paper titled Learning Safe Agent Behaviour from Human Preferences and Justifications via World Models, by Ilias Kazantzidis and 3 other authors</div>
    <a class="mobile-submission-download" href="/pdf/2607.13172">View PDF</a>
    <a class="mobile-submission-download" href="https://arxiv.org/html/2607.13172v1">HTML (experimental)</a>



    <blockquote class="abstract mathjax">
            <span class="descriptor">Abstract:</span>We address the problem of safely training an agent policy and deploying a good and safe policy, in settings where the environment dynamics are unknown and no suitable reward function is available. In the context of safety-critical environments, we consider traditional reinforcement learning impractical and resort to the resource of human input. We introduce DROPJ, a human-centred method for both safe training and deployment. We first learn a world model (a learned simulator) from a dataset of prior real-world trajectories. A human then plays the game in this learned simulator to extract several informative simulated trajectories. From these, we sample pairs of simulated trajectory segments and elicit from a human their preference over these segments, as well as a reason (justification) for their choice. We then train a reward model from these justified preferences and use it, together with the world model, to directly deploy the agent using model predictive control. Running real-user experiments, we find that generating informative simulated trajectories from a user significantly reduces the computational cost during training compared to other strategies, and can also improve the performance during deployment. In the context of training within a learned simulator, we show that the use of preferences rather than other types of feedback substantially improves the performance during deployment. We further demonstrate that safety justifications accompanying preferences can significantly enhance safety or prioritise user-prescribed aspects of safety associated with them during deployment.
    </blockquote>
    ...
    <div class="metatable">
      <table summary="Additional metadata">        <tr>
          ...
          <td class="tablecell comments mathjax">42 pages, 18 figures. Extended version of a paper presented at ICAART 2026; submitted for consideration in the ICAART 2026 post-publication selected-papers volume in Lecture Notes in Artificial Intelligence</td>
        </tr>
<tr>
          ...
          <td class="tablecell arxivid"><span class="arxivid"><a href="https://arxiv.org/abs/2607.13172">arXiv:2607.13172</a> [cs.AI]</span></td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxividv">(or <span class="arxivid">
              <a href="https://arxiv.org/abs/2607.13172v1">arXiv:2607.13172v1</a> [cs.AI]</span> for this version)
          </td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxivdoi">              <a href="https://doi.org/10.48550/arXiv.2607.13172" id="arxiv-doi-link">https://doi.org/10.48550/arXiv.2607.13172</a><div class="button-and-tooltip">
    ...
    <div class="submission-history">
      <h2>Submission history</h2> From: Ilias Kazantzidis [<a href="/show-email/37347035/2607.13172" rel="nofollow">view email</a>]      <br/>    <strong>[v1]</strong>
        Tue, 14 Jul 2026 18:22:14 UTC (4,713 KB)<br/>
</div>
  </div>
  <!--end leftcolumn-->
...
View a PDF of the paper titled Learning Safe Agent Behaviour from Human Preferences and Justifications via World Models, by Ilias Kazantzidis and 3 other authors</div><li><a href="/pdf/2607.13172" aria-describedby="download-button-info" accesskey="f" class="abs-button download-pdf">View PDF</a></li><li><a href="https://arxiv.org/html/2607.13172v1" class="abs-button" id="latexml-download-link">HTML (experimental)</a></li><li><a href="/src/2607.13172" class="abs-button download-eprint">TeX Source
 </a></li></ul>
  ...
  <div class="prevnext">
<span class="arrow">
      <a class="abs-button prev-url" href="/prevnext?id=2607.13172&amp;function=prev&amp;context=cs.AI"
         accesskey="p" title="previous in cs.AI (accesskey p)" rel="nofollow">&lt;&nbsp;prev</a>
    </span>
    <span class="is-hidden-mobile">&nbsp; | &nbsp;</span>    <span class="arrow">
      <a class="abs-button next-url" href="/prevnext?id=2607.13172&amp;function=next&amp;context=cs.AI" accesskey="n"
    ...
    <div class="switch context-change">
        <a href="/abs/2607.13172?context=cs" rel="nofollow">cs</a><br class="is-hidden-mobile">
        <a class="subclass" href="/abs/2607.13172?context=cs.LG" rel="nofollow">cs.LG</a><br class="is-hidden-mobile">
    </div>
  </div>
      ...
      <div class="extra-ref-cite">
        ...
        <ul>
          <li><a  class="abs-button abs-button-small cite-ads" href="https://ui.adsabs.harvard.edu/abs/arXiv:2607.13172">NASA ADS</a></li><li><a  class="abs-button abs-button-small cite-google-scholar" href="https://scholar.google.com/scholar_lookup?arxiv_id=2607.13172" target="_blank" rel="noopener">Google Scholar</a></li>
          <li><a  class="abs-button abs-button-small cite-semantic-scholar" href="https://api.semanticscholar.org/arXiv:2607.13172" target="_blank" rel="noopener">Semantic Scholar</a></li>
        </ul>
...
<div id='bib-cite-modal' class='bib-modal' hidden='true'>
  ...
  <div><h3>Bookmark</h3></div><a class="abs-button abs-button-grey abs-button-small" href="http://www.bibsonomy.org/BibtexHandler?requTask=upload&amp;url=https://arxiv.org/abs/2607.13172&amp;description=Learning Safe Agent Behaviour from Human Preferences and Justifications via World Models"
     title="Bookmark on BibSonomy">
    <img src="/static/browse/0.3.4/images/icons/social/bibsonomy.png"
         alt="BibSonomy"/>
  </a>
  <a class="abs-button abs-button-grey abs-button-small" href="https://reddit.com/submit?url=https://arxiv.org/abs/2607.13172&amp;title=Learning Safe Agent Behaviour from Human Preferences and Justifications via World Models"
...
<!-- END LABS AREA -->
  <div class="endorsers">
    <a href="/auth/show-endorsers/2607.13172" class="endorser-who" rel="nofollow">Which authors of this paper are endorsers?</a> |
