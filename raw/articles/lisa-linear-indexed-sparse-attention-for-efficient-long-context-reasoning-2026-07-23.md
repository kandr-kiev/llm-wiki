...
ingested: 2026-07-23
sha256: 537ed09723778f1fca2da62380fea58f4ba9b6b499730df94a986af43b0385a7
blog_source: ArXiv AI
---
<!DOCTYPE html>
<html lang="en">

<head><script>document.documentElement.classList.add('js');</script>  <title>[2607.19358] LISA: Linear-Indexed Sparse Attention for Efficient Long-Context Reasoning</title>
  ...
  <link rel="canonical" href="https://arxiv.org/abs/2607.19358"/>
  <meta name="description" content="Abstract page for arXiv paper 2607.19358: LISA: Linear-Indexed Sparse Attention for Efficient Long-Context Reasoning"><meta property="og:type" content="website" />
<meta property="og:site_name" content="arXiv.org" />
<meta property="og:title" content="LISA: Linear-Indexed Sparse Attention for Efficient Long-Context Reasoning" />
<meta property="og:url" content="https://arxiv.org/abs/2607.19358v1" />
...
<meta name="twitter:title" content="LISA: Linear-Indexed Sparse Attention for Efficient Long-Context Reasoning"/>
<meta name="twitter:description" content="Recent advances in long chain-of-thought reasoning models such as DeepSeek-R1 have led to increasingly longer inference context lengths under the test-time scaling paradigm. However, the O(n^2)..."/>
...
<meta name="twitter:image:alt" content="arXiv logo"/>
  ...
  <script src="/static/browse/0.3.4/js/cite.js" type="text/javascript"></script><meta name="citation_title" content="LISA: Linear-Indexed Sparse Attention for Efficient Long-Context Reasoning" /><meta name="citation_author" content="Zhao, Yu" /><meta name="citation_author" content="Zhang, Zekun" /><meta name="citation_author" content="Jiang, Fan" /><meta name="citation_author" content="Zeng, Bo" /><meta name="citation_author" content="Xu, Linlong" /><meta name="citation_author" content="Shan, Shimin" /><meta name="citation_author" content="Liu, Yu" /><meta name="citation_author" content="Wang, Longyue" /><meta name="citation_author" content="Luo, Weihua" /><meta name="citation_date" content="2026/05/29" /><meta name="citation_online_date" content="2026/05/29" /><meta name="citation_pdf_url" content="https://arxiv.org/pdf/2607.19358" /><meta name="citation_arxiv_id" content="2607.19358" /><meta name="citation_abstract" content="Recent advances in long chain-of-thought reasoning models such as DeepSeek-R1 have led to increasingly longer inference context lengths under the test-time scaling paradigm. However, the O(n^2) computational complexity of standard self-attention causes inference costs to grow sharply with long sequences, limiting the deployment of long-CoT reasoning in production settings. To address this, we propose LISA (Linear-Indexed Sparse Attention), a plug-and-play attention replacement module that requires no pretraining from scratch. LISA integrates two lightweight components in parallel within the original model: (1) a Linear Attention module that provides long-range memory with O(n) time complexity; (2) a Lightning Indexer that selects the top-M important tokens from the full context to feed into a Sparse Self-Attention. The two branches are fused via a gating mechanism, reducing inference complexity from O(n^2) to O(nM) (M &lt;&lt; n) for generating n tokens. We design a two-stage training pipeline: Stage 1 initializes the model by integrating the linear attention to capture long-range dependencies, complemented by a sliding-window attention mechanism that is optimized via knowledge distillation to approximate the full self-attention distribution of a frozen teacher model. In Stage 2, we further introduce the Indexer to replace the static sliding-window mechanism, enabling dynamic token selection from broader contexts. The Indexer is trained using a novel per-head KL divergence loss, which aligns its selection behavior with the attention patterns of the teacher model. Experiments on DeepSeek-distilled-Qwen models demonstrate that LISA achieves a 50% inference speedup under 16K-token context, while improving average performance by 5.6% on reasoning benchmarks including AIME and MATH-500." />
</head>
...
rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
    ...
    <rdf:Description
        rdf:about="/abs/2607.19358"
        dc:identifier="/abs/2607.19358"
        dc:title="LISA: Linear-Indexed Sparse Attention for Efficient Long-Context Reasoning"
        trackback:ping="/trackback/2607.19358" />
    </rdf:RDF>
--><div id="abs-outer">
  ...
  <div class="leftcolumn">
    ...
    <div class="header-breadcrumbs-mobile">
      <strong>arXiv:2607.19358</strong> (cs)
    </div>
<link rel="stylesheet" type="text/css" href="/static/base/1.0.1/css/abs.css">
<div id="content-inner">
  <div id="abs">
    <div class="dateline">
  [Submitted on 29 May 2026]</div>
    <h1 class="title mathjax"><span class="descriptor">Title:</span>LISA: Linear-Indexed Sparse Attention for Efficient Long-Context Reasoning</h1>
    <div class="authors"><span class="descriptor">Authors:</span><a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Zhao,+Y" rel="nofollow">Yu Zhao</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Zhang,+Z" rel="nofollow">Zekun Zhang</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Jiang,+F" rel="nofollow">Fan Jiang</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Zeng,+B" rel="nofollow">Bo Zeng</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Xu,+L" rel="nofollow">Linlong Xu</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Shan,+S" rel="nofollow">Shimin Shan</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Liu,+Y" rel="nofollow">Yu Liu</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Wang,+L" rel="nofollow">Longyue Wang</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Luo,+W" rel="nofollow">Weihua Luo</a></div>            <div id="download-button-info" hidden>View a PDF of the paper titled LISA: Linear-Indexed Sparse Attention for Efficient Long-Context Reasoning, by Yu Zhao and 8 other authors</div>
    <a class="mobile-submission-download" href="/pdf/2607.19358">View PDF</a>
    <a class="mobile-submission-download" href="https://arxiv.org/html/2607.19358v1">HTML (experimental)</a>
    ...
    <div class="metatable">
      <table summary="Additional metadata">        <tr>
          ...
          <td class="tablecell comments mathjax">20 pages, 10 figures</td>
        </tr>
<tr>
          ...
          <td class="tablecell jref">LISA-v2-2026</td>
        </tr>
<tr>
          <td class="tablecell label">Cite as:</td>
          <td class="tablecell arxivid"><span class="arxivid"><a href="https://arxiv.org/abs/2607.19358">arXiv:2607.19358</a> [cs.AI]</span></td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxividv">(or <span class="arxivid">
              <a href="https://arxiv.org/abs/2607.19358v1">arXiv:2607.19358v1</a> [cs.AI]</span> for this version)
          </td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxivdoi">              <a href="https://doi.org/10.48550/arXiv.2607.19358" id="arxiv-doi-link">https://doi.org/10.48550/arXiv.2607.19358</a><div class="button-and-tooltip">
    ...
    <div class="submission-history">
      <h2>Submission history</h2> From: Zhao Yu [<a href="/show-email/f685eb69/2607.19358" rel="nofollow">view email</a>]      <br/>    <strong>[v1]</strong>
        Fri, 29 May 2026 03:05:29 UTC (161 KB)<br/>
</div>
  </div>
  <!--end leftcolumn-->
...
View a PDF of the paper titled LISA: Linear-Indexed Sparse Attention for Efficient Long-Context Reasoning, by Yu Zhao and 8 other authors</div><li><a href="/pdf/2607.19358" aria-describedby="download-button-info" accesskey="f" class="abs-button download-pdf">View PDF</a></li><li><a href="https://arxiv.org/html/2607.19358v1" class="abs-button" id="latexml-download-link">HTML (experimental)</a></li><li><a href="/src/2607.19358" class="abs-button download-eprint">TeX Source
 </a></li></ul>
  ...
  <div class="prevnext">
<span class="arrow">
      <a class="abs-button prev-url" href="/prevnext?id=2607.19358&amp;function=prev&amp;context=cs.AI"
         accesskey="p" title="previous in cs.AI (accesskey p)" rel="nofollow">&lt;&nbsp;prev</a>
    </span>
    <span class="is-hidden-mobile">&nbsp; | &nbsp;</span>    <span class="arrow">
      <a class="abs-button next-url" href="/prevnext?id=2607.19358&amp;function=next&amp;context=cs.AI" accesskey="n"
    ...
    <div class="switch context-change">
        <a href="/abs/2607.19358?context=cs" rel="nofollow">cs</a><br class="is-hidden-mobile">
    </div>
  </div>
      ...
      <div class="extra-ref-cite">
        ...
        <ul>
          <li><a  class="abs-button abs-button-small cite-ads" href="https://ui.adsabs.harvard.edu/abs/arXiv:2607.19358">NASA ADS</a></li><li><a  class="abs-button abs-button-small cite-google-scholar" href="https://scholar.google.com/scholar_lookup?arxiv_id=2607.19358" target="_blank" rel="noopener">Google Scholar</a></li>
          <li><a  class="abs-button abs-button-small cite-semantic-scholar" href="https://api.semanticscholar.org/arXiv:2607.19358" target="_blank" rel="noopener">Semantic Scholar</a></li>
        </ul>
...
<div id='bib-cite-modal' class='bib-modal' hidden='true'>
  ...
  <div><h3>Bookmark</h3></div><a class="abs-button abs-button-grey abs-button-small" href="http://www.bibsonomy.org/BibtexHandler?requTask=upload&amp;url=https://arxiv.org/abs/2607.19358&amp;description=LISA: Linear-Indexed Sparse Attention for Efficient Long-Context Reasoning"
     title="Bookmark on BibSonomy">
    <img src="/static/browse/0.3.4/images/icons/social/bibsonomy.png"
         alt="BibSonomy"/>
  </a>
  <a class="abs-button abs-button-grey abs-button-small" href="https://reddit.com/submit?url=https://arxiv.org/abs/2607.19358&amp;title=LISA: Linear-Indexed Sparse Attention for Efficient Long-Context Reasoning"
...
<!-- END LABS AREA -->
  <div class="endorsers">
    <a href="/auth/show-endorsers/2607.19358" class="endorser-who" rel="nofollow">Which authors of this paper are endorsers?</a> |
