...
ingested: 2026-07-09
sha256: 706540d16a4432d01b3554a58cb08e89bf2a6e827d7942819c4f2695e6309e70
...
<head><script>document.documentElement.classList.add('js');</script>  <title>[2607.06757] LLM-powered reasoning in agent-based modeling</title>
  ...
  <link rel="canonical" href="https://arxiv.org/abs/2607.06757"/>
  <meta name="description" content="Abstract page for arXiv paper 2607.06757: LLM-powered reasoning in agent-based modeling"><meta property="og:type" content="website" />
<meta property="og:site_name" content="arXiv.org" />
<meta property="og:title" content="LLM-powered reasoning in agent-based modeling" />
<meta property="og:url" content="https://arxiv.org/abs/2607.06757v1" />
<meta property="og:image" content="/static/browse/0.3.4/images/arxiv-logo-fb.png" />
<meta property="og:image:secure_url" content="/static/browse/0.3.4/images/arxiv-logo-fb.png" />
<meta property="og:image:width" content="1200" />
<meta property="og:image:height" content="700" />
<meta property="og:image:alt" content="arXiv logo"/>
<meta property="og:description" content="Agent-based modeling (ABM) has the capability to model millions of individuals and their interactions, which is useful for policy making. However, ABMs have traditionally relied on static prior, which prevents the models from adapting to real-time changes. Our research provides a novel approach to addressing this information gap. Large language models (LLMs) offer new opportunities to predict human decision-making. Here, we introduce a scalable Hybrid Agent-based and Language-driven Epidemic (HALE) modeling framework that leverages LLMs to predict human decision-making in an ABM simulation. As a proof-of-concept, we use HALE to simulate COVID-19 and its effects in Salt Lake County, UT."/>
<meta name="twitter:site" content="@arxiv"/>
<meta name="twitter:card" content="summary"/>
<meta name="twitter:title" content="LLM-powered reasoning in agent-based modeling"/>
<meta name="twitter:description" content="Agent-based modeling (ABM) has the capability to model millions of individuals and their interactions, which is useful for policy making. However, ABMs have traditionally relied on static prior,..."/>
...
<meta name="twitter:image:alt" content="arXiv logo"/>
  ...
  <script src="/static/browse/0.3.4/js/cite.js" type="text/javascript"></script><meta name="citation_title" content="LLM-powered reasoning in agent-based modeling" /><meta name="citation_author" content="Moon, Sifat Afroj" /><meta name="citation_author" content="Maguire, Dakotah" /><meta name="citation_author" content="Spannaus, Adam" /><meta name="citation_author" content="Tuccillo, Joe" /><meta name="citation_author" content="Alam, Maksudul" /><meta name="citation_author" content="Seal, Sudip K." /><meta name="citation_author" content="Gounley, John" /><meta name="citation_author" content="Hanson, Heidi" /><meta name="citation_date" content="2026/07/07" /><meta name="citation_online_date" content="2026/07/07" /><meta name="citation_pdf_url" content="https://arxiv.org/pdf/2607.06757" /><meta name="citation_arxiv_id" content="2607.06757" /><meta name="citation_abstract" content="Agent-based modeling (ABM) has the capability to model millions of individuals and their interactions, which is useful for policy making. However, ABMs have traditionally relied on static prior, which prevents the models from adapting to real-time changes. Our research provides a novel approach to addressing this information gap. Large language models (LLMs) offer new opportunities to predict human decision-making. Here, we introduce a scalable Hybrid Agent-based and Language-driven Epidemic (HALE) modeling framework that leverages LLMs to predict human decision-making in an ABM simulation. As a proof-of-concept, we use HALE to simulate COVID-19 and its effects in Salt Lake County, UT." />
</head>
...
rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
    ...
    <rdf:Description
        rdf:about="/abs/2607.06757"
        dc:identifier="/abs/2607.06757"
        dc:title="LLM-powered reasoning in agent-based modeling"
        trackback:ping="/trackback/2607.06757" />
    </rdf:RDF>
--><div id="abs-outer">
  ...
  <div class="leftcolumn">
    ...
    <div class="header-breadcrumbs-mobile">
      <strong>arXiv:2607.06757</strong> (cs)
    </div>
...
<div id="content-inner">
  <div id="abs">
    <div class="dateline">
  [Submitted on 7 Jul 2026]</div>
    <h1 class="title mathjax"><span class="descriptor">Title:</span>LLM-powered reasoning in agent-based modeling</h1>
    <div class="authors"><span class="descriptor">Authors:</span><a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Moon,+S+A" rel="nofollow">Sifat Afroj Moon</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Maguire,+D" rel="nofollow">Dakotah Maguire</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Spannaus,+A" rel="nofollow">Adam Spannaus</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Tuccillo,+J" rel="nofollow">Joe Tuccillo</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Alam,+M" rel="nofollow">Maksudul Alam</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Seal,+S+K" rel="nofollow">Sudip K. Seal</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Gounley,+J" rel="nofollow">John Gounley</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Hanson,+H" rel="nofollow">Heidi Hanson</a></div>            <div id="download-button-info" hidden>View a PDF of the paper titled LLM-powered reasoning in agent-based modeling, by Sifat Afroj Moon and 7 other authors</div>
    <a class="mobile-submission-download" href="/pdf/2607.06757">View PDF</a>
    <a class="mobile-submission-download" href="https://arxiv.org/html/2607.06757v1">HTML (experimental)</a>



    <blockquote class="abstract mathjax">
            <span class="descriptor">Abstract:</span>Agent-based modeling (ABM) has the capability to model millions of individuals and their interactions, which is useful for policy making. However, ABMs have traditionally relied on static prior, which prevents the models from adapting to real-time changes. Our research provides a novel approach to addressing this information gap. Large language models (LLMs) offer new opportunities to predict human decision-making. Here, we introduce a scalable Hybrid Agent-based and Language-driven Epidemic (HALE) modeling framework that leverages LLMs to predict human decision-making in an ABM simulation. As a proof-of-concept, we use HALE to simulate COVID-19 and its effects in Salt Lake County, UT.
    </blockquote>
    ...
    <div class="metatable">
      <table summary="Additional metadata"><tr>
          ...
          <td class="tablecell subjects">
            <span class="primary-subject">Artificial Intelligence (cs.AI)</span>; Multiagent Systems (cs.MA)</td>
        </tr><tr>
          <td class="tablecell label">Cite as:</td>
          <td class="tablecell arxivid"><span class="arxivid"><a href="https://arxiv.org/abs/2607.06757">arXiv:2607.06757</a> [cs.AI]</span></td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxividv">(or <span class="arxivid">
              <a href="https://arxiv.org/abs/2607.06757v1">arXiv:2607.06757v1</a> [cs.AI]</span> for this version)
          </td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxivdoi">              <a href="https://doi.org/10.48550/arXiv.2607.06757" id="arxiv-doi-link">https://doi.org/10.48550/arXiv.2607.06757</a><div class="button-and-tooltip">
    ...
    <div class="submission-history">
      <h2>Submission history</h2> From: Sifat Moon [<a href="/show-email/9080efef/2607.06757" rel="nofollow">view email</a>]      <br/>    <strong>[v1]</strong>
        Tue, 7 Jul 2026 19:39:01 UTC (1,373 KB)<br/>
</div>
  </div>
  <!--end leftcolumn-->
...
View a PDF of the paper titled LLM-powered reasoning in agent-based modeling, by Sifat Afroj Moon and 7 other authors</div><li><a href="/pdf/2607.06757" aria-describedby="download-button-info" accesskey="f" class="abs-button download-pdf">View PDF</a></li><li><a href="https://arxiv.org/html/2607.06757v1" class="abs-button" id="latexml-download-link">HTML (experimental)</a></li><li><a href="/src/2607.06757" class="abs-button download-eprint">TeX Source
 </a></li></ul>
  ...
  <div class="prevnext">
<span class="arrow">
      <a class="abs-button prev-url" href="/prevnext?id=2607.06757&amp;function=prev&amp;context=cs.AI"
         accesskey="p" title="previous in cs.AI (accesskey p)" rel="nofollow">&lt;&nbsp;prev</a>
    </span>
    <span class="is-hidden-mobile">&nbsp; | &nbsp;</span>    <span class="arrow">
      <a class="abs-button next-url" href="/prevnext?id=2607.06757&amp;function=next&amp;context=cs.AI" accesskey="n"
    ...
    <div class="switch context-change">
        <a href="/abs/2607.06757?context=cs" rel="nofollow">cs</a><br class="is-hidden-mobile">
        <a class="subclass" href="/abs/2607.06757?context=cs.MA" rel="nofollow">cs.MA</a><br class="is-hidden-mobile">
    </div>
  </div>
      ...
      <div class="extra-ref-cite">
        ...
        <ul>
          <li><a  class="abs-button abs-button-small cite-ads" href="https://ui.adsabs.harvard.edu/abs/arXiv:2607.06757">NASA ADS</a></li><li><a  class="abs-button abs-button-small cite-google-scholar" href="https://scholar.google.com/scholar_lookup?arxiv_id=2607.06757" target="_blank" rel="noopener">Google Scholar</a></li>
          <li><a  class="abs-button abs-button-small cite-semantic-scholar" href="https://api.semanticscholar.org/arXiv:2607.06757" target="_blank" rel="noopener">Semantic Scholar</a></li>
        </ul>
...
<div id='bib-cite-modal' class='bib-modal' hidden='true'>
  ...
  <div><h3>Bookmark</h3></div><a class="abs-button abs-button-grey abs-button-small" href="http://www.bibsonomy.org/BibtexHandler?requTask=upload&amp;url=https://arxiv.org/abs/2607.06757&amp;description=LLM-powered reasoning in agent-based modeling"
     title="Bookmark on BibSonomy">
    <img src="/static/browse/0.3.4/images/icons/social/bibsonomy.png"
         alt="BibSonomy"/>
  </a>
  <a class="abs-button abs-button-grey abs-button-small" href="https://reddit.com/submit?url=https://arxiv.org/abs/2607.06757&amp;title=LLM-powered reasoning in agent-based modeling"
...
<!-- END LABS AREA -->
  <div class="endorsers">
    <a href="/auth/show-endorsers/2607.06757" class="endorser-who" rel="nofollow">Which authors of this paper are endorsers?</a> |
