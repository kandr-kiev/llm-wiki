---
source_url: file:///workspace/Projects/course-ai-agents/course-ai-agents-software-engineer-future-skills-2026.md
ingested: 2026-07-20
sha256: f25505356da797b63c355f541b367b6f0c8e46c305d88a589ad4be3c92de88e4
...
### 2.1 Зсув ролі: від “написує код” → “оркеструє систему”
...
### Мета курсу
Підготувати інженера до роботи в умовах, де 40%+ бізнес-процесів автоматизовано AI Agents; навчити проєктувати, будувати, деплоїти та підтримувати agentic системи; сформувати навички, що матимуть 3–5-річний термін актуальності.
...
**Тема**: що таке AI Agent, чим відріzanі від чатбота, які патерни існують.

#### Теорія
- Від RAG до агентів: гісторія 2022–2026.
...
**Тема**: підключення агента до зовнішніх world: API, файли, логи, UI.
...
**Тема**: застосувати всі навички на реальному proejct, близькому до твого досвіду.
