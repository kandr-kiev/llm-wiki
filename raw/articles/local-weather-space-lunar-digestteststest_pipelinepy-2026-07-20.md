...
def test_content_pools_non_empty():
    ...
    assert len(FOLK_FORECASTS) >= 5, f"FOLK_FORECASTS has {len(FOLK_FORECASTS)} items"
...
def test_render_basic():
    ...
    if unresolved:
        ...
        print("✅ test_render_basic passed — 0 unresolved placeholders")


if __name__ == "__main__":
    print("=" * 50)
    print("🧪 Інтеграційне тестування")
    print("=" * 50)
    
    test_template_placeholders_match_replacements()
    test_content_pools_non_empty()
    test_no_english_in_space_translation()
    test_monty_no_emoji_ddd()
    test_render_basic()
    
    print("\n" + "=" * 50)
    print("✅ ВСІ ІНТЕГРАЦІЙНІ ТЕСТИ ПРОЙДЕНО!")
    print("=" * 50)
