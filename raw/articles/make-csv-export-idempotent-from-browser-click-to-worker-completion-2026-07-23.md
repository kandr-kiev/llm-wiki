...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Make CSV Export Idempotent From Browser Click to Worker Completion - DEV Community</title>
    
    <link rel="preload" href="/reactions?article_id=4214973" as="fetch" crossorigin="same-origin">
    <link rel="canonical" href="https://dev.to/kongkong1/make-csv-export-idempotent-from-browser-click-to-worker-completion-31e8" />
    <meta name="description" content="Design a durable export contract that survives double clicks, retries, worker crashes, and expired download links. Tagged with webdev, backend, architecture, testing.">
    <meta name="keywords" content="webdev, backend, architecture, testing, software, coding, development, engineering, inclusive, community">

    <meta property="og:type" content="article" />
    <meta property="og:url" content="https://dev.to/kongkong1/make-csv-export-idempotent-from-browser-click-to-worker-completion-31e8" />
    <meta property="og:title" content="Make CSV Export Idempotent From Browser Click to Worker Completion" />
    <meta property="og:description" content="Design a durable export contract that survives double clicks, retries, worker crashes, and expired download links." />
    <meta property="og:site_name" content="DEV Community" />
    <meta name="twitter:site" content="@thepracticaldev">
    <meta name="twitter:creator" content="@">
    <meta name="author-trust" content="0">
    <meta name="twitter:title" content="Make CSV Export Idempotent From Browser Click to Worker Completion">
    <meta name="twitter:description" content="Design a durable export contract that survives double clicks, retries, worker crashes, and expired download links.">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:widgets:new-embed-design" content="on">
    <meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1">
      <meta property="og:image" content="https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2F590lkeah6aypwa1k2wb5.png" />
      <meta name="twitter:image:src" content="https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2F590lkeah6aypwa1k2wb5.png">

      <meta name="last-updated" content="2026-07-23 11:55:18 UTC">
      <meta name="user-signed-in" content="false">
      <meta name="head-cached-at" content="1784807718">
  ...
  <div class="crayons-header__container">
    <span class="inline-block m:hidden ">
      <button class="c-btn c-btn--icon-alone js-hamburger-trigger mx-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a5jiz2ekdha0su3t67ruyl5oxbgac65c" class="crayons-icon"><title id="a5jiz2ekdha0su3t67ruyl5oxbgac65c">Navigation menu</title>
        ...
        <div class="crayons-fields crayons-fields--horizontal">
          <div class="crayons-field flex-1 relative">
            ...
            <button type="submit" aria-label="Search" class="c-btn c-btn--icon-alone absolute inset-px right-auto mt-0 py-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a9pgyyc5t6ze3tdjtor65t98kq8hm1y8" aria-hidden="true" class="crayons-icon"><title id="a9pgyyc5t6ze3tdjtor65t98kq8hm1y8">Search</title>
    <path d="M18.031 16.617l4.283 4.282-1.415 1.415-4.282-4.283A8.96 8.96 0 0111 20c-4.968 0-9-4.032-9-9s4.032-9 9-9 9 4.032 9 9a8.96 8.96 0 01-1.969 5.617zm-2.006-.742A6.977 6.977 0 0018 11c0-3.868-3.133-7-7-7-3.868 0-7 3.132-7 7 0 3.867 3.132 7 7 7a6.977 6.977 0 004.875-1.975l.15-.15z"></path>
            ...
            <a class="crayons-header--search-brand-indicator" href="https://www.algolia.com/developers/?utm_source=devto&utm_medium=referral" target="_blank" rel="noopener noreferrer">
                Powered by Algolia
                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" width="24" height="24" viewBox="0 0 500 500.34" role="img" aria-labelledby="a3x0zspbenxf9rxam48gg2mn6dzmvp6p" aria-hidden="true" class="crayons-icon"><title id="a3x0zspbenxf9rxam48gg2mn6dzmvp6p">Search</title>
  ...
  <div class="hamburger__content">
    <header class="hamburger__content__header">
      ...
      <button class="c-btn c-btn--icon-alone js-hamburger-trigger shrink-0" aria-label="Close">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a96849bjgkmgk2y8nixmgiyxyzrz2f9p" aria-hidden="true" class="crayons-icon c-btn__icon"><title id="a96849bjgkmgk2y8nixmgiyxyzrz2f9p">Close</title><path d="M12 10.586l4.95-4.95 1.414 1.414-4.95 4.95 4.95 4.95-1.414 1.414-4.95-4.95-4.95 4.95-1.414-1.414 4.95-4.95-4.95-4.95L7.05 5.636l4.95 4.95z"></path></svg>
...
<div id="page-content" class="wrapper stories stories-show articletag-webdev articletag-backend articletag-architecture articletag-testing articleuser-4022658" data-current-page="stories-show">
  <div id="page-content-inner" data-internal-nav="false" data-viewable-id="4214973" data-viewable-type="Article">
...
<script src="https://assets.dev.to/assets/commentDropdowns-7a28d130e5b78d38b30a9495a964003a66bd64fa455fc70b766d69cf06b9ba24.js" defer="defer"></script>
  ...
  <script type="application/ld+json">
    {"@context":"http://schema.org","@type":"Article","mainEntityOfPage":{"@type":"WebPage","@id":"https://dev.to/kongkong1/make-csv-export-idempotent-from-browser-click-to-worker-completion-31e8"},"url":"https://dev.to/kongkong1/make-csv-export-idempotent-from-browser-click-to-worker-completion-31e8","image":["https://media2.dev.to/dynamic/image/width=1080,height=1080,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2F590lkeah6aypwa1k2wb5.png","https://media2.dev.to/dynamic/image/width=1280,height=720,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2F590lkeah6aypwa1k2wb5.png","https://media2.dev.to/dynamic/image/width=1600,height=900,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2F590lkeah6aypwa1k2wb5.png"],"publisher":{"@context":"http://schema.org","@type":"Organization","name":"DEV Community","logo":{"@context":"http://schema.org","@type":"ImageObject","url":"https://media2.dev.to/dynamic/image/width=192,height=,fit=scale-down,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F8j7kvp660rqzt99zui8e.png","width":"192","height":"192"}},"headline":"Make CSV Export Idempotent From Browser Click to Worker Completion","author":{"@context":"http://schema.org","@type":"Person","url":"https://dev.to/kongkong1","name":"kongkong"},"datePublished":"2026-07-23T11:54:18Z","dateModified":"2026-07-23T11:54:18Z"}
  </script>
    ...
    <span data-testid="tooltip" class="crayons-tooltip__content">
      ...
      <div class="align-center m:relative">
        <button id="article-show-more-button" aria-controls="article-show-more-dropdown" aria-expanded="false" aria-haspopup="true" class="dropbtn crayons-btn crayons-btn--ghost-dimmed crayons-btn--icon-rounded" aria-label="Share post options">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" role="img" aria-labelledby="as5swxfvck6jit4oppfcwxlaysfqu40j" aria-hidden="true" class="crayons-icon dropdown-icon"><title id="as5swxfvck6jit4oppfcwxlaysfqu40j">More...</title><path fill-rule="evenodd" clip-rule="evenodd" d="M7 12a2 2 0 11-4 0 2 2 0 014 0zm7 0a2 2 0 11-4 0 2 2 0 014 0zm5 2a2 2 0 100-4 2 2 0 000 4z"></path></svg>
        ...
        <div id="article-show-more-dropdown" class="crayons-dropdown side-bar left-2 right-2 m:right-auto m:left-100 s:left-auto mb-1 m:mb-0 top-unset bottom-100 m:top-0 m:bottom-unset">
          <div>
            <button
              ...
              data-postUrl="https://dev.to/kongkong1/make-csv-export-idempotent-from-browser-click-to-worker-completion-31e8">
              <span class="fw-bold">Copy link</span>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" id="article-copy-icon" role="img" aria-labelledby="ak9pp3ae16lyyhfa0kudhnp3ue409urx" aria-hidden="true" class="crayons-icon mx-2 shrink-0"><title id="ak9pp3ae16lyyhfa0kudhnp3ue409urx">Copy link</title>
    <path d="M7 6V3a1 1 0 011-1h12a1 1 0 011 1v14a1 1 0 01-1 1h-3v3c0 .552-.45 1-1.007 1H4.007A1 1 0 013 21l.003-14c0-.552.45-1 1.007-1H7zm2 0h8v10h2V4H9v2zm-2 5v2h6v-2H7zm0 4v2h6v-2H7z"></path>
          ...
          <div class="Desktop-only">
            <a
              ...
              rel="noopener"
              href='https://twitter.com/intent/tweet?text=%22Make%20CSV%20Export%20Idempotent%20From%20Browser%20Click%20to%20Worker%20Completion%22%20by%20kongkong%20%23DEVCommunity%20https%3A%2F%2Fdev.to%2Fkongkong1%2Fmake-csv-export-idempotent-from-browser-click-to-worker-completion-31e8'>
              Share to X
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fdev.to%2Fkongkong1%2Fmake-csv-export-idempotent-from-browser-click-to-worker-completion-31e8&title=Make%20CSV%20Export%20Idempotent%20From%20Browser%20Click%20to%20Worker%20Completion&summary=Design%20a%20durable%20export%20contract%20that%20survives%20double%20clicks%2C%20retries%2C%20worker%20crashes%2C%20and%20expired%20download%20links.&source=DEV%20Community">
              Share to LinkedIn
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://www.facebook.com/sharer.php?u=https%3A%2F%2Fdev.to%2Fkongkong1%2Fmake-csv-export-idempotent-from-browser-click-to-worker-completion-31e8">
              Share to Facebook
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://s2f.kytta.dev/?text=https%3A%2F%2Fdev.to%2Fkongkong1%2Fmake-csv-export-idempotent-from-browser-click-to-worker-completion-31e8">
              Share to Mastodon
            </a>
          </div>

          <web-share-wrapper shareurl="https://dev.to/kongkong1/make-csv-export-idempotent-from-browser-click-to-worker-completion-31e8" sharetitle="Make CSV Export Idempotent From Browser Click to Worker Completion" sharetext="Design a durable export contract that survives double clicks, retries, worker crashes, and expired download links." template="web-share-button">
          </web-share-wrapper>
    ...
    <main id="main-content" class="crayons-layout__content grid gap-4">
      <div class="article-wrapper">
        ...
        <article class="crayons-card crayons-article mb-4"
          ...
          data-article-id="4214973"
          data-article-slug="make-csv-export-idempotent-from-browser-click-to-worker-completion-31e8"
          data-author-id="4022658"
          data-author-name="kongkong"
          data-author-username="kongkong1"
          data-co-author-ids=""
          data-path="/kongkong1/make-csv-export-idempotent-from-browser-click-to-worker-completion-31e8"
            ...
            <div class="crayons-article__header__meta">
              <div class="flex s:items-start flex-col s:flex-row">
                ...
                <div class="flex flex-1 mb-5 items-start">
                  <div class="relative">
                      <a href="/kongkong1"><img class="radius-full align-middle" src="https://media2.dev.to/dynamic/image/width=50,height=50,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Fuser%2Fprofile_image%2F4022658%2F363ced53-f57d-4cf4-bf7c-2927ffcb39c5.png" width="40" height="40" alt="kongkong" /></a>
                  </div>
                  <div class="pl-3 flex-1">
                    <a href="/kongkong1" class="crayons-link fw-bold">kongkong</a>
                    
                    <p class="fs-xs color-base-60">
                        Posted on <time datetime="2026-07-23T11:54:18Z" class="date-no-year">Jul 23</time>
      ...
      " href="/t/testing"><span class="crayons-tag__prefix">#</span>testing</a>
          ...
          <div class="crayons-article__main ">
            <div class="crayons-article__body text-styles spec__body" data-article-id="4214973"
              id="article-body">
                <p>A user clicks <strong>Export</strong> twice because the first click shows no feedback. The API creates two jobs. A worker retries one after losing its acknowledgement, producing a third object. The UI eventually displays three links for the same request.</p>
...
<h2>
  <a name="define-the-operation" href="#define-the-operation">
  </a>
...
<div class="highlight__panel js-actions-panel">
<div class="highlight__panel-action js-fullscreen-code-action">
    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewbox="0 0 24 24" class="highlight-action crayons-icon highlight-action--full