...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Make Your CLI Config Write Survive Ctrl-C Without Leaving Truncated JSON - DEV Community</title>
    
    <link rel="preload" href="/reactions?article_id=4214965" as="fetch" crossorigin="same-origin">
    <link rel="canonical" href="https://dev.to/rivera123/make-your-cli-config-write-survive-ctrl-c-without-leaving-truncated-json-22m9" />
    <meta name="description" content="Use write-fsync-rename and failure fixtures so an interrupted CLI update preserves either the old config or the complete new one. Tagged with node, cli, javascript, testing.">
    <meta name="keywords" content="node, cli, javascript, testing, software, coding, development, engineering, inclusive, community">

    <meta property="og:type" content="article" />
    <meta property="og:url" content="https://dev.to/rivera123/make-your-cli-config-write-survive-ctrl-c-without-leaving-truncated-json-22m9" />
    <meta property="og:title" content="Make Your CLI Config Write Survive Ctrl-C Without Leaving Truncated JSON" />
    <meta property="og:description" content="Use write-fsync-rename and failure fixtures so an interrupted CLI update preserves either the old config or the complete new one." />
    <meta property="og:site_name" content="DEV Community" />
    <meta name="twitter:site" content="@thepracticaldev">
    <meta name="twitter:creator" content="@">
    <meta name="author-trust" content="0">
    <meta name="twitter:title" content="Make Your CLI Config Write Survive Ctrl-C Without Leaving Truncated JSON">
    <meta name="twitter:description" content="Use write-fsync-rename and failure fixtures so an interrupted CLI update preserves either the old config or the complete new one.">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:widgets:new-embed-design" content="on">
    <meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1">
      <meta property="og:image" content="https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fl6pg5m59ju0ycchtjhwp.png" />
      <meta name="twitter:image:src" content="https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fl6pg5m59ju0ycchtjhwp.png">

      <meta name="last-updated" content="2026-07-23 11:54:19 UTC">
      <meta name="user-signed-in" content="false">
      <meta name="head-cached-at" content="1784807659">
  ...
  <div class="crayons-header__container">
    <span class="inline-block m:hidden ">
      <button class="c-btn c-btn--icon-alone js-hamburger-trigger mx-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="ao7lr1srbet4amdsa1xcrkn4qdbwue02" class="crayons-icon"><title id="ao7lr1srbet4amdsa1xcrkn4qdbwue02">Navigation menu</title>
        ...
        <div class="crayons-fields crayons-fields--horizontal">
          <div class="crayons-field flex-1 relative">
            ...
            <button type="submit" aria-label="Search" class="c-btn c-btn--icon-alone absolute inset-px right-auto mt-0 py-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a1ft6oq2ml6cmsang2gy8cmp1lm7z4d5" aria-hidden="true" class="crayons-icon"><title id="a1ft6oq2ml6cmsang2gy8cmp1lm7z4d5">Search</title>
    <path d="M18.031 16.617l4.283 4.282-1.415 1.415-4.282-4.283A8.96 8.96 0 0111 20c-4.968 0-9-4.032-9-9s4.032-9 9-9 9 4.032 9 9a8.96 8.96 0 01-1.969 5.617zm-2.006-.742A6.977 6.977 0 0018 11c0-3.868-3.133-7-7-7-3.868 0-7 3.132-7 7 0 3.867 3.132 7 7 7a6.977 6.977 0 004.875-1.975l.15-.15z"></path>
            ...
            <a class="crayons-header--search-brand-indicator" href="https://www.algolia.com/developers/?utm_source=devto&utm_medium=referral" target="_blank" rel="noopener noreferrer">
                Powered by Algolia
                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" width="24" height="24" viewBox="0 0 500 500.34" role="img" aria-labelledby="aaiqtuk9a0nj3n74dzl1hes0gbcact1h" aria-hidden="true" class="crayons-icon"><title id="aaiqtuk9a0nj3n74dzl1hes0gbcact1h">Search</title>
  ...
  <div class="hamburger__content">
    <header class="hamburger__content__header">
      ...
      <button class="c-btn c-btn--icon-alone js-hamburger-trigger shrink-0" aria-label="Close">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="aeu3t5fdfrvyfw8ywse8bnkyunapnc3o" aria-hidden="true" class="crayons-icon c-btn__icon"><title id="aeu3t5fdfrvyfw8ywse8bnkyunapnc3o">Close</title><path d="M12 10.586l4.95-4.95 1.414 1.414-4.95 4.95 4.95 4.95-1.414 1.414-4.95-4.95-4.95 4.95-1.414-1.414 4.95-4.95-4.95-4.95L7.05 5.636l4.95 4.95z"></path></svg>
...
<div id="page-content" class="wrapper stories stories-show articletag-node articletag-cli articletag-javascript articletag-testing articleuser-4019566" data-current-page="stories-show">
  <div id="page-content-inner" data-internal-nav="false" data-viewable-id="4214965" data-viewable-type="Article">
...
<script src="https://assets.dev.to/assets/commentDropdowns-7a28d130e5b78d38b30a9495a964003a66bd64fa455fc70b766d69cf06b9ba24.js" defer="defer"></script>
  ...
  <script type="application/ld+json">
    {"@context":"http://schema.org","@type":"Article","mainEntityOfPage":{"@type":"WebPage","@id":"https://dev.to/rivera123/make-your-cli-config-write-survive-ctrl-c-without-leaving-truncated-json-22m9"},"url":"https://dev.to/rivera123/make-your-cli-config-write-survive-ctrl-c-without-leaving-truncated-json-22m9","image":["https://media2.dev.to/dynamic/image/width=1080,height=1080,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fl6pg5m59ju0ycchtjhwp.png","https://media2.dev.to/dynamic/image/width=1280,height=720,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fl6pg5m59ju0ycchtjhwp.png","https://media2.dev.to/dynamic/image/width=1600,height=900,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fl6pg5m59ju0ycchtjhwp.png"],"publisher":{"@context":"http://schema.org","@type":"Organization","name":"DEV Community","logo":{"@context":"http://schema.org","@type":"ImageObject","url":"https://media2.dev.to/dynamic/image/width=192,height=,fit=scale-down,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F8j7kvp660rqzt99zui8e.png","width":"192","height":"192"}},"headline":"Make Your CLI Config Write Survive Ctrl-C Without Leaving Truncated JSON","author":{"@context":"http://schema.org","@type":"Person","url":"https://dev.to/rivera123","name":"Sam Rivera"},"datePublished":"2026-07-23T11:53:41Z","dateModified":"2026-07-23T11:53:41Z"}
  </script>
    ...
    <span data-testid="tooltip" class="crayons-tooltip__content">
      ...
      <div class="align-center m:relative">
        <button id="article-show-more-button" aria-controls="article-show-more-dropdown" aria-expanded="false" aria-haspopup="true" class="dropbtn crayons-btn crayons-btn--ghost-dimmed crayons-btn--icon-rounded" aria-label="Share post options">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" role="img" aria-labelledby="ahe353svtlf3p8z3xdhevgm84vc6jg43" aria-hidden="true" class="crayons-icon dropdown-icon"><title id="ahe353svtlf3p8z3xdhevgm84vc6jg43">More...</title><path fill-rule="evenodd" clip-rule="evenodd" d="M7 12a2 2 0 11-4 0 2 2 0 014 0zm7 0a2 2 0 11-4 0 2 2 0 014 0zm5 2a2 2 0 100-4 2 2 0 000 4z"></path></svg>
        ...
        <div id="article-show-more-dropdown" class="crayons-dropdown side-bar left-2 right-2 m:right-auto m:left-100 s:left-auto mb-1 m:mb-0 top-unset bottom-100 m:top-0 m:bottom-unset">
          <div>
            <button
              ...
              data-postUrl="https://dev.to/rivera123/make-your-cli-config-write-survive-ctrl-c-without-leaving-truncated-json-22m9">
              <span class="fw-bold">Copy link</span>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" id="article-copy-icon" role="img" aria-labelledby="ajxta6m0y8r2vsdzez42v7mf18hdsfkp" aria-hidden="true" class="crayons-icon mx-2 shrink-0"><title id="ajxta6m0y8r2vsdzez42v7mf18hdsfkp">Copy link</title>
    <path d="M7 6V3a1 1 0 011-1h12a1 1 0 011 1v14a1 1 0 01-1 1h-3v3c0 .552-.45 1-1.007 1H4.007A1 1 0 013 21l.003-14c0-.552.45-1 1.007-1H7zm2 0h8v10h2V4H9v2zm-2 5v2h6v-2H7zm0 4v2h6v-2H7z"></path>
          ...
          <div class="Desktop-only">
            <a
              ...
              rel="noopener"
              href='https://twitter.com/intent/tweet?text=%22Make%20Your%20CLI%20Config%20Write%20Survive%20Ctrl-C%20Without%20Leaving%20Truncated%20JSON%22%20by%20Sam%20Rivera%20%23DEVCommunity%20https%3A%2F%2Fdev.to%2Frivera123%2Fmake-your-cli-config-write-survive-ctrl-c-without-leaving-truncated-json-22m9'>
              Share to X
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fdev.to%2Frivera123%2Fmake-your-cli-config-write-survive-ctrl-c-without-leaving-truncated-json-22m9&title=Make%20Your%20CLI%20Config%20Write%20Survive%20Ctrl-C%20Without%20Leaving%20Truncated%20JSON&summary=Use%20write-fsync-rename%20and%20failure%20fixtures%20so%20an%20interrupted%20CLI%20update%20preserves%20either%20the%20old%20config%20or%20the%20complete%20new%20one.&source=DEV%20Community">
              Share to LinkedIn
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://www.facebook.com/sharer.php?u=https%3A%2F%2Fdev.to%2Frivera123%2Fmake-your-cli-config-write-survive-ctrl-c-without-leaving-truncated-json-22m9">
              Share to Facebook
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://s2f.kytta.dev/?text=https%3A%2F%2Fdev.to%2Frivera123%2Fmake-your-cli-config-write-survive-ctrl-c-without-leaving-truncated-json-22m9">
              Share to Mastodon
            </a>
          </div>

          <web-share-wrapper shareurl="https://dev.to/rivera123/make-your-cli-config-write-survive-ctrl-c-without-leaving-truncated-json-22m9" sharetitle="Make Your CLI Config Write Survive Ctrl-C Without Leaving Truncated JSON" sharetext="Use write-fsync-rename and failure fixtures so an interrupted CLI update preserves either the old config or the complete new one." template="web-share-button">
          </web-share-wrapper>
    ...
    <main id="main-content" class="crayons-layout__content grid gap-4">
      <div class="article-wrapper">
        ...
        <article class="crayons-card crayons-article mb-4"
          ...
          data-article-id="4214965"
          data-article-slug="make-your-cli-config-write-survive-ctrl-c-without-leaving-truncated-json-22m9"
          data-author-id="4019566"
          data-author-name="Sam Rivera"
          data-author-username="rivera123"
          data-co-author-ids=""
          data-path="/rivera123/make-your-cli-config-write-survive-ctrl-c-without-leaving-truncated-json-22m9"
            ...
            <div class="crayons-article__header__meta">
              <div class="flex s:items-start flex-col s:flex-row">
                ...
                <div class="flex flex-1 mb-5 items-start">
                  <div class="relative">
                      <a href="/rivera123"><img class="radius-full align-middle" src="https://media2.dev.to/dynamic/image/width=50,height=50,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Fuser%2Fprofile_image%2F4019566%2F35d8bd36-ac83-406e-85a8-64afd02683e5.png" width="40" height="40" alt="Sam Rivera" /></a>
                  </div>
                  <div class="pl-3 flex-1">
                    <a href="/rivera123" class="crayons-link fw-bold">Sam Rivera</a>
                    
                    <p class="fs-xs color-base-60">
                        Posted on <time datetime="2026-07-23T11:53:41Z" class="date-no-year">Jul 23</time>
      ...
      " href="/t/testing"><span class="crayons-tag__prefix">#</span>testing</a>
          ...
          <div class="crayons-article__main ">
            <div class="crayons-article__body text-styles spec__body" data-article-id="4214965"
              id="article-body">
                <p>A small CLI reads <code>config.json</code>, changes one field, and writes the file back. The code looks harmless:<br>
</p>
...
<h2>
  <a name="why-direct-overwrite-is-the-wrong-primitive" href="#why-direct-overwrite-is-the-wrong-primitive">
  </a>
...
<h2>
  <a name="the-50line-writer" href="#the-50line-writer">
  </a>
  The 50-line writer
</h2>
...
<span class="k">export</span> <span class="k">async</span> <span class="kd">function</span> <span class="nf">writeJsonAtomic</span><span class="p">(</span><span class="nx">path</span><span class="p">,</span> <span class="nx">value</span><span class="p">)</span> <span class="p">{</span>
  ...
  <span class="k">try</span> <span class="p">{</span>
    ...
    <span class="k">await</span> <span class="nx">handle</span><span class="p">.</span><span class="nf">writ