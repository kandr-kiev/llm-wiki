...
ingested: 2026-07-07
sha256: 4c41b3b0565e1ca4f2a1653a35b5c728249846582b27eea12e56c8f38d14624f
...
<head><script>document.documentElement.classList.add('js');</script>  <title>[2607.02879] MedCalc-Pro: Solving Complex Medical Calculations with LLM Agents</title>
...
<meta name="twitter:image:alt" content="arXiv logo"/>
  ...
  <script src="/static/browse/0.3.4/js/cite.js" type="text/javascript"></script><meta name="citation_title" content="MedCalc-Pro: Solving Complex Medical Calculations with LLM Agents" /><meta name="citation_author" content="Zhao, Siran" /><meta name="citation_author" content="Hou, Ruihui" /><meta name="citation_author" content="Huai, Ziyue" /><meta name="citation_author" content="Zhang, Chennuo" /><meta name="citation_author" content="Ruan, Tong" /><meta name="citation_date" content="2026/07/03" /><meta name="citation_online_date" content="2026/07/03" /><meta name="citation_pdf_url" content="https://arxiv.org/pdf/2607.02879" /><meta name="citation_arxiv_id" content="2607.02879" /><meta name="citation_abstract" content="Current benchmarks for evaluating large language models (LLMs) in medical calculation are largely based on simplified settings, where each patient case corresponds to a single calculator and the required tool is explicitly specified in the query. However, real clinical scenarios often require multiple calculators for joint evaluation, nested-scale calculation, and fuzzy queries that do not directly specify the target calculator. To this end, we propose a new medical calculation benchmark, MedCalc-Pro, which covers three progressively challenging task settings: single-calculator, multi-calculator, and nested-calculator calculation settings. MedCalc-Pro contains 2,268 real-world clinical cases, covering 77 medical calculators across 14 clinical departments. Meanwhile, to address the limited performance of existing frameworks and methods in complex clinical scenarios, we further propose a more generalizable agent framework that supports multi-tool selection and nested-tool calling, while suppressing parameter error propagation through structured validation and evidence review. We conduct systematic comparisons across open-source, closed-source, and medical-specialized LLMs, and the results show that our framework achieves the best performance across all three task settings. This work provides a new benchmark and method for evaluating and applying LLMs in challenging medical calculation scenarios." />
</head>
...
rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
    ...
    <rdf:Description
        rdf:about="/abs/2607.02879"
        dc:identifier="/abs/2607.02879"
        dc:title="MedCalc-Pro: Solving Complex Medical Calculations with LLM Agents"
        trackback:ping="/trackback/2607.02879" />
    </rdf:RDF>
--><div id="abs-outer">
  ...
  <div class="leftcolumn">
    ...
    <div class="header-breadcrumbs-mobile">
      <strong>arXiv:2607.02879</strong> (cs)
    </div>
...
<div id="content-inner">
  ...
  [Submitted on 3 Jul 2026]</div>
    <h1 class="title mathjax"><span class="descriptor">Title:</span>MedCalc-Pro: Solving Complex Medical Calculations with LLM Agents</h1>
    <div class="authors"><span class="descriptor">Authors:</span><a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Zhao,+S" rel="nofollow">Siran Zhao</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Hou,+R" rel="nofollow">Ruihui Hou</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Huai,+Z" rel="nofollow">Ziyue Huai</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Zhang,+C" rel="nofollow">Chennuo Zhang</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Ruan,+T" rel="nofollow">Tong Ruan</a></div>            <div id="download-button-info" hidden>View a PDF of the paper titled MedCalc-Pro: Solving Complex Medical Calculations with LLM Agents, by Siran Zhao and 4 other authors</div>
    <a class="mobile-submission-download" href="/pdf/2607.02879">View PDF</a>
    <a class="mobile-submission-download" href="https://arxiv.org/html/2607.02879v1">HTML (experimental)</a>



    <blockquote class="abstract mathjax">
            <span class="descriptor">Abstract:</span>Current benchmarks for evaluating large language models (LLMs) in medical calculation are largely based on simplified settings, where each patient case corresponds to a single calculator and the required tool is explicitly specified in the query. However, real clinical scenarios often require multiple calculators for joint evaluation, nested-scale calculation, and fuzzy queries that do not directly specify the target calculator. To this end, we propose a new medical calculation benchmark, MedCalc-Pro, which covers three progressively challenging task settings: single-calculator, multi-calculator, and nested-calculator calculation settings. MedCalc-Pro contains 2,268 real-world clinical cases, covering 77 medical calculators across 14 clinical departments. Meanwhile, to address the limited performance of existing frameworks and methods in complex clinical scenarios, we further propose a more generalizable agent framework that supports multi-tool selection and nested-tool calling, while suppressing parameter error propagation through structured validation and evidence review. We conduct systematic comparisons across open-source, closed-source, and medical-specialized LLMs, and the results show that our framework achieves the best performance across all three task settings. This work provides a new benchmark and method for evaluating and applying LLMs in challenging medical calculation scenarios.
    </blockquote>
    ...
    <div class="metatable">
      <table summary="Additional metadata"><tr>
          ...
          <td class="tablecell arxivid"><span class="arxivid"><a href="https://arxiv.org/abs/2607.02879">arXiv:2607.02879</a> [cs.AI]</span></td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxividv">(or <span class="arxivid">
              <a href="https://arxiv.org/abs/2607.02879v1">arXiv:2607.02879v1</a> [cs.AI]</span> for this version)
          </td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxivdoi">              <a href="https://doi.org/10.48550/arXiv.2607.02879" id="arxiv-doi-link">https://doi.org/10.48550/arXiv.2607.02879</a><div class="button-and-tooltip">
    ...
    <div class="submission-history">
      <h2>Submission history</h2> From: Ruihui Hou [<a href="/show-email/29ff3895/2607.02879" rel="nofollow">view email</a>]      <br/>    <strong>[v1]</strong>
        Fri, 3 Jul 2026 02:24:26 UTC (443 KB)<br/>
</div>
  </div>
  <!--end leftcolumn-->
...
View a PDF of the paper titled MedCalc-Pro: Solving Complex Medical Calculations with LLM Agents, by Siran Zhao and 4 other authors</div><li><a href="/pdf/2607.02879" aria-describedby="download-button-info" accesskey="f" class="abs-button download-pdf">View PDF</a></li><li><a href="https://arxiv.org/html/2607.02879v1" class="abs-button" id="latexml-download-link">HTML (experimental)</a></li><li><a href="/src/2607.02879" class="abs-button download-eprint">TeX Source
 </a></li></ul>
  ...
  <div class="prevnext">
<span class="arrow">
      <a class="abs-button prev-url" href="/prevnext?id=2607.02879&amp;function=prev&amp;context=cs.AI"
         accesskey="p" title="previous in cs.AI (accesskey p)" rel="nofollow">&lt;&nbsp;prev</a>
    </span>
    <span class="is-hidden-mobile">&nbsp; | &nbsp;</span>    <span class="arrow">
      <a class="abs-button next-url" href="/prevnext?id=2607.02879&amp;function=next&amp;context=cs.AI" accesskey="n"
    ...
    <div class="switch context-change">
        <a href="/abs/2607.02879?context=cs" rel="nofollow">cs</a><br class="is-hidden-mobile">
    </div>
  </div>
      ...
      <div class="extra-ref-cite">
        ...
        <ul>
          <li><a  class="abs-button abs-button-small cite-ads" href="https://ui.adsabs.harvard.edu/abs/arXiv:2607.02879">NASA ADS</a></li><li><a  class="abs-button abs-button-small cite-google-scholar" href="https://scholar.google.com/scholar_lookup?arxiv_id=2607.02879" target="_blank" rel="noopener">Google Scholar</a></li>
          <li><a  class="abs-button abs-button-small cite-semantic-scholar" href="https://api.semanticscholar.org/arXiv:2607.02879" target="_blank" rel="noopener">Semantic Scholar</a></li>
        </ul>
...
<div id='bib-cite-modal' class='bib-modal' hidden='true'>
  ...
  <div><h3>Bookmark</h3></div><a class="abs-button abs-button-grey abs-button-small" href="http://www.bibsonomy.org/BibtexHandler?requTask=upload&amp;url=https://arxiv.org/abs/2607.02879&amp;description=MedCalc-Pro: Solving Complex Medical Calculations with LLM Agents"
     title="Bookmark on BibSonomy">
    <img src="/static/browse/0.3.4/images/icons/social/bibsonomy.png"
         alt="BibSonomy"/>
  </a>
  <a class="abs-button abs-button-grey abs-button-small" href="https://reddit.com/submit?url=https://arxiv.org/abs/2607.02879&amp;title=MedCalc-Pro: Solving Complex Medical Calculations with LLM Agents"
...
<!-- END LABS AREA -->
  <div class="endorsers">
    <a href="/auth/show-endorsers/2607.02879" class="endorser-who" rel="nofollow">Which authors of this paper are endorsers?</a> |
