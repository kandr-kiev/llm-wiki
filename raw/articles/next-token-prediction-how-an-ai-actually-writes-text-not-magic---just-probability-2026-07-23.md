...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Next-Token Prediction: How an AI Actually Writes Text (Not Magic — Just Probability) - DEV Community</title>
    
    <link rel="preload" href="/reactions?article_id=4217023" as="fetch" crossorigin="same-origin">
    <link rel="canonical" href="https://software-engineer-blog.com/content/next-token-prediction-how-an-ai-actually-writes-text-not-magic-just-probability?id=129" />
    <meta name="description" content="An LLM never sees a finished sentence. It answers one tiny question, over and over: given everything so far, what&#39;s the next token? It builds a probability distribution over the whole vocabulary, samples from it (not always the top score), glues the. Tagged with llm, programming, softwareengineering.">
    <meta name="keywords" content="llm, programming, softwareengineering, software, coding, development, engineering, inclusive, community">

    <meta property="og:type" content="article" />
    <meta property="og:url" content="https://dev.to/vahid_aghajani_60ce9dbec9/next-token-prediction-how-an-ai-actually-writes-text-not-magic-just-probability-53dd" />
    <meta property="og:title" content="Next-Token Prediction: How an AI Actually Writes Text (Not Magic — Just Probability)" />
    <meta property="og:description" content="An LLM never sees a finished sentence. It answers one tiny question, over and over: given everything so far, what&#39;s the next token? It builds a probability distribution over the whole vocabulary, samples from it (not always the top score), glues the " />
    <meta property="og:site_name" content="DEV Community" />
    <meta name="twitter:site" content="@thepracticaldev">
    <meta name="twitter:creator" content="@">
    <meta name="author-trust" content="0">
    <meta name="twitter:title" content="Next-Token Prediction: How an AI Actually Writes Text (Not Magic — Just Probability)">
    <meta name="twitter:description" content="An LLM never sees a finished sentence. It answers one tiny question, over and over: given everything so far, what&#39;s the next token? It builds a probability distribution over the whole vocabulary, samples from it (not always the top score), glues the ">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:widgets:new-embed-design" content="on">
    <meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1">
      <meta property="og:image" content="https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fsoftware-engineer-blog.com%2Frequest%2Fbanner%2F129" />
      <meta name="twitter:image:src" content="https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fsoftware-engineer-blog.com%2Frequest%2Fbanner%2F129">

      <meta name="last-updated" content="2026-07-23 17:49:28 UTC">
      <meta name="user-signed-in" content="false">
      <meta name="head-cached-at" content="1784828968">
  ...
  <div class="crayons-header__container">
    <span class="inline-block m:hidden ">
      <button class="c-btn c-btn--icon-alone js-hamburger-trigger mx-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a3lnahhupp15qqsah37z6q8wce1tauoj" class="crayons-icon"><title id="a3lnahhupp15qqsah37z6q8wce1tauoj">Navigation menu</title>
        ...
        <div class="crayons-fields crayons-fields--horizontal">
          <div class="crayons-field flex-1 relative">
            ...
            <button type="submit" aria-label="Search" class="c-btn c-btn--icon-alone absolute inset-px right-auto mt-0 py-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="afgy8lrvomz65swfg9heyxta26ei0dou" aria-hidden="true" class="crayons-icon"><title id="afgy8lrvomz65swfg9heyxta26ei0dou">Search</title>
    <path d="M18.031 16.617l4.283 4.282-1.415 1.415-4.282-4.283A8.96 8.96 0 0111 20c-4.968 0-9-4.032-9-9s4.032-9 9-9 9 4.032 9 9a8.96 8.96 0 01-1.969 5.617zm-2.006-.742A6.977 6.977 0 0018 11c0-3.868-3.133-7-7-7-3.868 0-7 3.132-7 7 0 3.867 3.132 7 7 7a6.977 6.977 0 004.875-1.975l.15-.15z"></path>
            ...
            <a class="crayons-header--search-brand-indicator" href="https://www.algolia.com/developers/?utm_source=devto&utm_medium=referral" target="_blank" rel="noopener noreferrer">
                Powered by Algolia
                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" width="24" height="24" viewBox="0 0 500 500.34" role="img" aria-labelledby="a7tpey7k647m2efgiv52ybtgon3wkv0k" aria-hidden="true" class="crayons-icon"><title id="a7tpey7k647m2efgiv52ybtgon3wkv0k">Search</title>
  ...
  <div class="hamburger__content">
    <header class="hamburger__content__header">
      ...
      <button class="c-btn c-btn--icon-alone js-hamburger-trigger shrink-0" aria-label="Close">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="aepzbwmmpp1b7kkp6i4yfcfvpast09jw" aria-hidden="true" class="crayons-icon c-btn__icon"><title id="aepzbwmmpp1b7kkp6i4yfcfvpast09jw">Close</title><path d="M12 10.586l4.95-4.95 1.414 1.414-4.95 4.95 4.95 4.95-1.414 1.414-4.95-4.95-4.95 4.95-1.414-1.414 4.95-4.95-4.95-4.95L7.05 5.636l4.95 4.95z"></path></svg>
...
<div id="page-content" class="wrapper stories stories-show articletag-llm articletag-programming articletag-softwareengineering articleuser-4015358" data-current-page="stories-show">
  <div id="page-content-inner" data-internal-nav="false" data-viewable-id="4217023" data-viewable-type="Article">
...
<script src="https://assets.dev.to/assets/commentDropdowns-7a28d130e5b78d38b30a9495a964003a66bd64fa455fc70b766d69cf06b9ba24.js" defer="defer"></script>
  ...
  <script type="application/ld+json">
    {"@context":"http://schema.org","@type":"Article","mainEntityOfPage":{"@type":"WebPage","@id":"https://dev.to/vahid_aghajani_60ce9dbec9/next-token-prediction-how-an-ai-actually-writes-text-not-magic-just-probability-53dd"},"url":"https://dev.to/vahid_aghajani_60ce9dbec9/next-token-prediction-how-an-ai-actually-writes-text-not-magic-just-probability-53dd","image":["https://media2.dev.to/dynamic/image/width=1080,height=1080,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fsoftware-engineer-blog.com%2Frequest%2Fbanner%2F129","https://media2.dev.to/dynamic/image/width=1280,height=720,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fsoftware-engineer-blog.com%2Frequest%2Fbanner%2F129","https://media2.dev.to/dynamic/image/width=1600,height=900,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fsoftware-engineer-blog.com%2Frequest%2Fbanner%2F129"],"publisher":{"@context":"http://schema.org","@type":"Organization","name":"DEV Community","logo":{"@context":"http://schema.org","@type":"ImageObject","url":"https://media2.dev.to/dynamic/image/width=192,height=,fit=scale-down,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F8j7kvp660rqzt99zui8e.png","width":"192","height":"192"}},"headline":"Next-Token Prediction: How an AI Actually Writes Text (Not Magic — Just Probability)","author":{"@context":"http://schema.org","@type":"Person","url":"https://dev.to/vahid_aghajani_60ce9dbec9","name":"Vahid Aghajani"},"datePublished":"2026-07-23T17:48:21Z","dateModified":"2026-07-23T17:48:21Z"}
  </script>
    ...
    <span data-testid="tooltip" class="crayons-tooltip__content">
      ...
      <div class="align-center m:relative">
        <button id="article-show-more-button" aria-controls="article-show-more-dropdown" aria-expanded="false" aria-haspopup="true" class="dropbtn crayons-btn crayons-btn--ghost-dimmed crayons-btn--icon-rounded" aria-label="Share post options">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" role="img" aria-labelledby="aqowpfpshjalgecnzggyl4aufg8mtgwi" aria-hidden="true" class="crayons-icon dropdown-icon"><title id="aqowpfpshjalgecnzggyl4aufg8mtgwi">More...</title><path fill-rule="evenodd" clip-rule="evenodd" d="M7 12a2 2 0 11-4 0 2 2 0 014 0zm7 0a2 2 0 11-4 0 2 2 0 014 0zm5 2a2 2 0 100-4 2 2 0 000 4z"></path></svg>
        ...
        <div id="article-show-more-dropdown" class="crayons-dropdown side-bar left-2 right-2 m:right-auto m:left-100 s:left-auto mb-1 m:mb-0 top-unset bottom-100 m:top-0 m:bottom-unset">
          <div>
            <button
              ...
              data-postUrl="https://dev.to/vahid_aghajani_60ce9dbec9/next-token-prediction-how-an-ai-actually-writes-text-not-magic-just-probability-53dd">
              <span class="fw-bold">Copy link</span>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" id="article-copy-icon" role="img" aria-labelledby="ag3adstlafuthnucnuaralahn0wghods" aria-hidden="true" class="crayons-icon mx-2 shrink-0"><title id="ag3adstlafuthnucnuaralahn0wghods">Copy link</title>
    <path d="M7 6V3a1 1 0 011-1h12a1 1 0 011 1v14a1 1 0 01-1 1h-3v3c0 .552-.45 1-1.007 1H4.007A1 1 0 013 21l.003-14c0-.552.45-1 1.007-1H7zm2 0h8v10h2V4H9v2zm-2 5v2h6v-2H7zm0 4v2h6v-2H7z"></path>
          ...
          <div class="Desktop-only">
            <a
              ...
              rel="noopener"
              href='https://twitter.com/intent/tweet?text=%22Next-Token%20Prediction%3A%20How%20an%20AI%20Actually%20Writes%20Text%20%28Not%20Magic%20%E2%80%94%20Just%20Probability%29%22%20by%20Vahid%20Aghajani%20%23DEVCommunity%20https%3A%2F%2Fdev.to%2Fvahid_aghajani_60ce9dbec9%2Fnext-token-prediction-how-an-ai-actually-writes-text-not-magic-just-probability-53dd'>
              Share to X
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fdev.to%2Fvahid_aghajani_60ce9dbec9%2Fnext-token-prediction-how-an-ai-actually-writes-text-not-magic-just-probability-53dd&title=Next-Token%20Prediction%3A%20How%20an%20AI%20Actually%20Writes%20Text%20%28Not%20Magic%20%E2%80%94%20Just%20Probability%29&summary=An%20LLM%20never%20sees%20a%20finished%20sentence.%20It%20answers%20one%20tiny%20question%2C%20over%20and%20over%3A%20given%20everything%20so%20far%2C%20what%27s%20the%20next%20token%3F%20It%20builds%20a%20probability%20distribution%20over%20the%20whole%20vocabulary%2C%20samples%20from%20it%20%28not%20always%20the%20top%20score%29%2C%20glues%20the%20&source=DEV%20Community">
              Share to LinkedIn
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://www.facebook.com/sharer.php?u=https%3A%2F%2Fdev.to%2Fvahid_aghajani_60ce9dbec9%2Fnext-token-prediction-how-an-ai-actually-writes-text-not-magic-just-probability-53dd">
              Share to Facebook
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://s2f.kytta.dev/?text=https%3A%2F%2Fdev.to%2Fvahid_aghajani_60ce9dbec9%2Fnext-token-prediction-how-an-ai-actually-writes-text-not-magic-just-probability-53dd">
              Share to Mastodon
            </a>
          </div>

          <web-share-wrapper shareurl="https://dev.to/vahid_aghajani_60ce9dbec9/next-token-prediction-how-an-ai-actually-writes-text-not-magic-just-probability-53dd" sharetitle="Next-Token Prediction: How an AI Actually Writes Text (Not Magic — Just Probability)" sharetext="An LLM never sees a finished sentence. It answers one tiny question, over and over: given everything so far, what&#39;s the next token? It builds a probability distribution over the whole vocabulary, samples from it (not always the top score), glues the " template="web-share-button">
          </web-share-wrapper>
    ...
    <main id="main-content" class="crayons-layout__content grid gap-4">
      <div class="article-wrapper">
        ...
        <article class="crayons-card crayons-article mb-4"
          ...
          data-article-id="4217023"
          data-article-slug="next-token-prediction-how-an-ai-actually-writes-text-not-magic-just-probability-53dd"
          data-author-id="4015358"
          data-author-name="Vahid Aghajani"
          data-author-username="vahid_aghajani_60ce9dbec9"
          data-co-author-ids=""
          data-path="/vahid_aghajani_60ce9dbec9/next-token-prediction-how-an-ai-actually-writes-text-not-magic-just-probability-53dd"
          ...
          <header class="crayons-article__header" id="main-title">
              <a class="crayons-article__cover" href="https://media2.dev.to/dynamic/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fsoftware-engineer-blog.com%2Frequest%2Fbanner%2F129">
                <img
                  src="https://media2.dev.to/dynamic/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fsoftware-engineer-blog.com%2Frequest%2Fbanner%2F129"
                  style="aspect-ratio: auto 1000 / 420;"
                  width="1000" height="420"
                  class="crayons-article__cover__image" alt="Cover image for Next-Token Prediction: How an AI Actually Writes Text (Not Magic — Just Probability)">
              </a>
            ...
            <div class="crayons-article__header__meta">
              <div class="flex s:items-start flex-col s:flex-row">
                ...
                <div class="flex flex-1 mb-5 items-start">
                  <div class="relative">
                      <a href="/vahid_aghajani_60ce9dbec9"><img class="radius-full align-middle" src="https://media2.dev.to/dynamic/image/width=50,height=50,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Fuser%2Fprofile_image%2F4015358%2F35ccb2f9-355f-4af6-a004-19ae755a9d8c.png" width="40" height="40" alt="Vahid Aghajani" /></a>
                  </div>
                  <div class="pl-3 flex-1">
                    <a href="/vahid_aghajani_60ce9dbec9" class="crayons-link fw-bold">Vahid Aghajani</a>
                    
                    <p class="fs-xs color-base-60">
                        Posted on <time datetime="2026-07-23T17:48:21Z" class="date-no-year">Jul 23</time>


                        &bull; Originally published at <a style="color:#1395b8" href="https://software-engineer-blog.com/content/next-token-prediction-how-an-ai-actually-writes-text-not-magic-just-probability?id=129">software-engineer-blog.com</a> 
                    </p>
                  </div>
                </div>
              </div>
      ...
      " href="/t/softwareengineering"><span class="crayons-tag__prefix">#</span>softwareengineering</a>
          ...
          <div class="crayons-article__main ">
            <div class="crayons-article__body text-styles spec__body" data-article-id="4217023"
              id="article-body">
                <blockquote>
<p>📺 Prefer to watch? <a href="https://youtu.be/vbnIZiyaFCE" target="_blank" rel="noopener noreferrer">90-second YouTube Short</a> · 💬 <a href="https://t.me/SoftwareEngineerBlog" target="_blank" rel="noopener noreferrer">Telegram</a></p>
</blockquote>

<p><em>Originally published on <a href="https://software-engineer-blog.com/content/next-token-prediction-how-an-ai-actually-writes-text-not-magic-just-probability?id=129" target="_blank" rel="noopener noreferrer">software-engineer-blog.com</a>.</em></p>
...
<h2>
  <a name="the-concrete-example-finishing-one-sentence" href="#the-concrete-example-finishing-one-sentence">
  </a>
...
<h2>
  <a name="the-part-almost-everyone-skips-it-samples-it-doesnt-grab-the-top-score" href="#the-part-almost-everyone-skips-it-samples-it-doesnt-grab-the-top-score">
  </a>
...
<div class="highlight__panel js-actions-panel">
<div class="highlight__panel-action js-fullscreen-code-action">
    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewbox="0 0 24 24" class="highlight-action crayons-icon highlight-action--fullscreen-on"><title>Enter fullscreen mode</titl