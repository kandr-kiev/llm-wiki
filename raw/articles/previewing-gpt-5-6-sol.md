...
---
- - - - - - - - - - - - - - - - - - - - Previewing GPT-5.6 Sol: a next-generation model | OpenAI- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - [Skip to main content](#main)
...
- Company
- [Foundation(opens in a new window)](https://openaifoundation.org)
[Try ChatGPT(opens in a new window)](https://chatgpt.com/)Login<div id="header-nav-dropdown-panel" role="region" aria-hidden="true" aria-label="Expanded Navigation Menu" class="bg-secondary-100 top-header-h duration-short ease-
