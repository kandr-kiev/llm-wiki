...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Route Nylas notifications to Google Pub/Sub - DEV Community</title>
    
    <link rel="preload" href="/reactions?article_id=3965250" as="fetch" crossorigin="same-origin">
    <link rel="canonical" href="https://dev.to/mqasimca/route-nylas-notifications-to-google-pubsub-4h6g" />
    <meta name="description" content="HTTP webhooks need an always-up endpoint that absorbs bursts. Deliver Nylas notifications to a Google Pub/Sub topic instead, for buffering and deliverability guarantees, with the API and CLI. Tagged with api, webhooks, gcp, devtools.">
    <meta name="keywords" content="api, webhooks, gcp, devtools, software, coding, development, engineering, inclusive, community">

    <meta property="og:type" content="article" />
    <meta property="og:url" content="https://dev.to/mqasimca/route-nylas-notifications-to-google-pubsub-4h6g" />
    <meta property="og:title" content="Route Nylas notifications to Google Pub/Sub" />
    <meta property="og:description" content="HTTP webhooks need an always-up endpoint that absorbs bursts. Deliver Nylas notifications to a Google Pub/Sub topic instead, for buffering and deliverability guarantees, with the API and CLI." />
    <meta property="og:site_name" content="DEV Community" />
    <meta name="twitter:site" content="@thepracticaldev">
    <meta name="twitter:creator" content="@mqasimcax">
    <meta name="author-trust" content="0">
    <meta name="twitter:title" content="Route Nylas notifications to Google Pub/Sub">
    <meta name="twitter:description" content="HTTP webhooks need an always-up endpoint that absorbs bursts. Deliver Nylas notifications to a Google Pub/Sub topic instead, for buffering and deliverability guarantees, with the API and CLI.">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:widgets:new-embed-design" content="on">
    <meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1">
      <meta property="og:image" content="https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fst7135b1knllaahii2og.png" />
      <meta name="twitter:image:src" content="https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fst7135b1knllaahii2og.png">

      <meta name="last-updated" content="2026-07-23 11:54:17 UTC">
      <meta name="user-signed-in" content="false">
      <meta name="head-cached-at" content="1784807657">
  ...
  <div class="crayons-header__container">
    <span class="inline-block m:hidden ">
      <button class="c-btn c-btn--icon-alone js-hamburger-trigger mx-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a8l7dod1x3ihjhkq9b2cgwpqdy808tl" class="crayons-icon"><title id="a8l7dod1x3ihjhkq9b2cgwpqdy808tl">Navigation menu</title>
        ...
        <div class="crayons-fields crayons-fields--horizontal">
          <div class="crayons-field flex-1 relative">
            ...
            <button type="submit" aria-label="Search" class="c-btn c-btn--icon-alone absolute inset-px right-auto mt-0 py-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a4qpw89a9o3mexzm3zawxceu3gm6epip" aria-hidden="true" class="crayons-icon"><title id="a4qpw89a9o3mexzm3zawxceu3gm6epip">Search</title>
    <path d="M18.031 16.617l4.283 4.282-1.415 1.415-4.282-4.283A8.96 8.96 0 0111 20c-4.968 0-9-4.032-9-9s4.032-9 9-9 9 4.032 9 9a8.96 8.96 0 01-1.969 5.617zm-2.006-.742A6.977 6.977 0 0018 11c0-3.868-3.133-7-7-7-3.868 0-7 3.132-7 7 0 3.867 3.132 7 7 7a6.977 6.977 0 004.875-1.975l.15-.15z"></path>
            ...
            <a class="crayons-header--search-brand-indicator" href="https://www.algolia.com/developers/?utm_source=devto&utm_medium=referral" target="_blank" rel="noopener noreferrer">
                Powered by Algolia
                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" width="24" height="24" viewBox="0 0 500 500.34" role="img" aria-labelledby="ag47hveblpm3s7azn66en7p4zhky96n5" aria-hidden="true" class="crayons-icon"><title id="ag47hveblpm3s7azn66en7p4zhky96n5">Search</title>
  ...
  <div class="hamburger__content">
    <header class="hamburger__content__header">
      ...
      <button class="c-btn c-btn--icon-alone js-hamburger-trigger shrink-0" aria-label="Close">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a5rykobpvftcdvuay6tvg6rnvc7nni5r" aria-hidden="true" class="crayons-icon c-btn__icon"><title id="a5rykobpvftcdvuay6tvg6rnvc7nni5r">Close</title><path d="M12 10.586l4.95-4.95 1.414 1.414-4.95 4.95 4.95 4.95-1.414 1.414-4.95-4.95-4.95 4.95-1.414-1.414 4.95-4.95-4.95-4.95L7.05 5.636l4.95 4.95z"></path></svg>
...
<div id="page-content" class="wrapper stories stories-show articletag-api articletag-webhooks articletag-gcp articletag-devtools articleuser-3995627" data-current-page="stories-show">
  <div id="page-content-inner" data-internal-nav="false" data-viewable-id="3965250" data-viewable-type="Article">
...
<script src="https://assets.dev.to/assets/commentDropdowns-7a28d130e5b78d38b30a9495a964003a66bd64fa455fc70b766d69cf06b9ba24.js" defer="defer"></script>
  ...
  <script type="application/ld+json">
    {"@context":"http://schema.org","@type":"Article","mainEntityOfPage":{"@type":"WebPage","@id":"https://dev.to/mqasimca/route-nylas-notifications-to-google-pubsub-4h6g"},"url":"https://dev.to/mqasimca/route-nylas-notifications-to-google-pubsub-4h6g","image":["https://media2.dev.to/dynamic/image/width=1080,height=1080,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fst7135b1knllaahii2og.png","https://media2.dev.to/dynamic/image/width=1280,height=720,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fst7135b1knllaahii2og.png","https://media2.dev.to/dynamic/image/width=1600,height=900,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Fst7135b1knllaahii2og.png"],"publisher":{"@context":"http://schema.org","@type":"Organization","name":"DEV Community","logo":{"@context":"http://schema.org","@type":"ImageObject","url":"https://media2.dev.to/dynamic/image/width=192,height=,fit=scale-down,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F8j7kvp660rqzt99zui8e.png","width":"192","height":"192"}},"headline":"Route Nylas notifications to Google Pub/Sub","author":{"@context":"http://schema.org","@type":"Person","url":"https://dev.to/mqasimca","name":"Qasim"},"datePublished":"2026-07-23T11:53:46Z","dateModified":"2026-07-23T11:53:46Z"}
  </script>
    ...
    <span data-testid="tooltip" class="crayons-tooltip__content">
      ...
      <div class="align-center m:relative">
        <button id="article-show-more-button" aria-controls="article-show-more-dropdown" aria-expanded="false" aria-haspopup="true" class="dropbtn crayons-btn crayons-btn--ghost-dimmed crayons-btn--icon-rounded" aria-label="Share post options">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" role="img" aria-labelledby="ajoxxdxwnrgl2esqcacc0jzl9gwjab7f" aria-hidden="true" class="crayons-icon dropdown-icon"><title id="ajoxxdxwnrgl2esqcacc0jzl9gwjab7f">More...</title><path fill-rule="evenodd" clip-rule="evenodd" d="M7 12a2 2 0 11-4 0 2 2 0 014 0zm7 0a2 2 0 11-4 0 2 2 0 014 0zm5 2a2 2 0 100-4 2 2 0 000 4z"></path></svg>
        ...
        <div id="article-show-more-dropdown" class="crayons-dropdown side-bar left-2 right-2 m:right-auto m:left-100 s:left-auto mb-1 m:mb-0 top-unset bottom-100 m:top-0 m:bottom-unset">
          <div>
            <button
              ...
              data-postUrl="https://dev.to/mqasimca/route-nylas-notifications-to-google-pubsub-4h6g">
              <span class="fw-bold">Copy link</span>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" id="article-copy-icon" role="img" aria-labelledby="a6wonrbua7sdd3fr1frjyha3npw5ewgf" aria-hidden="true" class="crayons-icon mx-2 shrink-0"><title id="a6wonrbua7sdd3fr1frjyha3npw5ewgf">Copy link</title>
    <path d="M7 6V3a1 1 0 011-1h12a1 1 0 011 1v14a1 1 0 01-1 1h-3v3c0 .552-.45 1-1.007 1H4.007A1 1 0 013 21l.003-14c0-.552.45-1 1.007-1H7zm2 0h8v10h2V4H9v2zm-2 5v2h6v-2H7zm0 4v2h6v-2H7z"></path>
          ...
          <div class="Desktop-only">
            <a
              ...
              rel="noopener"
              href='https://twitter.com/intent/tweet?text=%22Route%20Nylas%20notifications%20to%20Google%20Pub%2FSub%22%20by%20%40mqasimcax%20%23DEVCommunity%20https%3A%2F%2Fdev.to%2Fmqasimca%2Froute-nylas-notifications-to-google-pubsub-4h6g'>
              Share to X
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fdev.to%2Fmqasimca%2Froute-nylas-notifications-to-google-pubsub-4h6g&title=Route%20Nylas%20notifications%20to%20Google%20Pub%2FSub&summary=HTTP%20webhooks%20need%20an%20always-up%20endpoint%20that%20absorbs%20bursts.%20Deliver%20Nylas%20notifications%20to%20a%20Google%20Pub%2FSub%20topic%20instead%2C%20for%20buffering%20and%20deliverability%20guarantees%2C%20with%20the%20API%20and%20CLI.&source=DEV%20Community">
              Share to LinkedIn
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://www.facebook.com/sharer.php?u=https%3A%2F%2Fdev.to%2Fmqasimca%2Froute-nylas-notifications-to-google-pubsub-4h6g">
              Share to Facebook
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://s2f.kytta.dev/?text=https%3A%2F%2Fdev.to%2Fmqasimca%2Froute-nylas-notifications-to-google-pubsub-4h6g">
              Share to Mastodon
            </a>
          </div>

          <web-share-wrapper shareurl="https://dev.to/mqasimca/route-nylas-notifications-to-google-pubsub-4h6g" sharetitle="Route Nylas notifications to Google Pub/Sub" sharetext="HTTP webhooks need an always-up endpoint that absorbs bursts. Deliver Nylas notifications to a Google Pub/Sub topic instead, for buffering and deliverability guarantees, with the API and CLI." template="web-share-button">
          </web-share-wrapper>
    ...
    <main id="main-content" class="crayons-layout__content grid gap-4">
      <div class="article-wrapper">
        ...
        <article class="crayons-card crayons-article mb-4"
          ...
          data-article-id="3965250"
          data-article-slug="route-nylas-notifications-to-google-pubsub-4h6g"
          data-author-id="3995627"
          data-author-name="Qasim"
          data-author-username="mqasimca"
          data-co-author-ids=""
          data-path="/mqasimca/route-nylas-notifications-to-google-pubsub-4h6g"
            ...
            <div class="crayons-article__header__meta">
              <div class="flex s:items-start flex-col s:flex-row">
                ...
                <div class="flex flex-1 mb-5 items-start">
                  <div class="relative">
                      <a href="/mqasimca"><img class="radius-full align-middle" src="https://media2.dev.to/dynamic/image/width=50,height=50,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Fuser%2Fprofile_image%2F3995627%2Feddc44d6-3e99-45b8-ae80-71279c900b01.jpg" width="40" height="40" alt="Qasim" /></a>
                  </div>
                  <div class="pl-3 flex-1">
                    <a href="/mqasimca" class="crayons-link fw-bold">Qasim</a>
                    
                    <p class="fs-xs color-base-60">
                        Posted on <time datetime="2026-07-23T11:53:46Z" class="date-no-year">Jul 23</time>
      ...
      " href="/t/webhooks"><span class="crayons-tag__prefix">#</span>webhooks</a>
                      <a class="crayons-tag   " style="
        --tag-bg: rgba(64, 78, 211, 0.10);
        --tag-prefix: #404ED3;
        --tag-bg-hover: rgba(64, 78, 211, 0.10);
...
<h2>
  <a name="why-pubsub-instead-of-an-http-endpoint" href="#why-pubsub-instead-of-an-http-endpoint">
  </a>
...
<h2>
  <a name="set-up-the-topic-first" href="#set-up-the-topic-first">
  </a>
...
<h2>
  <a name="create-the-channel" href="#create-the-channel">
  </a>
  Create the channel
</h2>
...
<div class="highlight__panel-action js-fullscreen-code-action">
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" viewbox="0 0 24 24" class="highlight-action crayons-icon highlight-action--fullscreen-off"><title>Exit fullscreen mode</title>
    <path d="M18 7h4v2h-6V3h2v4zM8 9H2V7h4V3h2v6zm10 8v4h-2v-6h6v2