...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Server state and client state: why React apps need two libraries - DEV Community</title>
    
    <link rel="preload" href="/reactions?article_id=4186912" as="fetch" crossorigin="same-origin">
    <link rel="canonical" href="https://warrendeleon.com/blog/server-state-and-client-state-react-native/" />
    <meta name="description" content="Server state and client state have different requirements. Why modern React stacks split the job between two libraries instead of one store. Tagged with reactnative, statemanagement, redux, reduxtoolkit.">
    <meta name="keywords" content="reactnative, statemanagement, redux, reduxtoolkit, software, coding, development, engineering, inclusive, community">

    <meta property="og:type" content="article" />
    <meta property="og:url" content="https://dev.to/warrendeleon/server-state-and-client-state-why-react-apps-need-two-libraries-144h" />
    <meta property="og:title" content="Server state and client state: why React apps need two libraries" />
    <meta property="og:description" content="Server state and client state have different requirements. Why modern React stacks split the job between two libraries instead of one store." />
    <meta property="og:site_name" content="DEV Community" />
    <meta name="twitter:site" content="@thepracticaldev">
    <meta name="twitter:creator" content="@warren_deleon">
    <meta name="author-trust" content="0">
    <meta name="twitter:title" content="Server state and client state: why React apps need two libraries">
    <meta name="twitter:description" content="Server state and client state have different requirements. Why modern React stacks split the job between two libraries instead of one store.">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:widgets:new-embed-design" content="on">
    <meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1">
      <meta property="og:image" content="https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fwarrendeleon.com%2Fimages%2Fblog%2Fserver-vs-client-state.webp" />
      <meta name="twitter:image:src" content="https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fwarrendeleon.com%2Fimages%2Fblog%2Fserver-vs-client-state.webp">

      <meta name="last-updated" content="2026-07-20 10:32:45 UTC">
      <meta name="user-signed-in" content="false">
      <meta name="head-cached-at" content="1784543565">
  ...
  <div class="crayons-header__container">
    <span class="inline-block m:hidden ">
      <button class="c-btn c-btn--icon-alone js-hamburger-trigger mx-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="agrylvglpt1c8ii0c7qenc97at1wepuu" class="crayons-icon"><title id="agrylvglpt1c8ii0c7qenc97at1wepuu">Navigation menu</title>
        ...
        <div class="crayons-fields crayons-fields--horizontal">
          <div class="crayons-field flex-1 relative">
            ...
            <button type="submit" aria-label="Search" class="c-btn c-btn--icon-alone absolute inset-px right-auto mt-0 py-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="ae6m6uwp39x2iu0pfo3apoipltl5a7sk" aria-hidden="true" class="crayons-icon"><title id="ae6m6uwp39x2iu0pfo3apoipltl5a7sk">Search</title>
    <path d="M18.031 16.617l4.283 4.282-1.415 1.415-4.282-4.283A8.96 8.96 0 0111 20c-4.968 0-9-4.032-9-9s4.032-9 9-9 9 4.032 9 9a8.96 8.96 0 01-1.969 5.617zm-2.006-.742A6.977 6.977 0 0018 11c0-3.868-3.133-7-7-7-3.868 0-7 3.132-7 7 0 3.867 3.132 7 7 7a6.977 6.977 0 004.875-1.975l.15-.15z"></path>
            ...
            <a class="crayons-header--search-brand-indicator" href="https://www.algolia.com/developers/?utm_source=devto&utm_medium=referral" target="_blank" rel="noopener noreferrer">
                Powered by Algolia
                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" width="24" height="24" viewBox="0 0 500 500.34" role="img" aria-labelledby="a6igxbszadeucbr52wpdh80jzedtvh1j" aria-hidden="true" class="crayons-icon"><title id="a6igxbszadeucbr52wpdh80jzedtvh1j">Search</title>
  ...
  <div class="hamburger__content">
    <header class="hamburger__content__header">
      ...
      <button class="c-btn c-btn--icon-alone js-hamburger-trigger shrink-0" aria-label="Close">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a2hh3r17mbugkl0gtae4kw398lvv1v5v" aria-hidden="true" class="crayons-icon c-btn__icon"><title id="a2hh3r17mbugkl0gtae4kw398lvv1v5v">Close</title><path d="M12 10.586l4.95-4.95 1.414 1.414-4.95 4.95 4.95 4.95-1.414 1.414-4.95-4.95-4.95 4.95-1.414-1.414 4.95-4.95-4.95-4.95L7.05 5.636l4.95 4.95z"></path></svg>
...
<div id="page-content" class="wrapper stories stories-show articletag-reactnative articletag-statemanagement articletag-redux articletag-reduxtoolkit articleuser-3849498" data-current-page="stories-show">
  <div id="page-content-inner" data-internal-nav="false" data-viewable-id="4186912" data-viewable-type="Article">
...
<script src="https://assets.dev.to/assets/commentDropdowns-7a28d130e5b78d38b30a9495a964003a66bd64fa455fc70b766d69cf06b9ba24.js" defer="defer"></script>
  ...
  <script type="application/ld+json">
    {"@context":"http://schema.org","@type":"Article","mainEntityOfPage":{"@type":"WebPage","@id":"https://dev.to/warrendeleon/server-state-and-client-state-why-react-apps-need-two-libraries-144h"},"url":"https://dev.to/warrendeleon/server-state-and-client-state-why-react-apps-need-two-libraries-144h","image":["https://media2.dev.to/dynamic/image/width=1080,height=1080,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fwarrendeleon.com%2Fimages%2Fblog%2Fserver-vs-client-state.webp","https://media2.dev.to/dynamic/image/width=1280,height=720,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fwarrendeleon.com%2Fimages%2Fblog%2Fserver-vs-client-state.webp","https://media2.dev.to/dynamic/image/width=1600,height=900,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fwarrendeleon.com%2Fimages%2Fblog%2Fserver-vs-client-state.webp"],"publisher":{"@context":"http://schema.org","@type":"Organization","name":"DEV Community","logo":{"@context":"http://schema.org","@type":"ImageObject","url":"https://media2.dev.to/dynamic/image/width=192,height=,fit=scale-down,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F8j7kvp660rqzt99zui8e.png","width":"192","height":"192"}},"headline":"Server state and client state: why React apps need two libraries","author":{"@context":"http://schema.org","@type":"Person","url":"https://dev.to/warrendeleon","name":"Warren de Leon"},"datePublished":"2026-07-20T10:32:17Z","dateModified":"2026-07-20T10:32:17Z"}
  </script>
    ...
    <span data-testid="tooltip" class="crayons-tooltip__content">
      ...
      <div class="align-center m:relative">
        <button id="article-show-more-button" aria-controls="article-show-more-dropdown" aria-expanded="false" aria-haspopup="true" class="dropbtn crayons-btn crayons-btn--ghost-dimmed crayons-btn--icon-rounded" aria-label="Share post options">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" role="img" aria-labelledby="a9jv56em89tdk60c1sgn76km2hanjksq" aria-hidden="true" class="crayons-icon dropdown-icon"><title id="a9jv56em89tdk60c1sgn76km2hanjksq">More...</title><path fill-rule="evenodd" clip-rule="evenodd" d="M7 12a2 2 0 11-4 0 2 2 0 014 0zm7 0a2 2 0 11-4 0 2 2 0 014 0zm5 2a2 2 0 100-4 2 2 0 000 4z"></path></svg>
        ...
        <div id="article-show-more-dropdown" class="crayons-dropdown side-bar left-2 right-2 m:right-auto m:left-100 s:left-auto mb-1 m:mb-0 top-unset bottom-100 m:top-0 m:bottom-unset">
          <div>
            <button
              ...
              data-postUrl="https://dev.to/warrendeleon/server-state-and-client-state-why-react-apps-need-two-libraries-144h">
              <span class="fw-bold">Copy link</span>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" id="article-copy-icon" role="img" aria-labelledby="adcudgj6nnx37ivwendmix4tvp643fes" aria-hidden="true" class="crayons-icon mx-2 shrink-0"><title id="adcudgj6nnx37ivwendmix4tvp643fes">Copy link</title>
    <path d="M7 6V3a1 1 0 011-1h12a1 1 0 011 1v14a1 1 0 01-1 1h-3v3c0 .552-.45 1-1.007 1H4.007A1 1 0 013 21l.003-14c0-.552.45-1 1.007-1H7zm2 0h8v10h2V4H9v2zm-2 5v2h6v-2H7zm0 4v2h6v-2H7z"></path>
          ...
          <div class="Desktop-only">
            <a
              ...
              rel="noopener"
              href='https://twitter.com/intent/tweet?text=%22Server%20state%20and%20client%20state%3A%20why%20React%20apps%20need%20two%20libraries%22%20by%20%40warren_deleon%20%23DEVCommunity%20https%3A%2F%2Fdev.to%2Fwarrendeleon%2Fserver-state-and-client-state-why-react-apps-need-two-libraries-144h'>
              Share to X
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fdev.to%2Fwarrendeleon%2Fserver-state-and-client-state-why-react-apps-need-two-libraries-144h&title=Server%20state%20and%20client%20state%3A%20why%20React%20apps%20need%20two%20libraries&summary=Server%20state%20and%20client%20state%20have%20different%20requirements.%20Why%20modern%20React%20stacks%20split%20the%20job%20between%20two%20libraries%20instead%20of%20one%20store.&source=DEV%20Community">
              Share to LinkedIn
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://www.facebook.com/sharer.php?u=https%3A%2F%2Fdev.to%2Fwarrendeleon%2Fserver-state-and-client-state-why-react-apps-need-two-libraries-144h">
              Share to Facebook
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://s2f.kytta.dev/?text=https%3A%2F%2Fdev.to%2Fwarrendeleon%2Fserver-state-and-client-state-why-react-apps-need-two-libraries-144h">
              Share to Mastodon
            </a>
          </div>

          <web-share-wrapper shareurl="https://dev.to/warrendeleon/server-state-and-client-state-why-react-apps-need-two-libraries-144h" sharetitle="Server state and client state: why React apps need two libraries" sharetext="Server state and client state have different requirements. Why modern React stacks split the job between two libraries instead of one store." template="web-share-button">
          </web-share-wrapper>
    ...
    <main id="main-content" class="crayons-layout__content grid gap-4">
      <div class="article-wrapper">
        ...
        <article class="crayons-card crayons-article mb-4"
          ...
          data-article-id="4186912"
          data-article-slug="server-state-and-client-state-why-react-apps-need-two-libraries-144h"
          data-author-id="3849498"
          data-author-name="Warren de Leon"
          data-author-username="warrendeleon"
          data-co-author-ids=""
          data-path="/warrendeleon/server-state-and-client-state-why-react-apps-need-two-libraries-144h"
          ...
          <header class="crayons-article__header" id="main-title">
              <a class="crayons-article__cover" href="https://media2.dev.to/dynamic/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fwarrendeleon.com%2Fimages%2Fblog%2Fserver-vs-client-state.webp">
                <img
                  src="https://media2.dev.to/dynamic/image/width=1000,height=420,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fwarrendeleon.com%2Fimages%2Fblog%2Fserver-vs-client-state.webp"
                  style="aspect-ratio: auto 1000 / 420;"
                  width="1000" height="420"
                  class="crayons-article__cover__image" alt="Cover image for Server state and client state: why React apps need two libraries">
              </a>
            ...
            <div class="crayons-article__header__meta">
              <div class="flex s:items-start flex-col s:flex-row">
                ...
                <div class="flex flex-1 mb-5 items-start">
                  <div class="relative">
                      <a href="/warrendeleon"><img class="radius-full align-middle" src="https://media2.dev.to/dynamic/image/width=50,height=50,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Fuser%2Fprofile_image%2F3849498%2F78ff4b91-2b34-4678-85ae-19aaf1642e95.png" width="40" height="40" alt="Warren de Leon" /></a>
                  </div>
                  <div class="pl-3 flex-1">
                    <a href="/warrendeleon" class="crayons-link fw-bold">Warren de Leon</a>
                    
                    <p class="fs-xs color-base-60">
                        Posted on <time datetime="2026-07-20T10:32:17Z" class="date-no-year">Jul 20</time>


                        &bull; Originally published at <a style="color:#1395b8" href="https://warrendeleon.com/blog/server-state-and-client-state-react-native/">warrendeleon.com</a> 
                    </p>
                  </div>
                </div>
              </div>
      ...
      " href="/t/redux"><span class="crayons-tag__prefix">#</span>redux</a>
        ...
        --tag-bg-hover: rgba(64, 78, 211, 0.10);
        --tag-prefix-hover: #404ED3;
      " href="/t/reduxtoolkit"><span class="crayons-tag__prefix">#</span>reduxtoolkit</a>
                  </div>
            </div>
          </header>
          ...
          <div class="crayons-article__main ">
            ...
            <div class="crayons-article__body text-styles spec__body" data-article-id="4186912"
              id="article-body">
                <blockquote>
<p>📚 <strong>State Management</strong> series — <a href="https://warrendeleon.com/blog/series/state-management/" target="_blank" rel="noopener noreferrer">read it in full on warrendeleon.com</a>, where new parts land first.</p>
</blockquote>
...
<p>These two posts are a short break from the <a href="https://warrendeleon.com/blog/why-module-federation-react-native/?utm_source=devto&amp;utm_medium=crosspost&amp;utm_campaign=server-vs-client-state" target="_blank" rel="noopener noreferrer">Module Federation series</a>, because the federated work ahead leans on exactly this distinction. It is easier to get straight in one plain app first.</p>
...
<h2>
  <a name="two-kinds-of-state" href="#two-kinds-of-state">
  </a>
  Two kinds of state
</h2>
...
<p>Client state is the other half: data the app owns outright. The selected account, a sort order, a form draft, whether a modal is open, the auth tokens you hold after login (where you keep them safely is <a href="https://warrendeleon.com/blog/tiered-secure-storage-react-native/?utm_source=devto&amp;utm_medium=crosspost&amp;utm_campaign=server-vs-client-state" target="_blank" rel="noopener noreferrer">its own topic</a>), the user's theme and language. It has to be held, it has to be reactive, and once in a while it has to survive a restart. That is nearly the whole list. It cannot go stale, so it needs no caching; there is nothing to refetch, so it needs no background sync. The two are not degrees of the same thing. They have different jobs, and a library built for one is the wrong tool for the other.</p>

<h2>
  <a name="what-each-half-asks-for" href="#what-each-half-asks-for">
  </a>
...
<div class="highlight__panel-action js-fullscreen-code-action">
    ...
    <path d="M16 3h6v6h-2V5h-4V3zM2 3h6v2H4v4H2V3zm18 16v-4h2v6h-6v-2h4zM4 19h4v2H2v-6h2v