---
source_url: https://dev.to/nahamaalochi/understanding-nextjs-page-caching-with-a-real-example-10io
ingested: 2026-07-22
sha256: 2439d9e62847bad2b907a0ed42744efc29f2cc1b3b0331892b50454121b0df9c
...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Understanding Next.js Page Caching (with a real example) - DEV Community</title>
    
    <link rel="preload" href="/reactions?article_id=4099196" as="fetch" crossorigin="same-origin">
    <link rel="canonical" href="https://edgar.co.ke/writing/understanding-nextjs-page-caching-with-a-real-example" />
    <meta name="description" content="Caching can be a tricky topic, especially when pages don’t update the way you expect. I recently ran... Tagged with note, caching, frontend, typescript.">
    <meta name="keywords" content="note, caching, frontend, typescript, software, coding, development, engineering, inclusive, community">

    <meta property="og:type" content="article" />
    <meta property="og:url" content="https://dev.to/nahamaalochi/understanding-nextjs-page-caching-with-a-real-example-10io" />
    <meta property="og:title" content="Understanding Next.js Page Caching (with a real example)" />
    <meta property="og:description" content="Caching can be a tricky topic, especially when pages don’t update the way you expect. I recently ran..." />
    <meta property="og:site_name" content="DEV Community" />
    <meta name="twitter:site" content="@thepracticaldev">
    <meta name="twitter:creator" content="@NahamaAlochi">
    <meta name="author-trust" content="0">
    <meta name="twitter:title" content="Understanding Next.js Page Caching (with a real example)">
    <meta name="twitter:description" content="Caching can be a tricky topic, especially when pages don’t update the way you expect. I recently ran...">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:widgets:new-embed-design" content="on">
    <meta name="robots" content="max-snippet:-1, max-image-preview:large, max-video-preview:-1">
      <meta property="og:image" content="https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Faa8lttgyuhthw4q2z7xg.png" />
      <meta name="twitter:image:src" content="https://media2.dev.to/dynamic/image/width=1200,height=627,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Faa8lttgyuhthw4q2z7xg.png">

      <meta name="last-updated" content="2026-07-22 23:15:45 UTC">
      <meta name="user-signed-in" content="false">
      <meta name="head-cached-at" content="1784762145">
  ...
  <div class="crayons-header__container">
    <span class="inline-block m:hidden ">
      <button class="c-btn c-btn--icon-alone js-hamburger-trigger mx-2">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="aayhyvjy24zriq6ned0wyjzkq5xrxsfv" class="crayons-icon"><title id="aayhyvjy24zriq6ned0wyjzkq5xrxsfv">Navigation menu</title>
        ...
        <div class="crayons-fields crayons-fields--horizontal">
          <div class="crayons-field flex-1 relative">
            ...
            <button type="submit" aria-label="Search" class="c-btn c-btn--icon-alone absolute inset-px right-auto mt-0 py-0">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="aiz7v6di8oks47xl8pj9r590o2zt86op" aria-hidden="true" class="crayons-icon"><title id="aiz7v6di8oks47xl8pj9r590o2zt86op">Search</title>
    <path d="M18.031 16.617l4.283 4.282-1.415 1.415-4.282-4.283A8.96 8.96 0 0111 20c-4.968 0-9-4.032-9-9s4.032-9 9-9 9 4.032 9 9a8.96 8.96 0 01-1.969 5.617zm-2.006-.742A6.977 6.977 0 0018 11c0-3.868-3.133-7-7-7-3.868 0-7 3.132-7 7 0 3.867 3.132 7 7 7a6.977 6.977 0 004.875-1.975l.15-.15z"></path>
            ...
            <a class="crayons-header--search-brand-indicator" href="https://www.algolia.com/developers/?utm_source=devto&utm_medium=referral" target="_blank" rel="noopener noreferrer">
                Powered by Algolia
                <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" width="24" height="24" viewBox="0 0 500 500.34" role="img" aria-labelledby="a4w94c8bt27ba2zxf7h6rw387v6dc5tw" aria-hidden="true" class="crayons-icon"><title id="a4w94c8bt27ba2zxf7h6rw387v6dc5tw">Search</title>
  ...
  <div class="hamburger__content">
    <header class="hamburger__content__header">
      ...
      <button class="c-btn c-btn--icon-alone js-hamburger-trigger shrink-0" aria-label="Close">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" role="img" aria-labelledby="a3elyejakxcr0e9ds5xp4ox1r5r0kcy7" aria-hidden="true" class="crayons-icon c-btn__icon"><title id="a3elyejakxcr0e9ds5xp4ox1r5r0kcy7">Close</title><path d="M12 10.586l4.95-4.95 1.414 1.414-4.95 4.95 4.95 4.95-1.414 1.414-4.95-4.95-4.95 4.95-1.414-1.414 4.95-4.95-4.95-4.95L7.05 5.636l4.95 4.95z"></path></svg>
...
<div id="page-content" class="wrapper stories stories-show articletag-note articletag-caching articletag-frontend articletag-typescript articleuser-4017885" data-current-page="stories-show">
  <div id="page-content-inner" data-internal-nav="false" data-viewable-id="4099196" data-viewable-type="Article">
...
<script src="https://assets.dev.to/assets/commentDropdowns-7a28d130e5b78d38b30a9495a964003a66bd64fa455fc70b766d69cf06b9ba24.js" defer="defer"></script>
  ...
  <script type="application/ld+json">
    {"@context":"http://schema.org","@type":"Article","mainEntityOfPage":{"@type":"WebPage","@id":"https://dev.to/nahamaalochi/understanding-nextjs-page-caching-with-a-real-example-10io"},"url":"https://dev.to/nahamaalochi/understanding-nextjs-page-caching-with-a-real-example-10io","image":["https://media2.dev.to/dynamic/image/width=1080,height=1080,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Faa8lttgyuhthw4q2z7xg.png","https://media2.dev.to/dynamic/image/width=1280,height=720,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Faa8lttgyuhthw4q2z7xg.png","https://media2.dev.to/dynamic/image/width=1600,height=900,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Farticles%2Faa8lttgyuhthw4q2z7xg.png"],"publisher":{"@context":"http://schema.org","@type":"Organization","name":"DEV Community","logo":{"@context":"http://schema.org","@type":"ImageObject","url":"https://media2.dev.to/dynamic/image/width=192,height=,fit=scale-down,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.amazonaws.com%2Fuploads%2Farticles%2F8j7kvp660rqzt99zui8e.png","width":"192","height":"192"}},"headline":"Understanding Next.js Page Caching (with a real example)","author":{"@context":"http://schema.org","@type":"Person","url":"https://dev.to/nahamaalochi","name":"Edgar Nahama Alochi"},"datePublished":"2026-07-22T23:12:10Z","dateModified":"2026-07-22T23:13:02Z"}
  </script>
...
<button
  ...
  <path transform="translate(24,0) scale(-1,1)" d="M6 4H21C21.5523 4 22 4.44772 22 5V12H20V6H6V9L1 5L6 1V4ZM18 20H3C2.44772 20 2 19.5523 2 19V12H4V18H18V15L23 19L18 23V20Z"></path>
    ...
    <span data-testid="tooltip" class="crayons-tooltip__content">
      ...
      <div class="align-center m:relative">
        <button id="article-show-more-button" aria-controls="article-show-more-dropdown" aria-expanded="false" aria-haspopup="true" class="dropbtn crayons-btn crayons-btn--ghost-dimmed crayons-btn--icon-rounded" aria-label="Share post options">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" role="img" aria-labelledby="a6rdqxgcawfzuwsf0cglsjes03ggp188" aria-hidden="true" class="crayons-icon dropdown-icon"><title id="a6rdqxgcawfzuwsf0cglsjes03ggp188">More...</title><path fill-rule="evenodd" clip-rule="evenodd" d="M7 12a2 2 0 11-4 0 2 2 0 014 0zm7 0a2 2 0 11-4 0 2 2 0 014 0zm5 2a2 2 0 100-4 2 2 0 000 4z"></path></svg>
        ...
        <div id="article-show-more-dropdown" class="crayons-dropdown side-bar left-2 right-2 m:right-auto m:left-100 s:left-auto mb-1 m:mb-0 top-unset bottom-100 m:top-0 m:bottom-unset">
          <div>
            <button
              ...
              data-postUrl="https://dev.to/nahamaalochi/understanding-nextjs-page-caching-with-a-real-example-10io">
              <span class="fw-bold">Copy link</span>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" id="article-copy-icon" role="img" aria-labelledby="a13tkkpq81uhqw2bcjvs857oza17v0s6" aria-hidden="true" class="crayons-icon mx-2 shrink-0"><title id="a13tkkpq81uhqw2bcjvs857oza17v0s6">Copy link</title>
    <path d="M7 6V3a1 1 0 011-1h12a1 1 0 011 1v14a1 1 0 01-1 1h-3v3c0 .552-.45 1-1.007 1H4.007A1 1 0 013 21l.003-14c0-.552.45-1 1.007-1H7zm2 0h8v10h2V4H9v2zm-2 5v2h6v-2H7zm0 4v2h6v-2H7z"></path>
          ...
          <div class="Desktop-only">
            <a
              ...
              rel="noopener"
              href='https://twitter.com/intent/tweet?text=%22Understanding%20Next.js%20Page%20Caching%20%28with%20a%20real%20example%29%22%20by%20%40NahamaAlochi%20%23DEVCommunity%20https%3A%2F%2Fdev.to%2Fnahamaalochi%2Funderstanding-nextjs-page-caching-with-a-real-example-10io'>
              Share to X
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Fdev.to%2Fnahamaalochi%2Funderstanding-nextjs-page-caching-with-a-real-example-10io&title=Understanding%20Next.js%20Page%20Caching%20%28with%20a%20real%20example%29&summary=Caching%20can%20be%20a%20tricky%20topic%2C%20especially%20when%20pages%20don%E2%80%99t%20update%20the%20way%20you%20expect.%20I%20recently%20ran...&source=DEV%20Community">
              Share to LinkedIn
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://www.facebook.com/sharer.php?u=https%3A%2F%2Fdev.to%2Fnahamaalochi%2Funderstanding-nextjs-page-caching-with-a-real-example-10io">
              Share to Facebook
            </a>
            <a
              target="_blank"
              class="crayons-link crayons-link--block"
              rel="noopener"
              href="https://s2f.kytta.dev/?text=https%3A%2F%2Fdev.to%2Fnahamaalochi%2Funderstanding-nextjs-page-caching-with-a-real-example-10io">
              Share to Mastodon
            </a>
          </div>

          <web-share-wrapper shareurl="https://dev.to/nahamaalochi/understanding-nextjs-page-caching-with-a-real-example-10io" sharetitle="Understanding Next.js Page Caching (with a real example)" sharetext="Caching can be a tricky topic, especially when pages don’t update the way you expect. I recently ran..." template="web-share-button">
          </web-share-wrapper>
    ...
    <main id="main-content" class="crayons-layout__content grid gap-4">
      <div class="article-wrapper">
        ...
        <article class="crayons-card crayons-article mb-4"
          ...
          data-article-id="4099196"
          data-article-slug="understanding-nextjs-page-caching-with-a-real-example-10io"
          data-author-id="4017885"
          data-author-name="Edgar Nahama Alochi"
          data-author-username="nahamaalochi"
          data-co-author-ids=""
          data-path="/nahamaalochi/understanding-nextjs-page-caching-with-a-real-example-10io"
            ...
            <div class="crayons-article__header__meta">
              <div class="flex s:items-start flex-col s:flex-row">
                ...
                <div class="flex flex-1 mb-5 items-start">
                  <div class="relative">
                      <a href="/nahamaalochi"><img class="radius-full align-middle" src="https://media2.dev.to/dynamic/image/width=50,height=50,fit=cover,gravity=auto,format=auto/https%3A%2F%2Fdev-to-uploads.s3.us-east-2.amazonaws.com%2Fuploads%2Fuser%2Fprofile_image%2F4017885%2F79abbb49-c4c8-4a4c-96ca-82feca0d1ffd.jpg" width="40" height="40" alt="Edgar Nahama Alochi" /></a>
                  </div>
                  <div class="pl-3 flex-1">
                    <a href="/nahamaalochi" class="crayons-link fw-bold">Edgar Nahama Alochi</a>
                    
                    <p class="fs-xs color-base-60">
                        Posted on <time datetime="2026-07-22T23:12:10Z" class="date-no-year">Jul 22</time>


                        &bull; Originally published at <a style="color:#1395b8" href="https://edgar.co.ke/writing/understanding-nextjs-page-caching-with-a-real-example">edgar.co.ke</a> on <time datetime="2026-07-22T23:12:10Z" class="date-no-year">Jul 22</time>
                    </p>
                  </div>
                </div>
              </div>
    ...
    ><span class="crayons-reaction__icon crayons-reaction__icon--inactive p-1"><img src="https://assets.dev.to/assets/fire-f60e7a582391810302117f987b22a8ef04a2fe0df7e3258a5f49332df1cec71e.svg" width="24" height="24" /></span>
      ...
      " href="/t/note"><span class="crayons-tag__prefix">#</span>note</a>
                      <a class="crayons-tag   " style="
        --tag-bg: rgba(64, 78, 211, 0.10);
        --tag-prefix: #404ED3;
        --tag-bg-hover: rgba(64, 78, 211, 0.10);
        --tag-prefix-hover: #404ED3;
      " href="/t/caching"><span class="crayons-tag__prefix">#</span>caching</a>
                      <a class="crayons-tag   " style="
      ...
      " href="/t/typescript"><span class="crayons-tag__prefix">#</span>typescript</a>
          ...
          <div class="crayons-article__main ">
            <div class="crayons-article__body text-styles spec__body" data-article-id="4099196"
              id="article-body">
                <p>Caching can be a tricky topic, especially when pages don’t update the way you expect.<br>
...
<h3>
  <a name="how-nextjs-caching-works" href="#how-nextjs-caching-works">
  </a>
...
<h3>
  <a name="how-to-control-caching" href="#how-to-control-caching">
  </a>
