...
ingested: 2026-07-10
sha256: 1094a252843f9b20c740e9bd9fbc07efaa8dd83f0f50abe28d05636f917d3da8
...
<head><script>document.documentElement.classList.add('js');</script>  <title>[2607.07846] VectorizationLLM: Smart Vectorization Based AI Assistant</title>
...
<meta name="twitter:image:alt" content="arXiv logo"/>
  ...
  <script src="/static/browse/0.3.4/js/cite.js" type="text/javascript"></script><meta name="citation_title" content="VectorizationLLM: Smart Vectorization Based AI Assistant" /><meta name="citation_author" content="Duke, Ryan" /><meta name="citation_date" content="2026/07/08" /><meta name="citation_online_date" content="2026/07/08" /><meta name="citation_pdf_url" content="https://arxiv.org/pdf/2607.07846" /><meta name="citation_arxiv_id" content="2607.07846" /><meta name="citation_abstract" content="VectorizationLLM is a specialized Large Language Model based on Google open-weight LLMs. The model is designed to assist students to learn smart vectorization, time/wave vector analysis, piecewise functions, Fourier analysis, and differential equations in MATLAB. The course application is CTEC 247: Applied Computational Analysis II by the Department of Electrical &amp; Computer Engineering Technology at New York Institute of Technology Old Westbury. The LLM model is designed to be an instructive assistant, providing detailed explanations of concepts with examples from in-class notes without providing direct answers to questions. The model is designed with a RAG (Retrieval Augmented Generation) knowledge base and system prompt architecture. Examples in both code, text, and images are provided in the LLM responses." />
</head>
...
rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
    ...
    <rdf:Description
        rdf:about="/abs/2607.07846"
        dc:identifier="/abs/2607.07846"
        dc:title="VectorizationLLM: Smart Vectorization Based AI Assistant"
        trackback:ping="/trackback/2607.07846" />
    </rdf:RDF>
--><div id="abs-outer">
  ...
  <div class="leftcolumn">
    ...
    <div class="header-breadcrumbs-mobile">
      <strong>arXiv:2607.07846</strong> (cs)
    </div>
...
<div id="content-inner">
  ...
  [Submitted on 8 Jul 2026]</div>
    <h1 class="title mathjax"><span class="descriptor">Title:</span>VectorizationLLM: Smart Vectorization Based AI Assistant</h1>
    <div class="authors"><span class="descriptor">Authors:</span><a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Duke,+R" rel="nofollow">Ryan Duke</a></div>            <div id="download-button-info" hidden>View a PDF of the paper titled VectorizationLLM: Smart Vectorization Based AI Assistant, by Ryan Duke</div>
    <a class="mobile-submission-download" href="/pdf/2607.07846">View PDF</a>
    <a class="mobile-submission-download" href="https://arxiv.org/html/2607.07846v1">HTML (experimental)</a>



    <blockquote class="abstract mathjax">
            <span class="descriptor">Abstract:</span>VectorizationLLM is a specialized Large Language Model based on Google open-weight LLMs. The model is designed to assist students to learn smart vectorization, time/wave vector analysis, piecewise functions, Fourier analysis, and differential equations in MATLAB. The course application is CTEC 247: Applied Computational Analysis II by the Department of Electrical &amp; Computer Engineering Technology at New York Institute of Technology Old Westbury. The LLM model is designed to be an instructive assistant, providing detailed explanations of concepts with examples from in-class notes without providing direct answers to questions. The model is designed with a RAG (Retrieval Augmented Generation) knowledge base and system prompt architecture. Examples in both code, text, and images are provided in the LLM responses.
    </blockquote>
    ...
    <div class="metatable">
      <table summary="Additional metadata">        <tr>
          ...
          <td class="tablecell comments mathjax">44 pages, 6 figures</td>
        </tr>
<tr>
          <td class="tablecell label">Subjects:</td>
          <td class="tablecell subjects">
            <span class="primary-subject">Artificial Intelligence (cs.AI)</span>; Computers and Society (cs.CY)</td>
        </tr><tr>
          <td class="tablecell label">Cite as:</td>
          <td class="tablecell arxivid"><span class="arxivid"><a href="https://arxiv.org/abs/2607.07846">arXiv:2607.07846</a> [cs.AI]</span></td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxividv">(or <span class="arxivid">
              <a href="https://arxiv.org/abs/2607.07846v1">arXiv:2607.07846v1</a> [cs.AI]</span> for this version)
          </td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxivdoi">              <a href="https://doi.org/10.48550/arXiv.2607.07846"  id="arxiv-doi-link">https://doi.org/10.48550/arXiv.2607.07846</a><div class="button-and-tooltip">
    ...
    <div class="submission-history">
      <h2>Submission history</h2> From: Ryan Duke [<a href="/show-email/292e0c3b/2607.07846" rel="nofollow">view email</a>]      <br/>    <strong>[v1]</strong>
        Wed, 8 Jul 2026 18:27:39 UTC (4,584 KB)<br/>
</div>
  </div>
  <!--end leftcolumn-->
...
View a PDF of the paper titled VectorizationLLM: Smart Vectorization Based AI Assistant, by Ryan Duke</div><li><a href="/pdf/2607.07846" aria-describedby="download-button-info" accesskey="f" class="abs-button download-pdf">View PDF</a></li><li><a href="https://arxiv.org/html/2607.07846v1" class="abs-button" id="latexml-download-link">HTML (experimental)</a></li><li><a href="/src/2607.07846" class="abs-button download-eprint">TeX Source
 </a></li></ul>
  ...
  <div class="prevnext">
<span class="arrow">
      <a class="abs-button prev-url" href="/prevnext?id=2607.07846&amp;function=prev&amp;context=cs.AI"
         accesskey="p" title="previous in cs.AI (accesskey p)" rel="nofollow">&lt;&nbsp;prev</a>
    </span>
    <span class="is-hidden-mobile">&nbsp; | &nbsp;</span>    <span class="arrow">
      <a class="abs-button next-url" href="/prevnext?id=2607.07846&amp;function=next&amp;context=cs.AI" accesskey="n"
    ...
    <div class="switch context-change">
        <a href="/abs/2607.07846?context=cs" rel="nofollow">cs</a><br class="is-hidden-mobile">
        <a class="subclass" href="/abs/2607.07846?context=cs.CY" rel="nofollow">cs.CY</a><br class="is-hidden-mobile">
    </div>
  </div>
      ...
      <div class="extra-ref-cite">
        ...
        <ul>
          <li><a  class="abs-button abs-button-small cite-ads" href="https://ui.adsabs.harvard.edu/abs/arXiv:2607.07846">NASA ADS</a></li><li><a  class="abs-button abs-button-small cite-google-scholar" href="https://scholar.google.com/scholar_lookup?arxiv_id=2607.07846" target="_blank" rel="noopener">Google Scholar</a></li>
          <li><a  class="abs-button abs-button-small cite-semantic-scholar" href="https://api.semanticscholar.org/arXiv:2607.07846" target="_blank" rel="noopener">Semantic Scholar</a></li>
        </ul>
...
<div id='bib-cite-modal' class='bib-modal' hidden='true'>
  ...
  <div><h3>Bookmark</h3></div><a class="abs-button abs-button-grey abs-button-small" href="http://www.bibsonomy.org/BibtexHandler?requTask=upload&amp;url=https://arxiv.org/abs/2607.07846&amp;description=VectorizationLLM: Smart Vectorization Based AI Assistant"
     title="Bookmark on BibSonomy">
    <img src="/static/browse/0.3.4/images/icons/social/bibsonomy.png"
         alt="BibSonomy"/>
  </a>
  <a class="abs-button abs-button-grey abs-button-small" href="https://reddit.com/submit?url=https://arxiv.org/abs/2607.07846&amp;title=VectorizationLLM: Smart Vectorization Based AI Assistant"
...
<!-- END LABS AREA -->
  <div class="endorsers">
    <a href="/auth/show-endorsers/2607.07846" class="endorser-who" rel="nofollow">Which authors of this paper are endorsers?</a> |
