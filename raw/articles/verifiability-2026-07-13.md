...
<head>
  ...
  <title>Verifiability – karpathy</title>
  <link rel="canonical" href="https://karpathy.bearblog.dev/verifiability/">
  
    

    <meta name="karpathy" content="look-for-the-bear-necessities">
    <meta name="token" content="SWppQLjtBBSNMproogtK">

    
<!-- Primary Meta Tags -->
<meta name="title" content="Verifiability">
<meta name="description" content="The impact of verifiability on the jagged frontier of LLMs">

<!-- Open Graph / Facebook -->
<meta property="og:site_name" content="karpathy">
<meta property="og:title" content="Verifiability">
<meta property="og:type" content="article">
<meta property="og:url" content="https://karpathy.bearblog.dev/verifiability/">
<meta property="og:description" content="The impact of verifiability on the jagged frontier of LLMs">
<meta property="og:image" content="/static/og-image.png">


<!-- Twitter -->
<meta property="twitter:card" content="summary">
<meta property="twitter:url" content="https://karpathy.bearblog.dev/verifiability/">
<meta property="twitter:title" content="Verifiability">
<meta property="twitter:description" content="The impact of verifiability on the jagged frontier of LLMs">
...
<script type="application/ld+json">
  {
    ...
    "description": "The impact of verifiability on the jagged frontier of LLMs",
...
<body class="post " onload="(function() { document.cookie = `timezone=${Intl.DateTimeFormat().resolvedOptions().timeZone};path=/`; })()">
  ...
  <main>
        ...
        <p>
            <i>
                <time datetime="2025-11-17T17:00Z">
    17 Nov, 2025
</time>
            </i>
        </p>
...
<li>Software 2.0 easily automates what you can verify.</li>
    ...
    <small>
        <input hidden name="uid" value="SWppQLjtBBSNMproogtK" style="display:none">
        <input hidden name="title" value="Verifiability" style="display:none">
...
<script>
    ...
    fetch('/upvote-info/SWppQLjtBBSNMproogtK/').then(response => response.json()).then(data => {
