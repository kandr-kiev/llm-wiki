...
ingested: 2026-07-07
sha256: efc68928086e282850343147efee1d99e25d9c2fe88f3a3552633687bf4fb8ab
...
<head><script>document.documentElement.classList.add('js');</script>  <title>[2607.02931] VERITAS: Towards a General-Purpose Replication Tool for Scientific Research</title>
...
<meta name="twitter:image:alt" content="arXiv logo"/>
  ...
  <script src="/static/browse/0.3.4/js/cite.js" type="text/javascript"></script><meta name="citation_title" content="VERITAS: Towards a General-Purpose Replication Tool for Scientific Research" /><meta name="citation_author" content="Liu, Haokun" /><meta name="citation_author" content="Tjiaranata, Filbert Aurelian" /><meta name="citation_author" content="Tan, Chenhao" /><meta name="citation_date" content="2026/07/03" /><meta name="citation_online_date" content="2026/07/03" /><meta name="citation_pdf_url" content="https://arxiv.org/pdf/2607.02931" /><meta name="citation_arxiv_id" content="2607.02931" /><meta name="citation_abstract" content="AI tools are accelerating scientific publication while the systems that review it struggle to keep up, and independent verification of published research has become both harder and more important. As manual replication is slow and expensive, a growing line of work uses coding agents to automate parts of the process. Existing efforts are largely packaged as benchmarks with companion agents that only run inside the benchmark&#39;s own pipeline, and no general-purpose replication tool exists. We present VERITAS, a domain-agnostic replication framework built around CLI coding agents. Given a paper, a code repository, or both, VERITAS extracts the paper&#39;s claims, runs the methodology while resolving issues as they arise, and judges each claim against the evidence from experiment runs. The pipeline returns an importance-weighted Replication Score, a severity-rated log of every fix applied, and the patched codebase. We evaluate VERITAS on CORE-Bench and ReplicationBench, 65 papers spanning computer science, social science, medicine, and astrophysics. Against two strong Claude Code baselines on the same model and host environment, VERITAS achieves state-of-the-art performance and leads on every metric on both benchmarks." />
</head>
...
rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
    ...
    <rdf:Description
        rdf:about="/abs/2607.02931"
        dc:identifier="/abs/2607.02931"
        dc:title="VERITAS: Towards a General-Purpose Replication Tool for Scientific Research"
        trackback:ping="/trackback/2607.02931" />
    </rdf:RDF>
--><div id="abs-outer">
  ...
  <div class="leftcolumn">
    ...
    <div class="header-breadcrumbs-mobile">
      <strong>arXiv:2607.02931</strong> (cs)
    </div>
...
<div id="content-inner">
  ...
  [Submitted on 3 Jul 2026]</div>
    <h1 class="title mathjax"><span class="descriptor">Title:</span>VERITAS: Towards a General-Purpose Replication Tool for Scientific Research</h1>
    <div class="authors"><span class="descriptor">Authors:</span><a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Liu,+H" rel="nofollow">Haokun Liu</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Tjiaranata,+F+A" rel="nofollow">Filbert Aurelian Tjiaranata</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Tan,+C" rel="nofollow">Chenhao Tan</a></div>            <div id="download-button-info" hidden>View a PDF of the paper titled VERITAS: Towards a General-Purpose Replication Tool for Scientific Research, by Haokun Liu and 2 other authors</div>
    <a class="mobile-submission-download" href="/pdf/2607.02931">View PDF</a>
    <a class="mobile-submission-download" href="https://arxiv.org/html/2607.02931v1">HTML (experimental)</a>



    <blockquote class="abstract mathjax">
            <span class="descriptor">Abstract:</span>AI tools are accelerating scientific publication while the systems that review it struggle to keep up, and independent verification of published research has become both harder and more important. As manual replication is slow and expensive, a growing line of work uses coding agents to automate parts of the process. Existing efforts are largely packaged as benchmarks with companion agents that only run inside the benchmark&#39;s own pipeline, and no general-purpose replication tool exists. We present VERITAS, a domain-agnostic replication framework built around CLI coding agents. Given a paper, a code repository, or both, VERITAS extracts the paper&#39;s claims, runs the methodology while resolving issues as they arise, and judges each claim against the evidence from experiment runs. The pipeline returns an importance-weighted Replication Score, a severity-rated log of every fix applied, and the patched codebase. We evaluate VERITAS on CORE-Bench and ReplicationBench, 65 papers spanning computer science, social science, medicine, and astrophysics. Against two strong Claude Code baselines on the same model and host environment, VERITAS achieves state-of-the-art performance and leads on every metric on both benchmarks.
    </blockquote>
    ...
    <div class="metatable">
      <table summary="Additional metadata">        <tr>
          ...
          <td class="tablecell comments mathjax">21 pages, 2 figures, 8 tables</td>
        </tr>
<tr>
          ...
          <td class="tablecell arxivid"><span class="arxivid"><a href="https://arxiv.org/abs/2607.02931">arXiv:2607.02931</a> [cs.AI]</span></td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxividv">(or <span class="arxivid">
              <a href="https://arxiv.org/abs/2607.02931v1">arXiv:2607.02931v1</a> [cs.AI]</span> for this version)
          </td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxivdoi">              <a href="https://doi.org/10.48550/arXiv.2607.02931" id="arxiv-doi-link">https://doi.org/10.48550/arXiv.2607.02931</a><div class="button-and-tooltip">
    ...
    <div class="submission-history">
      <h2>Submission history</h2> From: Haokun Liu [<a href="/show-email/e87b822e/2607.02931" rel="nofollow">view email</a>]      <br/>    <strong>[v1]</strong>
        Fri, 3 Jul 2026 03:55:59 UTC (92 KB)<br/>
</div>
  </div>
  <!--end leftcolumn-->
...
View a PDF of the paper titled VERITAS: Towards a General-Purpose Replication Tool for Scientific Research, by Haokun Liu and 2 other authors</div><li><a href="/pdf/2607.02931" aria-describedby="download-button-info" accesskey="f" class="abs-button download-pdf">View PDF</a></li><li><a href="https://arxiv.org/html/2607.02931v1" class="abs-button" id="latexml-download-link">HTML (experimental)</a></li><li><a href="/src/2607.02931" class="abs-button download-eprint">TeX Source
 </a></li></ul>
  ...
  <div class="prevnext">
<span class="arrow">
      <a class="abs-button prev-url" href="/prevnext?id=2607.02931&amp;function=prev&amp;context=cs.AI"
         accesskey="p" title="previous in cs.AI (accesskey p)" rel="nofollow">&lt;&nbsp;prev</a>
    </span>
    <span class="is-hidden-mobile">&nbsp; | &nbsp;</span>    <span class="arrow">
      <a class="abs-button next-url" href="/prevnext?id=2607.02931&amp;function=next&amp;context=cs.AI" accesskey="n"
    ...
    <div class="switch context-change">
        <a href="/abs/2607.02931?context=cs" rel="nofollow">cs</a><br class="is-hidden-mobile">
    </div>
  </div>
      ...
      <div class="extra-ref-cite">
        ...
        <ul>
          <li><a  class="abs-button abs-button-small cite-ads" href="https://ui.adsabs.harvard.edu/abs/arXiv:2607.02931">NASA ADS</a></li><li><a  class="abs-button abs-button-small cite-google-scholar" href="https://scholar.google.com/scholar_lookup?arxiv_id=2607.02931" target="_blank" rel="noopener">Google Scholar</a></li>
          <li><a  class="abs-button abs-button-small cite-semantic-scholar" href="https://api.semanticscholar.org/arXiv:2607.02931" target="_blank" rel="noopener">Semantic Scholar</a></li>
        </ul>
...
<div id='bib-cite-modal' class='bib-modal' hidden='true'>
  ...
  <div><h3>Bookmark</h3></div><a class="abs-button abs-button-grey abs-button-small" href="http://www.bibsonomy.org/BibtexHandler?requTask=upload&amp;url=https://arxiv.org/abs/2607.02931&amp;description=VERITAS: Towards a General-Purpose Replication Tool for Scientific Research"
     title="Bookmark on BibSonomy">
    <img src="/static/browse/0.3.4/images/icons/social/bibsonomy.png"
         alt="BibSonomy"/>
  </a>
  <a class="abs-button abs-button-grey abs-button-small" href="https://reddit.com/submit?url=https://arxiv.org/abs/2607.02931&amp;title=VERITAS: Towards a General-Purpose Replication Tool for Scientific Research"
...
<!-- END LABS AREA -->
  <div class="endorsers">
    <a href="/auth/show-endorsers/2607.02931" class="endorser-who" rel="nofollow">Which authors of this paper are endorsers?</a> |
