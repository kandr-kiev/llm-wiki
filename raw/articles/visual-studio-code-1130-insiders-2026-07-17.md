...
ingested: 2026-07-17
sha256: 3b57e466d003debd17b431660603ee20af680e944baf5f9501452cc3c4911ba0
...
<head>
	...
	<meta name="description" content="Learn what's new in Visual Studio Code 1.130 (Insiders)" />
<meta name="keywords" content="" />
<!-- Twitter and Facebook OpenGraph Metadata-->
<meta name="twitter:card" content="summary_large_image" />
<meta property="og:url" content="https://code.visualstudio.com/updates/v1_130" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Visual Studio Code 1.130 (Insiders)" />
<meta property="og:description" content="Learn what's new in Visual Studio Code 1.130 (Insiders)" />

<meta property="og:image" content="https://code.visualstudio.com/assets/updates/1_130/release-highlights.webp" />
	...
	<title>Visual Studio Code 1.130 (Insiders)</title>
    ...
    <div class="docs-layout-wrapper">
        ...
        <aside class="docs-left-sidebar">
            <nav id="docs-navbar" aria-label="Updates" class="docs-nav updates-nav visible-md visible-lg">
            	...
            	<ul class="nav">
            			...
            			<li class="active">
            				<a href="/updates/v1_130" aria-label="Current Page: Insiders">Insiders</a>
            			</li>
            ...
            <nav id="small-nav" aria-label="Updates" class="docs-nav updates-nav hidden-md hidden-lg">
            	...
            	<select id="small-nav-dropdown" aria-label="updates">
            			...
            			<option value="/updates/v1_130" selected>Insiders</option>
        ...
        <div class="docs-content-wrapper">
            ...
            <main class="docs-main-content body">
                <h1>Visual Studio Code 1.130 (Insiders)</h1>
...
<p>Welcome to the 1.130 Insiders release of Visual Studio Code.</p>
<p>These release notes cover the Insiders build of VS Code and continue to evolve as new features are added.</p>
<p>You can still track our progress in the <a href="https://github.com/Microsoft/vscode/commits/main" class="external-link" target="_blank">Commit log</a> and our list of <a href="https://github.com/Microsoft/vscode/issues?q=is%3Aissue%20is%3Aclosed%20milestone%3A1.130.0" class="external-link" target="_blank">Closed issues</a>.</p>
<p>Happy Coding!</p>
<hr>
<!-- TOC
...
Navigation End -->
<h2 id="_july-14-2026" data-needslink="_july-14-2026">July 14, 2026</h2>
<ul>
...
<p><a id="scroll-to-top" role="button" title="Scroll to top" aria-label="scroll to top" href="#"><span class="icon"></span></a></p>
                ...
                <div class="feedback" data-edit-url="https://vscode.dev/github/microsoft/vscode-docs/blob/main/release-notes/v1_130.md"></div>
            </main>
            ...
            <aside class="docs-right-sidebar hidden-xs">
                <nav id="docs-subnavbar" aria-label="On Page">
                    ...
                    <ul class="nav">
                        ...
                        <li><a href="#_july-14-2026">July 14, 2026</a></li>
