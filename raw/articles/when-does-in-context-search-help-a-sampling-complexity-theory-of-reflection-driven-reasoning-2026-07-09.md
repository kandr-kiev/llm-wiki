...
ingested: 2026-07-09
sha256: 523be20b8b14fbf9923e09e5f247a6d1d29f3f54e9f6e41856d72017a885bdc0
...
<head><script>document.documentElement.classList.add('js');</script>  <title>[2607.06720] When Does In-Context Search Help? A Sampling-Complexity Theory of Reflection-Driven Reasoning</title>
...
<meta name="twitter:image:alt" content="arXiv logo"/>
  ...
  <script src="/static/browse/0.3.4/js/cite.js" type="text/javascript"></script><meta name="citation_title" content="When Does In-Context Search Help? A Sampling-Complexity Theory of Reflection-Driven Reasoning" /><meta name="citation_author" content="Wolf, Yotam" /><meta name="citation_author" content="Wies, Noam" /><meta name="citation_author" content="Shashua, Amnon" /><meta name="citation_date" content="2026/07/07" /><meta name="citation_online_date" content="2026/07/07" /><meta name="citation_pdf_url" content="https://arxiv.org/pdf/2607.06720" /><meta name="citation_arxiv_id" content="2607.06720" /><meta name="citation_abstract" content="Training large language models (LLMs) with extended reasoning has enabled in-context search, in which models iteratively generate, critique, and revise solution attempts. We provide a theoretical analysis of in-context search by modeling it as approximate inference over reasoning traces, where the base model defines a prior and self-reflection provides feedback for posterior updates, and study the resulting inference-time sampling complexity - the number of sequential attempts needed to achieve high success probability. We show that when reflections reliably localize early mistakes, in-context search can yield exponential improvements over the base model, solving problems with exponentially small zero-shot pass rates using only a polynomial number of sequential attempts, whereas when this property fails, conditioning on past attempts offers no asymptotic benefit over parallel sampling. We further show that these gains are robust and learnable: approximate posterior updates suffice, and cross-entropy training on search rollouts recovers the required behavior with polynomial sample complexity. Finally, we show that under a stagewise abstraction of reinforcement learning with verifiable rewards, the optimal policy extension implements the same posterior reweighting rule. We validate key qualitative predictions of the theory on real large reasoning models." />
</head>
...
rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
    ...
    <rdf:Description
        rdf:about="/abs/2607.06720"
        dc:identifier="/abs/2607.06720"
        dc:title="When Does In-Context Search Help? A Sampling-Complexity Theory of Reflection-Driven Reasoning"
        trackback:ping="/trackback/2607.06720" />
    </rdf:RDF>
--><div id="abs-outer">
  ...
  <div class="leftcolumn">
    ...
    <div class="header-breadcrumbs-mobile">
      <strong>arXiv:2607.06720</strong> (cs)
    </div>
...
<div id="content-inner">
  ...
  [Submitted on 7 Jul 2026]</div>
    <h1 class="title mathjax"><span class="descriptor">Title:</span>When Does In-Context Search Help? A Sampling-Complexity Theory of Reflection-Driven Reasoning</h1>
    <div class="authors"><span class="descriptor">Authors:</span><a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Wolf,+Y" rel="nofollow">Yotam Wolf</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Wies,+N" rel="nofollow">Noam Wies</a>, <a href="https://arxiv.org/search/cs?searchtype=author&amp;query=Shashua,+A" rel="nofollow">Amnon Shashua</a></div>            <div id="download-button-info" hidden>View a PDF of the paper titled When Does In-Context Search Help? A Sampling-Complexity Theory of Reflection-Driven Reasoning, by Yotam Wolf and 2 other authors</div>
    <a class="mobile-submission-download" href="/pdf/2607.06720">View PDF</a>
    <a class="mobile-submission-download" href="https://arxiv.org/html/2607.06720v1">HTML (experimental)</a>



    <blockquote class="abstract mathjax">
            <span class="descriptor">Abstract:</span>Training large language models (LLMs) with extended reasoning has enabled in-context search, in which models iteratively generate, critique, and revise solution attempts. We provide a theoretical analysis of in-context search by modeling it as approximate inference over reasoning traces, where the base model defines a prior and self-reflection provides feedback for posterior updates, and study the resulting inference-time sampling complexity - the number of sequential attempts needed to achieve high success probability. We show that when reflections reliably localize early mistakes, in-context search can yield exponential improvements over the base model, solving problems with exponentially small zero-shot pass rates using only a polynomial number of sequential attempts, whereas when this property fails, conditioning on past attempts offers no asymptotic benefit over parallel sampling. We further show that these gains are robust and learnable: approximate posterior updates suffice, and cross-entropy training on search rollouts recovers the required behavior with polynomial sample complexity. Finally, we show that under a stagewise abstraction of reinforcement learning with verifiable rewards, the optimal policy extension implements the same posterior reweighting rule. We validate key qualitative predictions of the theory on real large reasoning models.
    </blockquote>
    ...
    <div class="metatable">
      <table summary="Additional metadata"><tr>
          ...
          <td class="tablecell arxivid"><span class="arxivid"><a href="https://arxiv.org/abs/2607.06720">arXiv:2607.06720</a> [cs.AI]</span></td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxividv">(or <span class="arxivid">
              <a href="https://arxiv.org/abs/2607.06720v1">arXiv:2607.06720v1</a> [cs.AI]</span> for this version)
          </td>
        </tr>
        <tr>
          <td class="tablecell label">&nbsp;</td>
          <td class="tablecell arxivdoi">              <a href="https://doi.org/10.48550/arXiv.2607.06720" id="arxiv-doi-link">https://doi.org/10.48550/arXiv.2607.06720</a><div class="button-and-tooltip">
    ...
    <div class="submission-history">
      <h2>Submission history</h2> From: Yotam Wolf [<a href="/show-email/95f4a2ae/2607.06720" rel="nofollow">view email</a>]      <br/>    <strong>[v1]</strong>
        Tue, 7 Jul 2026 18:36:04 UTC (746 KB)<br/>
</div>
  </div>
  <!--end leftcolumn-->
...
View a PDF of the paper titled When Does In-Context Search Help? A Sampling-Complexity Theory of Reflection-Driven Reasoning, by Yotam Wolf and 2 other authors</div><li><a href="/pdf/2607.06720" aria-describedby="download-button-info" accesskey="f" class="abs-button download-pdf">View PDF</a></li><li><a href="https://arxiv.org/html/2607.06720v1" class="abs-button" id="latexml-download-link">HTML (experimental)</a></li><li><a href="/src/2607.06720" class="abs-button download-eprint">TeX Source
 </a></li></ul>
  ...
  <div class="prevnext">
<span class="arrow">
      <a class="abs-button prev-url" href="/prevnext?id=2607.06720&amp;function=prev&amp;context=cs.AI"
         accesskey="p" title="previous in cs.AI (accesskey p)" rel="nofollow">&lt;&nbsp;prev</a>
    </span>
    <span class="is-hidden-mobile">&nbsp; | &nbsp;</span>    <span class="arrow">
      <a class="abs-button next-url" href="/prevnext?id=2607.06720&amp;function=next&amp;context=cs.AI" accesskey="n"
    ...
    <div class="switch context-change">
        <a href="/abs/2607.06720?context=cs" rel="nofollow">cs</a><br class="is-hidden-mobile">
        <a class="subclass" href="/abs/2607.06720?context=cs.CL" rel="nofollow">cs.CL</a><br class="is-hidden-mobile">
    </div>
  </div>
      ...
      <div class="extra-ref-cite">
        ...
        <ul>
          <li><a  class="abs-button abs-button-small cite-ads" href="https://ui.adsabs.harvard.edu/abs/arXiv:2607.06720">NASA ADS</a></li><li><a  class="abs-button abs-button-small cite-google-scholar" href="https://scholar.google.com/scholar_lookup?arxiv_id=2607.06720" target="_blank" rel="noopener">Google Scholar</a></li>
          <li><a  class="abs-button abs-button-small cite-semantic-scholar" href="https://api.semanticscholar.org/arXiv:2607.06720" target="_blank" rel="noopener">Semantic Scholar</a></li>
        </ul>
...
<div id='bib-cite-modal' class='bib-modal' hidden='true'>
  ...
  <div><h3>Bookmark</h3></div><a class="abs-button abs-button-grey abs-button-small" href="http://www.bibsonomy.org/BibtexHandler?requTask=upload&amp;url=https://arxiv.org/abs/2607.06720&amp;description=When Does In-Context Search Help? A Sampling-Complexity Theory of Reflection-Driven Reasoning"
     title="Bookmark on BibSonomy">
    <img src="/static/browse/0.3.4/images/icons/social/bibsonomy.png"
         alt="BibSonomy"/>
  </a>
  <a class="abs-button abs-button-grey abs-button-small" href="https://reddit.com/submit?url=https://arxiv.org/abs/2607.06720&amp;title=When Does In-Context Search Help? A Sampling-Complexity Theory of Reflection-Driven Reasoning"
...
<!-- END LABS AREA -->
  <div class="endorsers">
    <a href="/auth/show-endorsers/2607.06720" class="endorser-who" rel="nofollow">Which authors of this paper are endorsers?</a> |
