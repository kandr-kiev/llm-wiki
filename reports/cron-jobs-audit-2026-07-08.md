...
- **Ризик:** Monitors можуть записувати в raw/ одночасно з тим, як Integrator читає з raw/
...
2. **[P1]** Додати навички wiki-indexer та llm-wiki до моніторів
3. **[P1]** Встановити порядок виконання pipeline
4. **[P2]** Зменшити частоту RSS/GitHub моніторів до 720m
