...
Introducing the [Explainable AI Cheat Sheet](https://ex.pegg.io), your high-level guide to the set of tools and methods that helps humans understand AI/ML models and their predictions.
[ ![](/images/Explainable-AI-cheat-sheet-v0.2.1080.png)](https://ex.pegg.io)
...
Attribution example:
*Alammar, Jay (2018). The Illustrated Transformer [Blog post]. Retrieved from [https://jalammar.github.io/illustrated-transformer/](https://jalammar.github.io/illustrated-transformer/)*
