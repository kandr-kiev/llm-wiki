...
> **Source:** we-dont-use-ai-in-any-of-our-design-or-production-processes-2026-07-15.md
> **Type:** comparison
> **Created:** 2026-07-16
> **Updated:** 2026-07-16
> **Confidence:** high
> **Description:** ##  [ Mass-Driver ](/) ##  Typefaces -  [ MD Nichrome ](/typefaces/md-nichrome) -  [ MD Lórien ](/typefaces/md-lorien) -  [ MD Thermochrome ](/typefaces/md-thermochrome) -  [ MD IO ](/typefaces/md-io)...
> **Sources:**
...
In ancient Rome, holding a flat brush in the right hand, a writer could make a cleaner line if they began and ended with a short horizontal flick; this was the origin of the serif.[](#footnote-catich) And their wrist was less comfortable rotating the brush to always face its direction of travel, so they would have found it easier to hold at one angle, making strokes of different widths — thicker when pulling it downwards and to the right. Our letters still feature this same stroke modulation today. Did the signwriter know their idea would outlast their civilisation?
The book of the same name by [Edward Catich](https://en.wikipedia.org/wiki/Edward_Catich#The_Origin_of_the_Serif) is a masterclass in connecting the visual grammar of type to its organic roots in calligraphy.
When we turn design over to generative AI, we remove the human element from the process. When we ask Midjourney to draw an ox, it does not think of home. ChatGPT will never invent [a new calligraphy technique,](https://undercase.xyz/custom/a-guide-to-sinist

## Summary

ral-hand) because it has no wrists to feel uncomfortable. A tool that shields us from the friction of the work is compelling, but if we don’t experience the friction, we will never change the work.
...
- 
## All Typefaces
- [MD Nichrome](/typefaces/md-nichrome)
- [MD Lórien](/typefaces/md-lorien)
- [MD Thermochrome](/typefaces/md-thermochrome)
- [MD IO](/typefaces/md-io)
- [MD UI](/typefaces/md-ui)
- [MD System](/typefaces/md-system)
- [MD Primer](/typefaces/md-primer)
- [MD Polychrome](/typefaces/md-polychrome)
- 
## Information
- [About](/about)
- [Licensing](/licensing)
...
- 
## Connect
- [Bluesky](https://bsky.app/profile/mass-driver.com)
- Mastodon
- [Instagram](https://www.instagram.com/mass.driver/)
---
- [RSS (all news)](/rss)
- [RSS (articles only)](/rss-articles)
- [
