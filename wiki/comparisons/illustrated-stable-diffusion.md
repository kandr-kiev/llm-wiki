...
> **Source:** illustrated-stable-diffusion.md
> **Type:** comparison
> **Created:** 2026-07-11
> **Updated:** 2026-07-11
> **Confidence:** high
> **Description:** --- title: "illustrated stable diffusion" type: comparison tags: [comparison, diffusion] description: Comparison page for illustrated stable diffusion sources: [] links: [] description: Comparison pag...
> **Sources:**
>   - illustrated-stable-diffusion.md
> **Links:**
...
As we look under the hood, the first observation we can make is that there’s a text-understanding component that translates the text information into a numeric representation th

## Summary

at captures the ideas in the text.
...
Diffusion is the process that takes place inside the pink “image information creator” component. Having the token embeddings that 
