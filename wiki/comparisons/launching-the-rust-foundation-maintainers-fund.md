...
> **Source:** launching-the-rust-foundation-maintainers-fund-2026-07-17.md
> **Type:** comparison
> **Created:** 2026-07-17
> **Updated:** 2026-07-17
> **Confidence:** high
...
- System
## Launching the Rust Foundation Maintainers Fund
June 2, 2026 · Funding team
on behalf of [Leadership Council](https://www.rust-lang.org/governance/teams/leadership-council) 
>
...
This program extends our existing support for Rust maintainers, such as the program management program and the compiler-ops program. An

## Summary

 important development is that we now have a centralized mechanism for gathering donations from both individuals and companies, and a dedicated team that will help direct those funds to specific maintainers. You can find more details about the funding team and the Maintainer in Residence program in the RFC.
...
- 
This program was inspired by the Developer in Residence concept used by the Python Software Foundation (PSF), with which we led several helpful discussions. Thank you, PSF! [↩](#fr-dir-1)
- 
Note that the fact that GitHub Sponsors is currently enabled on the `rustfoundation` GitHub organization, and not the `rust-l
