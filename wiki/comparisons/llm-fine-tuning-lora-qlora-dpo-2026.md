...
created: 2026-07-07
updated: 2026-07-07
tags: [llm-wiki, fine-tuning, lora, comparison]
confidence: verified
links: []
sources: []
---
...
> **Source:** [llm-fine-tuning-lora-qlora-dpo-2026.md](https://futureagi.com/blog/llm-fine-tuning-techniques-i-ii)
> **Relevance:** high
> **Type:** comparison
...
- BitFit: Ben Zaken et al., 2022, arXiv:2106.10199
- Tulu 3: Allen AI, 2024, arxiv.org/abs/2411.15124

## Related Wiki Pages

- [[llm-quantization]] — Quantization methods (GGUF, GPTQ, AWQ, NF4)
- [[advanced-rag-techniques]] — RAG as alternative to fine-tuning
- [[hermes-knowledge-storage]] — Storage system for model metadata
