...
> **Source:** llm-fine-tuning-techniques-in-lora-qlora-sft-dpo.md
> **Type:** comparison
> **Created:** 2026-07-11
> **Updated:** 2026-07-11
> **Confidence:** high
> **Description:** --- title: "LLM Fine-Tuning Techniques in LoRA, QLoRA, SFT, DPO" type: comparison tags: [comparison, dpo, fine-tuning, lora, qlora, sft] description: Comparison page for LLM Fine-Tuning Techniques in...
> **Sources:**
>   - llm-fine-tuning-techniques-in-lora-qlora-sft-dpo.md
> **Links:**
- [[llm-fine-tuning]]
...
- **Hyperparameters:** LR 1e-5–5e-4 for LoRA; 1e-6–5e-5 fo
