...
> **Source:** python-3150-beta-2-is-here-2026-07-17.md
> **Type:** comparison
> **Created:** 2026-07-17
> **Updated:** 2026-07-17
> **Confidence:** high
> **Description:** # Python 3.15.0 beta 2 is here!  [Hugo van Kemenade](/authors/hugo-van-kemenade) / June 2, 2026 [ releases ](/tags/releases) [- python.org/downloads/release/python-3150b2](https://www.python.org/downl...
> **Sources:**
...
[Hugo van Kemenade](/authors/hugo-van-kemenade) / June 2, 2026 [ releases ](/tags/releases) [- python.org/downloads/release/python-3150b2](https://www.python.org/downloads/release/python-3150b2/)
...
- [PEP 747](https://docs.pyt

## Summary

hon.org/3.15/whatsnew/3.15.html#typing): Annotating type forms with `TypeForm`
...
For more details on the changes to Python 3.15, see [What’s new in Python 3.15](https://docs.python.org/3.15/whatsnew/3.15.html). The next pre-release of Python 3.15 will be 3.15.0b3, scheduled for 2026-06-23.
...
Thanks to all of the many volunteers who help make Python development and these releases possible! Please consider supporting our efforts by volunteering yourself or through organisation contributions to the [Python Software F
