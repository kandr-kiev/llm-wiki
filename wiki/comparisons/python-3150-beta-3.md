...
> **Source:** python-3150-beta-3-is-here-2026-07-17.md
> **Type:** comparison
> **Created:** 2026-07-17
> **Updated:** 2026-07-17
> **Confidence:** high
> **Description:** # Python 3.15.0 beta 3 is here!  [Hugo van Kemenade](/authors/hugo-van-kemenade) / June 23, 2026 [ releases ](/tags/releases) [- python.org/downloads/release/python-3150b3](https://www.python.org/down...
> **Sources:**
>   - python-3150-beta-3-is-here-2026-07-17.md
> **Links:**
- [[python-3150-beta-2]]
- [[python-3150-beta-1]]
- [[python-3145-is-out]]
...
[Hugo van Kemenade](/authors/hugo-van-kemenade) / June 23, 2026 [ releases ](/tags/releases) [- python.org/downloads/release/python-3150b3](https://www.python.org/downloads/release/python-3150b3/)
...
- [PEP 829](https://peps.python.org/pep-0829/): Package startup configuration fil
...
For more details on the changes to Python 3.15, see [What’s new in Python 3.15](https://docs.python.org/3.15/whatsnew/3.15.html). The next pre-release of Python 3.15 will be 3.15.0b4, scheduled for 2026-07-18.
...
Thanks to all of the many volunteers who help make Python development and these releases possible! Please consider supporting our efforts by volunteering yourself or through organisation contributions to the [Python Software Foundation](https://www.python.org/psf-la
