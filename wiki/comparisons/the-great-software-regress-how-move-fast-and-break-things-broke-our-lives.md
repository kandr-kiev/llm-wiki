...
> **Source:** my-cars-ota-update-broke-android-auto-2026-07-17.md
> **Type:** comparison
> **Created:** 2026-07-17
> **Updated:** 2026-07-17
> **Confidence:** high
> **Description:** [ #  Dan Kendalls' Fluff ](/) Home Blog # The Great Software Regress: How "Move Fast and Break Things" Broke Our Lives * 16 Jul, 2026 * Just yesterday morning, my brand-new MINI Countryman auto-instal...
> **Sources:**
...
Yes, technically, you are patching vulnerabilities. But in the actual, messy, human world, people get hacked because of deliberate user actions executing malicious payloads regardless of the un

## Summary

derlying OS vulnerabilities.
Heck, my mum once managed to pick up a malicious payload for iOS on her old first-gen iPad. Now, this was years after iOS 5 was relevant, but still user input was required.
...
To be brutally honest, I am part of the problem too. I have had pressure to make things worse instead of making things better.
We are all complicit in the world we make.
So when I say "fuck you," I don't just mean a faceless manage
