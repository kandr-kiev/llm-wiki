...
> **Source:** show-hn-sx-20--share-ai-skills-with-your-team-through-a-dropbox-folder-2026-07-14.md
> **Type:** comparison
> **Created:** 2026-07-14
> **Updated:** 2026-07-14
> **Confidence:** high
> **Description:** sx blog [sx blog](/sx/) # Your Dropbox is now a skill server Jul 10, 2026 • Dylan Etkin ![sx 2.0](/sx/assets/skill-server-hero.png) *sx 2.0 is out: a native app for Mac, Windows, and Linux that lets a...
> **Sources:**
...
Jul 10, 2026
• Dylan Etkin
![sx 2.0](/sx/assets/skill-server-hero.png)
...
The obvious comparison is exactly that Obsidian setup, a markdown vault in a synced folder, and plenty of teams do run their skills that way today. The difference is what happens after the files sync. sx knows about the AI clients natively. When you hit Sync in the app, it runs an `sx install` in the background: it resolves what should be installed for you, translates each asset into every client’s format (Claude Code skills, Cursor rules, Copilot instructions, and so on), and writes it to the right place on your machine. Your teammate drops a skill in the shared folder, you click one button, and it’s live 

## Summary

in your AI client. That translation layer is the part a folder full of markdown can’t do for you.
