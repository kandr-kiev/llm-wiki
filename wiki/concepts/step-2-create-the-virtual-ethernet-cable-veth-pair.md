...
no-cni NotReady control-plane,master 52s v1.35.0 192.168.117.2   Ubuntu 24.04.3 LTS 7.0.11-orbstack-00360-gc9bc4d96ac70 containerd://2.1.6
worker-1 NotReady   46s v1.35.0 192.168.117.3   Ubuntu 24.04.3 LTS 7.0.11-orbstack-00360-gc9bc4d96ac70 containerd://2.1.6
worker-2 NotReady   40s v1.35.0 192.168.117.4   Ubuntu 24.04.3 LTS 7.0.11-orbstack-00360-gc9bc4d96ac70 containerd://2.1.6
```
...
```dataview
LIST FROM ""
WHERE contains(backlinks, "step-2-create-the-virtual-ethernet-cable-veth-pair")
```
