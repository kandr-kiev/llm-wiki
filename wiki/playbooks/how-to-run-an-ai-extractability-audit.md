...
The critical detail for this tutorial: **the audit counts every** ` `**,** ` `**, and** ` ` **in your rendered DOM.** Not the headings you wrote in your CMS. The headings your component library emits. That gap is where my six invisible failures lived.
## Prerequisites
